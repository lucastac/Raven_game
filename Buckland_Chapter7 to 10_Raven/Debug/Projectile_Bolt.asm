; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Lucas\Desktop\jogos - game ai by example\Bluckland_SourceCode - new version\VS2010\Raven_Game\Buckland_Chapter7 to 10_Raven\armory\Projectile_Bolt.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG138909 DB	'Bolt_Mass', 00H
	ORG $+2
_SmallestDelay DQ 03fd0000000000000r		; 0.25
_SEND_MSG_IMMEDIATELY DQ 00000000000000000r	; 0
$SG138908 DB	'Bolt_MaxForce', 00H
	ORG $+2
$SG138910 DB	'Bolt_MaxSpeed', 00H
	ORG $+2
$SG138911 DB	'Bolt_Scale', 00H
	ORG $+1
$SG138912 DB	'Bolt_Damage', 00H
$SG138915 DB	'a', 00H, 'r', 00H, 'm', 00H, 'o', 00H, 'r', 00H, 'y', 00H
	DB	'\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'j', 00H, 'e', 00H, 'c'
	DB	00H, 't', 00H, 'i', 00H, 'l', 00H, 'e', 00H, '_', 00H, 'B', 00H
	DB	'o', 00H, 'l', 00H, 't', 00H, '.', 00H, 'c', 00H, 'p', 00H, 'p'
	DB	00H, 00H, 00H
	ORG $+2
$SG138916 DB	't', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'e', 00H, 't', 00H
...
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\raven_game\buckland_chapter7 to 10_raven\armory\projectile_bolt.cpp
rdata$r	SEGMENT
...
$T149690 = -56						; size = 16
$T149689 = -40						; size = 16
_dist$138933 = -20					; size = 8
_hit$138929 = -8					; size = 4
_this$ = -4						; size = 4
...
; 56   :                                                m_vPosition);
	...
	mov	DWORD PTR _hit$138929[ebp], eax

; 57   :     
; 58   :     //if hit
; 59   :     if (hit)

	cmp	DWORD PTR _hit$138929[ebp], 0
	je	SHORT $LN2@Update
...
; 70   :                               (void*)&m_iDamageInflicted);
	...
	push	eax
	push	3
	mov	ecx, DWORD PTR _hit$138929[ebp]
	call	?ID@BaseGameEntity@@QBEHXZ		; BaseGameEntity::ID
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 79   :                                                  m_pWorld->GetMap()->GetWalls()))
	...
	add	ecx, 200				; 000000c8H
	push	ecx
	lea	edx, DWORD PTR _dist$138933[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 24					; 00000018H
	sub	esp, 16					; 00000010H
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$144369[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$144369[ebp]
	push	edx
	lea	eax, DWORD PTR $T144371[ebp]
	push	eax
	...
	lea	eax, DWORD PTR $T149743[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T144371[ebp]
...
; 165  : 		{	// construct from message string
	...
	mov	DWORD PTR $T149758[ebp], eax
	lea	eax, DWORD PTR $T149758[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$140867[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$140867[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$140867[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T149846[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T149846[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$140846[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$140846[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T149912[ebp]
	or	ecx, 1
	mov	DWORD PTR $T149912[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T149912[ebp]
	and	eax, 1
	je	$LN5@operator@4
	and	DWORD PTR $T149912[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@4:
	ret	0
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	push	OFFSET ??_C@_0CB@NOKEJIID@?$DMPopLuaNumber?$DO?5Cannot?5retrieve?3?5@
	lea	ecx, DWORD PTR _err$144386[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$144386[ebp]
	push	edx
	lea	eax, DWORD PTR $T144387[ebp]
	push	eax
	call	??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z ; std::operator+<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 12					; 0000000cH
	mov	DWORD PTR tv74[ebp], eax
	...
	push	edx
	lea	ecx, DWORD PTR $T149962[ebp]
	call	??0runtime_error@std@@QAE@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@@Z ; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T149962[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T144387[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
$T149977 = -88						; size = 12
$T149976 = -73						; size = 1
_point$145064 = -68					; size = 16
_dist$145063 = -44					; size = 8
_curWall$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_A$ = 8							; size = 16
_B$ = 24						; size = 16
...
; 100  :     double dist = 0.0;
	...
	fldz
	fstp	QWORD PTR _dist$145063[ebp]

; 101  :     Vector2D point;

	lea	ecx, DWORD PTR _point$145064[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 102  : 
; 103  :     if (LineIntersection2D(A, B, (*curWall)->From(), (*curWall)->To(), dist, point))

	lea	eax, DWORD PTR _point$145064[ebp]
	push	eax
	lea	ecx, DWORD PTR _dist$145063[ebp]
	push	ecx
	lea	edx, DWORD PTR $T149978[ebp]
	push	edx
	lea	ecx, DWORD PTR _curWall$[ebp]
...
; 105  :       if (dist < distance)
	...
	fld	QWORD PTR [edx]
	fcomp	QWORD PTR _dist$145063[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 107  :         distance = dist;
	...
	mov	eax, DWORD PTR _distance$[ebp]
	fld	QWORD PTR _dist$145063[ebp]
	fstp	QWORD PTR [eax]

; 108  :         ip = point;

	mov	ecx, DWORD PTR _ip$[ebp]
	mov	edx, DWORD PTR _point$145064[ebp]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR _point$145064[ebp+4]
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR _point$145064[ebp+8]
	mov	DWORD PTR [ecx+8], edx
	mov	eax, DWORD PTR _point$145064[ebp+12]
	mov	DWORD PTR [ecx+12], eax
$LN2@FindCloses:
...
; 113  :   if (distance < MaxDouble) return true;
	...
	mov	BYTE PTR $T149980[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T149980[ebp]
...
; 115  :   return false;
	...
	mov	BYTE PTR $T149981[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T149981[ebp]
$LN7@FindCloses:
...
; 1542 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$145792[ebp], edx
...
; 1544 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$145792[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
; 787  : 		return (const_iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T150073[ebp]
	or	eax, 1
	mov	DWORD PTR $T150073[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T150083[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150083[ebp], 0
	...
	mov	ecx, DWORD PTR $T150083[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T150083[ebp]
