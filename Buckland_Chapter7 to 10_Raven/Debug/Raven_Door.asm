; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Lucas\Desktop\jogos - game ai by example\Raven_Game\Buckland_Chapter7 to 10_Raven\Raven_Door.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\lucas\desktop\jogos - game ai by example\raven_game\buckland_chapter7 to 10_raven\raven_door.cpp
rdata$r	SEGMENT
...
; 20   :   m_vtoP2Norm =  Vec2DNormalize(m_vP2 - m_vP1);
	...
	push	eax
	lea	ecx, DWORD PTR $T147287[ebp]
	push	ecx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
	push	eax
	lea	edx, DWORD PTR $T147288[ebp]
	push	edx
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\common\2d\wall2d.h
...
; 93   :     Clamp(m_dCurrentSize, 0, m_dSize);
	...
	mov	DWORD PTR $T147391[ebp], 0
	mov	edx, DWORD PTR _this$[ebp]
	add	edx, 136				; 00000088H
	push	edx
	lea	eax, DWORD PTR $T147391[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 116  :     Clamp(m_dCurrentSize, 0, m_dSize);
	...
	mov	DWORD PTR $T147406[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 136				; 00000088H
	push	eax
	lea	ecx, DWORD PTR $T147406[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
; 132  :                 id) == m_Switches.end())
	...
	mov	BYTE PTR $T147410[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T147413[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T147414[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
	movzx	ecx, BYTE PTR $T147410[ebp]
	test	ecx, ecx
...
; 157  :   for (int i=0; i<num; ++i)
	...
	mov	DWORD PTR _i$138306[ebp], 0
	jmp	SHORT $LN3@Read
$LN2@Read:
	mov	edx, DWORD PTR _i$138306[ebp]
	add	edx, 1
	mov	DWORD PTR _i$138306[ebp], edx
$LN3@Read:
	mov	eax, DWORD PTR _i$138306[ebp]
...
$T147467 = -76						; size = 8
$T147464 = -68						; size = 4
__Nget_fac$139027 = -64					; size = 4
__Tmp$139026 = -56					; size = 4
__Ok$ = -44						; size = 8
__State$ = -28						; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
...
; 279  : 			long _Tmp = 0;
	...
	mov	DWORD PTR __Tmp$139026[ebp], 0

; 280  : 			const _Nget& _Nget_fac = _USE(ios_base::getloc(), _Nget);

	lea	ecx, DWORD PTR $T147464[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	...
	add	esp, 4
	mov	DWORD PTR __Nget_fac$139027[ebp], eax
...
$LN9@operator@4:
	...
	lea	eax, DWORD PTR __Tmp$139026[ebp]
	push	eax
	...
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T147469[ebp]
	push	eax
	mov	ecx, DWORD PTR __Nget_fac$139027[ebp]
...
; 288  : 				|| _Tmp < INT_MIN || INT_MAX < _Tmp)
	...
	cmp	DWORD PTR __Tmp$139026[ebp], -2147483648 ; 80000000H
	jl	SHORT $LN2@operator@4
	cmp	DWORD PTR __Tmp$139026[ebp], 2147483647	; 7fffffffH
...
; 291  : 				_Val = _Tmp;
	...
	mov	eax, DWORD PTR __Tmp$139026[ebp]
	mov	DWORD PTR [edx], eax
$LN5@operator@4:
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T147495[ebp], eax
	lea	ecx, DWORD PTR __Lock$117481[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T147495[ebp]
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T147503[ebp]
	or	edx, 1
	mov	DWORD PTR $T147503[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 417  : 			const _Nget& _Nget_fac = _USE(ios_base::getloc(), _Nget);
	...
	call	??$use_facet@V?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@@std@@YAABV?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@0@ABVlocale@0@@Z ; std::use_facet<std::num_get<char,std::istreambuf_iterator<char,std::char_traits<char> > > >
	add	esp, 4
	mov	DWORD PTR __Nget_fac$139298[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR $T147524[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
$LN6@operator@5:
	...
	push	eax
	lea	ecx, DWORD PTR $T147528[ebp]
	call	??0?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z ; std::istreambuf_iterator<char,std::char_traits<char> >::istreambuf_iterator<char,std::char_traits<char> >
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T147529[ebp]
	push	eax
	mov	ecx, DWORD PTR __Nget_fac$139298[ebp]
...
; 426  : 		return (*this);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T147530[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_istream@DU?$char_traits@D@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T147530[ebp]
...
; 782  : 		return (iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T147579[ebp]
	or	eax, 1
	mov	DWORD PTR $T147579[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@PAIPBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >::_Vector_iterator<std::_Vector_val<unsigned int,std::allocator<unsigned int> > >
	mov	eax, DWORD PTR $T147584[ebp]
	or	eax, 1
	mov	DWORD PTR $T147584[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 979  : 			size_type _Idx = _STD addressof(_Val) - this->_Myfirst;
	...
	sar	eax, 2
	mov	DWORD PTR __Idx$139822[ebp], eax
...
; 985  : 				this->_Myfirst[_Idx]);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	edx, DWORD PTR __Idx$139822[ebp]
...
$T147651 = -44						; size = 4
$T147650 = -40						; size = 4
__Meta$140567 = -32					; size = 4
__Ctype_fac$140563 = -24				; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Noskip$ = 8						; size = 1
...
; 124  : 				const _Ctype& _Ctype_fac = _USE(ios_base::getloc(), _Ctype);
	...
	add	esp, 4
	mov	DWORD PTR __Ctype_fac$140563[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR $T147650[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 127  : 				int_type _Meta = _Myios::rdbuf()->sgetc();
	...
	mov	DWORD PTR __Meta$140567[ebp], ecx
	jmp	SHORT $LN7@Ipfx
$LN6@Ipfx:
...
; 130  : 					if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	mov	DWORD PTR $T147651[ebp], edx
	lea	eax, DWORD PTR __Meta$140567[ebp]
	push	eax
	lea	ecx, DWORD PTR $T147651[ebp]
	push	ecx
...
; 136  : 						_Traits::to_char_type(_Meta)))
	...
	push	ecx
	push	72					; 00000048H
	mov	ecx, DWORD PTR __Ctype_fac$140563[ebp]
...
$LN5@snextc:
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T147695[ebp], eax
	lea	eax, DWORD PTR $T147694[ebp]
	push	eax
	lea	ecx, DWORD PTR $T147695[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
_TEXT	SEGMENT
__Size$141688 = -28					; size = 4
__Ptr$141681 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$141681[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$141681[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@IV?$allocator@I@std@@@std@@QBEIXZ ; std::vector<unsigned int,std::allocator<unsigned int> >::size
	mov	DWORD PTR __Size$141688[ebp], eax
...
; 770  : 			this->_Mylast = _Ptr + _Size;
	...
	mov	ecx, DWORD PTR __Size$141688[ebp]
	mov	edx, DWORD PTR __Ptr$141681[ebp]
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR __Ptr$141681[ebp]
	mov	DWORD PTR [edx+4], eax
$LN7@reserve:
...
$T147880 = -64						; size = 4
$T147879 = -60						; size = 12
__Pfmod$142866 = -48					; size = 4
__Pf$142850 = -44					; size = 4
__Id$142849 = -40					; size = 4
__Psave$142837 = -32					; size = 4
__Lock$142836 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$142836[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$142837[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$142837[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$142837[ebp]
	mov	DWORD PTR __Pf$142850[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$142837[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T147879[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T147879[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$142837[ebp]
	mov	DWORD PTR __Pf$142850[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$142837[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$142837[ebp]
	mov	DWORD PTR __Pfmod$142866[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$142866[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$142850[ebp]
	mov	DWORD PTR $T147880[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$142836[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T147880[ebp]
$LN8@use_facet:
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T147909[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T147909[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T147916[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T147916[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T147912[ebp]
...
; 78   :             _THROW_NCEE(runtime_error, "bad locale name");
	...
	lea	ecx, DWORD PTR $T147928[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T147928[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
...
; 118  : 		return (::_Getctype());
	...
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T147989[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T147989[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T147989[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T147989[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T147989[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T147989[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T147989[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T147989[ebp+12]
	mov	DWORD PTR [eax+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T148020[ebp], edx
	mov	eax, DWORD PTR $T148020[ebp]
	push	eax
...
; 74   : 		_Find(_Unchecked(_First), _Unchecked(_Last), _Val)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@ABV01@@Z
	mov	eax, DWORD PTR $T148061[ebp]
	or	eax, 1
	mov	DWORD PTR $T148061[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
...
__unwindfunclet$??$find@V?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@I@std@@YA?AV?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@0@V10@0ABI@Z$6:
	...
	and	eax, 1
	je	$LN10@find
	and	DWORD PTR $T148061[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
$LN10@find:
	ret	0
...
$T148072 = -64						; size = 4
$T148071 = -60						; size = 12
__Pfmod$143241 = -48					; size = 4
__Pf$143230 = -44					; size = 4
__Id$143229 = -40					; size = 4
__Psave$143217 = -32					; size = 4
__Lock$143216 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$143216[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$143217[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$143229[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$143229[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$143230[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$143230[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$143217[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$143217[ebp]
	mov	DWORD PTR __Pf$143230[ebp], edx
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$143217[ebp]
	push	ecx
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$143217[ebp]
	mov	DWORD PTR __Pf$143230[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$143217[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$143217[ebp]
	mov	DWORD PTR __Pfmod$143241[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$143241[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$143230[ebp]
	mov	DWORD PTR $T148072[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$143216[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T148072[ebp]
$LN8@use_facet@2:
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	add	esp, 8
	mov	BYTE PTR $T148101[ebp], al
	movzx	edx, BYTE PTR $T148101[ebp]
	push	edx
...
; 246  : 				_Locinfo(_Ploc->c_str()));
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T148136[ebp], eax
	push	245					; 000000f5H
	push	OFFSET ??_C@_0EH@GHEBKCIB@c?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T148136[ebp]
	push	ecx
	push	16					; 00000010H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T148135[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148135[ebp], 0
	...
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T148141[ebp]
	or	eax, 1
	mov	DWORD PTR $T148141[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T148135[ebp]
...
$LN5@Getcat@2:
	mov	edx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T148134[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T148134[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T148141[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T148141[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T148137[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T148154[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148154[ebp], 0
	...
	mov	ecx, DWORD PTR $T148154[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T148154[ebp]
...
$T148183 = -208						; size = 4
$T148182 = -204						; size = 4
__Ulo$141296 = -200					; size = 4
__Errno$141295 = -192					; size = 4
__Ep$141294 = -180					; size = 4
__Ac$141293 = -168					; size = 32
$T141282 = -132						; size = 32
$T141280 = -100						; size = 32
__Str$141279 = -64					; size = 32
__Punct_fac$141274 = -28				; size = 4
__Ans$ = -24						; size = 4
_this$ = -20						; size = 4
...
; 372  : 			const _Mypunct& _Punct_fac = _USE(_Iosbase.getloc(), _Mypunct);
	...
	add	esp, 4
	mov	DWORD PTR __Punct_fac$141274[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T148182[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 373  : 			_Mystr _Str((_Mystrsize)1, (char_type)0);
	...
	push	0
	push	1
	lea	ecx, DWORD PTR __Str$141279[ebp]
...
; 374  : 			_Str += _Punct_fac.falsename();
	...
	lea	ecx, DWORD PTR $T141280[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Punct_fac$141274[ebp]
...
; 385  : 					_Iosbase.getloc()), &_Errno);
	...
	lea	edx, DWORD PTR __First$[ebp]
	push	edx
	lea	eax, DWORD PTR __Ac$141293[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	push	ecx
	...
	add	esp, 24					; 00000018H
	push	eax
	lea	edx, DWORD PTR __Ep$141294[ebp]
	push	edx
	lea	eax, DWORD PTR __Ac$141293[ebp]
	push	eax
	call	__Stoulx
	add	esp, 16					; 00000010H
	mov	DWORD PTR __Ulo$141296[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T148183[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 386  : 			if (_Ep != _Ac && _Errno == 0 && _Ulo <= 1)
	...
	mov	ecx, DWORD PTR __Ep$141294[ebp]
	lea	edx, DWORD PTR __Ac$141293[ebp]
	cmp	ecx, edx
	je	SHORT $LN5@do_get
	cmp	DWORD PTR __Errno$141295[ebp], 0
	jne	SHORT $LN5@do_get
	cmp	DWORD PTR __Ulo$141296[ebp], 1
	ja	SHORT $LN5@do_get

; 387  : 				_Ans = _Ulo;

	mov	eax, DWORD PTR __Ulo$141296[ebp]
	mov	DWORD PTR __Ans$[ebp], eax
$LN5@do_get:
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$140266[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$140266[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$140266[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 28					; 0000001cH
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T148433[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T148433[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
tv75 = -137						; size = 1
$T148457 = -136						; size = 4
__Pg$141951 = -132					; size = 4
__Pe$141925 = -128					; size = 4
__Group$ = -124						; size = 4
...
; 672  : 		for (char *const _Pe = &_Ac[_MAX_INT_DIG - 1];
	...
	mov	DWORD PTR __Pe$141925[ebp], edx
...
$LN22@Getifld:
	mov	eax, DWORD PTR __Ptr$[ebp]
	cmp	eax, DWORD PTR __Pe$141925[ebp]
...
; 700  : 		for (const char *_Pg = _Grouping.c_str(); _Seendigit && 0 < _Group; )
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$141951[ebp], eax
$LN12@Getifld:
...
; 701  : 			if (*_Pg == CHAR_MAX)
	...
	mov	eax, DWORD PTR __Pg$141951[ebp]
...
; 707  : 				++_Pg;	// group size okay, advance to next test
	...
	mov	edx, DWORD PTR __Pg$141951[ebp]
	add	edx, 1
	mov	DWORD PTR __Pg$141951[ebp], edx
$LN9@Getifld:
...
$T148478 = -140						; size = 4
$T148475 = -136						; size = 4
__Pg$142024 = -132					; size = 4
__Group$142003 = -128					; size = 4
__Groups$142002 = -120					; size = 32
__Kseparator$141999 = -81				; size = 1
__Pten$ = -80						; size = 4
...
$LN73@Getffld:
	...
	mov	BYTE PTR __Kseparator$141999[ebp], al

; 759  : 			string _Groups((size_t)1, '\0');

	push	0
	push	1
	lea	ecx, DWORD PTR __Groups$142002[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2

; 760  : 			size_t _Group = 0;

	mov	DWORD PTR __Group$142003[ebp], 0
...
; 775  : 					if (_Groups[_Group] != CHAR_MAX)
	...
	mov	eax, DWORD PTR __Group$142003[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groups$142002[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
...
; 776  : 						++_Groups[_Group];
	...
	mov	edx, DWORD PTR __Group$142003[ebp]
	push	edx
	lea	ecx, DWORD PTR __Groups$142002[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
...
; 780  : 					|| *_First != _Kseparator)
	...
	movsx	edx, BYTE PTR __Kseparator$141999[ebp]
	test	edx, edx
	je	SHORT $LN42@Getffld
	mov	ecx, DWORD PTR __First$[ebp]
	call	??D?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QBEDXZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator*
	movsx	eax, al
	movsx	ecx, BYTE PTR __Kseparator$141999[ebp]
	cmp	eax, ecx
...
; 785  : 					++_Group;
	...
	mov	edx, DWORD PTR __Group$142003[ebp]
	add	edx, 1
	mov	DWORD PTR __Group$142003[ebp], edx
$LN44@Getffld:
...
; 787  : 			if (_Group == 0)
	...
	cmp	DWORD PTR __Group$142003[ebp], 0
...
; 794  : 			for (const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$142024[ebp], eax
$LN36@Getffld:
...
; 796  : 				if (*_Pg == CHAR_MAX)
	...
	mov	ecx, DWORD PTR __Pg$142024[ebp]
	movsx	edx, BYTE PTR [ecx]
	cmp	edx, 127				; 0000007fH
...
; 799  : 					|| 0 == _Group && *_Pg < _Groups[_Group])
	...
	mov	eax, DWORD PTR __Group$142003[ebp]
	sub	eax, 1
	mov	DWORD PTR __Group$142003[ebp], eax
...
; 802  : 					++_Pg;	// group size okay, advance to next test
	...
	mov	eax, DWORD PTR __Pg$142024[ebp]
	add	eax, 1
	mov	DWORD PTR __Pg$142024[ebp], eax
$LN33@Getffld:
...
; 859  : 		return (_Pten);
	...
	mov	ecx, DWORD PTR __Pten$[ebp]
	mov	DWORD PTR $T148478[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T148478[ebp]
$LN70@Getffld:
...
; 84   : 		return (do_falsename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T148495[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148495[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T148536 = -148						; size = 4
$T148533 = -144						; size = 4
__Pg$142362 = -140					; size = 4
__Group$142342 = -136					; size = 4
__Groups$142341 = -128					; size = 32
__Kseparator$142338 = -89				; size = 1
__Phex$ = -88						; size = 4
...
$LN78@Getffldx:
	...
	mov	BYTE PTR __Kseparator$142338[ebp], cl

; 928  : 			string _Groups((size_t)1, '\0');

	push	0
	push	1
	lea	ecx, DWORD PTR __Groups$142341[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2

; 929  : 			size_t _Group = 0;

	mov	DWORD PTR __Group$142342[ebp], 0
...
; 944  : 					if (_Groups[_Group] != CHAR_MAX)
	...
	mov	eax, DWORD PTR __Group$142342[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groups$142341[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
...
; 945  : 						++_Groups[_Group];
	...
	mov	edx, DWORD PTR __Group$142342[ebp]
	push	edx
	lea	ecx, DWORD PTR __Groups$142341[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
...
; 949  : 					|| *_First != _Kseparator)
	...
	movsx	edx, BYTE PTR __Kseparator$142338[ebp]
	test	edx, edx
	je	SHORT $LN42@Getffldx
	mov	ecx, DWORD PTR __First$[ebp]
	call	??D?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QBEDXZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator*
	movsx	eax, al
	movsx	ecx, BYTE PTR __Kseparator$142338[ebp]
	cmp	eax, ecx
...
; 954  : 					++_Group;
	...
	mov	edx, DWORD PTR __Group$142342[ebp]
	add	edx, 1
	mov	DWORD PTR __Group$142342[ebp], edx
$LN44@Getffldx:
...
; 956  : 			if (_Group == 0)
	...
	cmp	DWORD PTR __Group$142342[ebp], 0
...
; 963  : 			for (const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$142362[ebp], eax
$LN36@Getffldx:
...
; 965  : 				if (*_Pg == CHAR_MAX)
	...
	mov	ecx, DWORD PTR __Pg$142362[ebp]
	movsx	edx, BYTE PTR [ecx]
	cmp	edx, 127				; 0000007fH
...
; 968  : 					|| 0 == _Group && *_Pg < _Groups[_Group])
	...
	mov	eax, DWORD PTR __Group$142342[ebp]
	sub	eax, 1
	mov	DWORD PTR __Group$142342[ebp], eax
...
; 971  : 					++_Pg;	// group size okay, advance to next test
	...
	mov	eax, DWORD PTR __Pg$142362[ebp]
	add	eax, 1
	mov	DWORD PTR __Pg$142362[ebp], eax
$LN33@Getffldx:
...
; 1029 : 		return (0);	// power of 10 multiplier
	...
	mov	DWORD PTR $T148536[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T148536[ebp]
...
; 79   : 		return (do_grouping());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T148561[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148561[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 548  : 				_Strbuf->sbumpc()))
	...
	mov	ecx, DWORD PTR [ecx]
	call	?sbumpc@?$basic_streambuf@DU?$char_traits@D@std@@@std@@QAEHXZ ; std::basic_streambuf<char,std::char_traits<char> >::sbumpc
	mov	DWORD PTR $T148577[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T148578[ebp], eax
	lea	edx, DWORD PTR $T148577[ebp]
	push	edx
	lea	eax, DWORD PTR $T148578[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
; 559  : 				_Meta = _Strbuf->sgetc()))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T148581[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T148581[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
$T148590 = -64						; size = 4
$T148589 = -60						; size = 12
__Pfmod$143445 = -48					; size = 4
__Pf$143434 = -44					; size = 4
__Id$143433 = -40					; size = 4
__Psave$143421 = -32					; size = 4
__Lock$143420 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$143420[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$143421[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$143433[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$143433[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$143434[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$143434[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$143421[ebp], 0
	je	SHORT $LN4@use_facet@3

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$143421[ebp]
	mov	DWORD PTR __Pf$143434[ebp], edx
	jmp	SHORT $LN5@use_facet@3
$LN4@use_facet@3:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$143421[ebp]
	push	ecx
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$143421[ebp]
	mov	DWORD PTR __Pf$143434[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$143421[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$143421[ebp]
	mov	DWORD PTR __Pfmod$143445[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$143445[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$143434[ebp]
	mov	DWORD PTR $T148590[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$143420[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T148590[ebp]
$LN8@use_facet@3:
...
; 728  : 	_Debug_range2(_First, _Last, _File, _Line, _Iter_cat(_First));
	...
	add	esp, 4
	mov	BYTE PTR $T148605[ebp], al
	movzx	ecx, BYTE PTR $T148605[ebp]
	push	ecx
...
tv144 = -88						; size = 4
$T148613 = -84						; size = 4
__Field$143501 = -80					; size = 4
__Off$143500 = -76					; size = 4
__Prefix$143499 = -69					; size = 1
__Column$143495 = -68					; size = 4
__Ans$ = -64						; size = 4
__Str$ = -56						; size = 32
__Off$143487 = -20					; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
__First$ = 8						; size = 4
__Last$ = 12						; size = 4
...
; 546  : 	for (size_t _Off = 0; _Ptr[_Off] != (_Elem)0; ++_Off)
	...
	mov	DWORD PTR __Off$143487[ebp], 0
	jmp	SHORT $LN23@Getloctxt
$LN22@Getloctxt:
	mov	eax, DWORD PTR __Off$143487[ebp]
	add	eax, 1
	mov	DWORD PTR __Off$143487[ebp], eax
$LN23@Getloctxt:
	mov	ecx, DWORD PTR __Ptr$[ebp]
	add	ecx, DWORD PTR __Off$143487[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
...
; 547  : 		if (_Ptr[_Off] == _Ptr[0])
	...
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$143487[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
...
; 552  : 	for (size_t _Column = 1; ; ++_Column, ++_First, _Ans = -1)
	...
	mov	DWORD PTR __Column$143495[ebp], 1
	jmp	SHORT $LN19@Getloctxt
$LN18@Getloctxt:
	mov	eax, DWORD PTR __Column$143495[ebp]
	add	eax, 1
	mov	DWORD PTR __Column$143495[ebp], eax
	mov	ecx, DWORD PTR __First$[ebp]
	call	??E?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAEAAV01@XZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator++
	mov	DWORD PTR __Ans$[ebp], -1
$LN19@Getloctxt:
...
; 554  : 		bool _Prefix = false;	// seen at least one valid prefix
	...
	mov	BYTE PTR __Prefix$143499[ebp], 0

; 555  : 		size_t _Off = 0;	// offset into fields

	mov	DWORD PTR __Off$143500[ebp], 0

; 556  : 		size_t _Field = 0;	// current field number

	mov	DWORD PTR __Field$143501[ebp], 0
...
$LN15@Getloctxt:
	mov	ecx, DWORD PTR __Field$143501[ebp]
	add	ecx, 1
	mov	DWORD PTR __Field$143501[ebp], ecx
$LN16@Getloctxt:
	mov	edx, DWORD PTR __Field$143501[ebp]
...
$LN12@Getloctxt:
	mov	eax, DWORD PTR __Off$143500[ebp]
	add	eax, 1
	mov	DWORD PTR __Off$143500[ebp], eax
$LN13@Getloctxt:
	mov	ecx, DWORD PTR __Ptr$[ebp]
	add	ecx, DWORD PTR __Off$143500[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	je	SHORT $LN11@Getloctxt
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$143500[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	ecx, eax
...
; 564  : 				_Off += _Str[_Field];	// skip tested columns in field
	...
	mov	eax, DWORD PTR __Field$143501[ebp]
	push	eax
	lea	ecx, DWORD PTR __Str$[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
	add	ecx, DWORD PTR __Off$143500[ebp]
	mov	DWORD PTR __Off$143500[ebp], ecx
...
; 566  : 				|| _Ptr[_Off] == (_Elem)0)
	...
	mov	edx, DWORD PTR __Off$143500[ebp]
	add	edx, DWORD PTR __Column$143495[ebp]
	mov	DWORD PTR __Off$143500[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$143500[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
...
; 569  : 					? _Column : 127);	// save skip count if small enough
	...
	cmp	DWORD PTR __Column$143495[ebp], 127	; 0000007fH
...
; 576  : 				_Prefix = true;	// still a valid prefix
	...
	mov	BYTE PTR __Prefix$143499[ebp], 1
$LN9@Getloctxt:
...
; 579  : 		if (!_Prefix || _First == _Last)
	...
	movzx	eax, BYTE PTR __Prefix$143499[ebp]
	test	eax, eax
...
; 582  : 	return (_Ans);	// return field number or negative value on failure
	...
	mov	ecx, DWORD PTR __Ans$[ebp]
	mov	DWORD PTR $T148613[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T148613[ebp]
...
; 114  : 				_Locinfo(_Ploc->c_str()), 0, true);
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T148645[ebp], eax
	push	113					; 00000071H
	push	OFFSET ??_C@_0EH@GHEBKCIB@c?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T148645[ebp]
	push	ecx
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T148644[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148644[ebp], 0
	...
	mov	DWORD PTR tv134[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T148650[ebp]
	or	eax, 1
	mov	DWORD PTR $T148650[ebp], eax
	mov	ecx, DWORD PTR tv134[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T148644[ebp]
...
$LN5@Getcat@3:
	...
	mov	DWORD PTR $T148643[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T148643[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T148650[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@3
	and	DWORD PTR $T148650[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T148646[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@3:
...
; 174  : 		return (string(_Grouping));
	...
	mov	edx, DWORD PTR $T148676[ebp]
	or	edx, 1
	mov	DWORD PTR $T148676[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 179  : 		return (string_type(_Falsename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T148697[ebp]
	or	edx, 1
	mov	DWORD PTR $T148697[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 184  : 		return (string_type(_Truename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T148702[ebp]
	or	edx, 1
	mov	DWORD PTR $T148702[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	eax, DWORD PTR [edx+20]
	sub	eax, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Newsize$140245[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$140245[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 123  : 		return (::_Getcvt());
	...
	call	__Getcvt
	mov	DWORD PTR $T148734[ebp], eax
	mov	DWORD PTR $T148734[ebp+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T148734[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T148734[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 394  : 	return (_Iter._Unchecked());
	...
	mov	DWORD PTR $T148789[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Iter$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@IV?$allocator@I@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T148789[ebp]
...
; 208  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Other>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T148806[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148806[ebp], 0
	je	SHORT $LN3@construct@2
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
	call	??$forward@AAI@std@@YAAAIAAI@Z		; std::forward<unsigned int &>
	add	esp, 4
	mov	edx, DWORD PTR $T148806[ebp]
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR [edx], eax
	mov	ecx, DWORD PTR $T148806[ebp]
	mov	DWORD PTR tv73[ebp], ecx
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@II@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAI0@Z ; std::_Ptr_cat<unsigned int,unsigned int>
	add	esp, 8
	mov	BYTE PTR $T148829[ebp], al
	movzx	edx, BYTE PTR $T148829[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
...
; 48   : 	::new (_Vptr) _Ty1(_STD forward<_Ty2>(_Val));
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T148840[ebp], 0
	je	SHORT $LN3@Construct
	mov	edx, DWORD PTR __Val$[ebp]
	push	edx
	call	??$forward@ABI@std@@YAABIABI@Z		; std::forward<unsigned int const &>
	add	esp, 4
	mov	ecx, DWORD PTR $T148840[ebp]
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR $T148840[ebp]
	mov	DWORD PTR tv73[ebp], eax
	jmp	SHORT $LN4@Construct
$LN3@Construct:
	mov	DWORD PTR tv73[ebp], 0
...
; 660  : 	_Elem *_Ptrdest = _NEW_CRT _Elem[_Count];
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T148854[ebp], eax
	mov	edx, DWORD PTR $T148854[ebp]
...
; 664  : 	for (_Elem *_Ptrnext = _Ptrdest; 0 < _Count; --_Count, ++_Ptrnext, ++_Ptr)
	...
	mov	DWORD PTR __Ptrnext$144675[ebp], eax
	jmp	SHORT $LN3@Maklocstr
$LN2@Maklocstr:
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, 1
	mov	DWORD PTR __Count$[ebp], ecx
	mov	edx, DWORD PTR __Ptrnext$144675[ebp]
	add	edx, 1
	mov	DWORD PTR __Ptrnext$144675[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, 1
	mov	DWORD PTR __Ptr$[ebp], eax
$LN3@Maklocstr:
...
; 665  : 		*_Ptrnext = (_Elem)(unsigned char)*_Ptr;
	...
	mov	ecx, DWORD PTR __Ptrnext$144675[ebp]
	mov	edx, DWORD PTR __Ptr$[ebp]
	mov	al, BYTE PTR [edx]
	mov	BYTE PTR [ecx], al
