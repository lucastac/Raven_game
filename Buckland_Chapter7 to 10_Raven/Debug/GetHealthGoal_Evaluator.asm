...
$T139197 = -44						; size = 4
$T139196 = -40						; size = 4
_Desirability$131324 = -32				; size = 8
_Tweaker$131323 = -20					; size = 8
_Distance$ = -12					; size = 8
_this$ = -4						; size = 4
_pBot$ = 8						; size = 4
...
; 26   :     const double Tweaker = 0.2;
	...
	fstp	QWORD PTR _Tweaker$131323[ebp]
...
; 32   :                         (Raven_Feature::DistanceToItem(pBot, type_health));
	...
	fld1
	fsubrp	ST(1), ST(0)
	fmul	QWORD PTR _Tweaker$131323[ebp]
	push	4
	...
	fstp	QWORD PTR _Desirability$131324[ebp]
...
; 35   :     Clamp(Desirability, 0, 1);
	...
	lea	eax, DWORD PTR $T139196[ebp]
	push	eax
	lea	ecx, DWORD PTR $T139197[ebp]
	push	ecx
	lea	edx, DWORD PTR _Desirability$131324[ebp]
	push	edx
...
; 38   :     Desirability *= m_dCharacterBias;
	...
	fld	QWORD PTR _Desirability$131324[ebp]
...
; 60   :   std::string s = ttos(1-Raven_Feature::Health(pBot)) + ", " + ttos(Raven_Feature::DistanceToItem(pBot, type_health));
	...
	push	2
	lea	edx, DWORD PTR $T139223[ebp]
	push	edx
	lea	eax, DWORD PTR $T131373[ebp]
	push	eax
	call	??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z ; ttos<double>
	add	esp, 12					; 0000000cH
