; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Lucas\Desktop\jogos - game ai by example\Bluckland_SourceCode - new version\VS2010\Raven_Game\Common\Debug\DebugConsole.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG128550 DB	'DebugLog.txt', 00H
	ORG $+3
$SG128554 DB	'Debug', 00H
	ORG $+2
$SG128556 DB	'Error', 00H
	ORG $+2
$SG128557 DB	'Registration of Debug Console Failed!', 00H
	ORG $+2
$SG128558 DB	'Debug Console', 00H
	ORG $+2
$SG128559 DB	'Debug', 00H
	ORG $+2
$SG128561 DB	'Error!', 00H
	ORG $+1
$SG128562 DB	'CreateWindowEx Failed!', 00H
CONST	ENDS
...
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\raven_game\common\debug\debugconsole.cpp
_BSS	SEGMENT
...
$T133736 = -289						; size = 1
$T133735 = -288						; size = 12
_line$128521 = -276					; size = 4
_i$128498 = -272					; size = 4
_end$128497 = -264					; size = 12
_beg$128490 = -244					; size = 12
_StartIndex$128346 = -228				; size = 4
_PageSize$128344 = -224					; size = 4
_ps$128336 = -216					; size = 64
_hdc$128311 = -148					; size = 4
_rect$ = -140						; size = 16
_si$ = -116						; size = 28
_tm$ = -80						; size = 56
_iVertPos$ = -20					; size = 4
...
; 48   :       HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$128311[ebp], eax
...
; 50   :       GetTextMetrics(hdc, &tm);
	...
	push	eax
	mov	ecx, DWORD PTR _hdc$128311[ebp]
	push	ecx
...
; 64   :       ReleaseDC(hwnd, hdc);
	...
	mov	esi, esp
	mov	eax, DWORD PTR _hdc$128311[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
...
; 172  : 		  BeginPaint(hwnd, &ps);
	...
	mov	esi, esp
	lea	edx, DWORD PTR _ps$128336[ebp]
	push	edx
	mov	eax, DWORD PTR _hwnd$[ebp]
	push	eax
...
; 174  :         SetBkMode(ps.hdc, TRANSPARENT);
	...
	mov	esi, esp
	push	1
	mov	ecx, DWORD PTR _ps$128336[ebp]
	push	ecx
...
; 175  :         SetTextColor(ps.hdc, RGB(255,255,255));
	...
	mov	edx, DWORD PTR _ps$128336[ebp]
	push	edx
...
; 187  :           int PageSize = (int)(cyClient / cyChar) - 1;
	...
	idiv	DWORD PTR ?cyChar@?1??DebugWindowProc@DebugConsole@@CGJPAUHWND__@@IIJ@Z@4HA
	sub	eax, 1
	mov	DWORD PTR _PageSize$128344[ebp], eax

; 188  : 
; 189  :           int StartIndex = 0;

	mov	DWORD PTR _StartIndex$128346[ebp], 0

; 190  :       
; 191  :           if (iVertPos > PageSize)

	mov	eax, DWORD PTR _iVertPos$[ebp]
	cmp	eax, DWORD PTR _PageSize$128344[ebp]
...
; 193  :             StartIndex = iVertPos - PageSize;
	...
	mov	ecx, DWORD PTR _iVertPos$[ebp]
	sub	ecx, DWORD PTR _PageSize$128344[ebp]
	mov	DWORD PTR _StartIndex$128346[ebp], ecx
$LN13@DebugWindo:
...
; 196  :           std::vector<std::string>::iterator beg = m_Buffer.begin() + StartIndex;
	...
	mov	edx, DWORD PTR _StartIndex$128346[ebp]
	push	edx
	lea	eax, DWORD PTR _beg$128490[ebp]
	push	eax
	lea	ecx, DWORD PTR $T133735[ebp]
	push	ecx
	mov	ecx, OFFSET ?m_Buffer@DebugConsole@@0V?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@A ; DebugConsole::m_Buffer
...
; 197  : 		  std::vector<std::string>::iterator end = beg;
	...
	lea	eax, DWORD PTR _beg$128490[ebp]
	push	eax
	lea	ecx, DWORD PTR _end$128497[ebp]
...
; 200  : 		  for (int i = 0; i < PageSize + 1; ++i)
	...
	mov	DWORD PTR _i$128498[ebp], 0
	jmp	SHORT $LN12@DebugWindo
$LN11@DebugWindo:
	mov	ecx, DWORD PTR _i$128498[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$128498[ebp], ecx
$LN12@DebugWindo:
	mov	edx, DWORD PTR _PageSize$128344[ebp]
	add	edx, 1
	cmp	DWORD PTR _i$128498[ebp], edx
...
; 203  : 			if (end == m_Buffer.end()) break;
	...
	mov	BYTE PTR $T133736[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	lea	ecx, DWORD PTR $T133737[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	movzx	eax, BYTE PTR $T133736[ebp]
	test	eax, eax
...
; 206  :           int line=0;
	...
	mov	DWORD PTR _line$128521[ebp], 0
...
$LN7@DebugWindo:
	lea	ecx, DWORD PTR _beg$128490[ebp]
	call	??E?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAEAAV01@XZ ; std::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >::operator++
$LN8@DebugWindo:
	lea	ecx, DWORD PTR _end$128497[ebp]
	push	ecx
	...
	mov	edx, DWORD PTR $T133753[ebp]
	or	edx, 1
	mov	DWORD PTR $T133753[ebp], edx
...
$LN39@DebugWindo:
	...
	mov	BYTE PTR $T133738[ebp], dl
	mov	DWORD PTR __$EHRec$[ebp+8], 3
	mov	eax, DWORD PTR $T133753[ebp]
	and	eax, 1
	je	SHORT $LN47@DebugWindo
	and	DWORD PTR $T133753[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T133739[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN47@DebugWindo:
	movzx	ecx, BYTE PTR $T133738[ebp]
	test	ecx, ecx
...
; 210  :             TextOut(ps.hdc, 0, cyChar*line++, (*beg).c_str(), (*beg).size()); 
	...
	imul	edx, DWORD PTR _line$128521[ebp]
	mov	DWORD PTR tv300[ebp], edx
	mov	eax, DWORD PTR _line$128521[ebp]
	add	eax, 1
	mov	DWORD PTR _line$128521[ebp], eax
	lea	ecx, DWORD PTR _beg$128490[ebp]
...
; 214  : 			EndPaint(hwnd, &ps);
	...
	mov	esi, esp
	lea	eax, DWORD PTR _ps$128336[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\common\debug\debugconsole.h
...
; 274  : 						           "Debug",
	...
	mov	DWORD PTR _wDebugConsole$[ebp+40], OFFSET $SG128554
...
; 281  :     MessageBox(NULL, "Registration of Debug Console Failed!", "Error", 0);
	...
	mov	esi, esp
	push	0
	push	OFFSET $SG128556
	push	OFFSET $SG128557
	push	0
...
; 303  : 									          NULL );
	...
	push	OFFSET $SG128558
	push	OFFSET $SG128559
	push	0
...
; 308  :     MessageBox(m_hwnd, "CreateWindowEx Failed!", "Error!", 0);
	...
	mov	esi, esp
	push	0
	push	OFFSET $SG128561
	push	OFFSET $SG128562
	mov	eax, DWORD PTR ?m_hwnd@DebugConsole@@0PAUHWND__@@A ; DebugConsole::m_hwnd
	push	eax
	call	DWORD PTR __imp__MessageBoxA@16
	cmp	esi, esp
...
$LN3@WriteAndRe:
	...
	lea	ecx, DWORD PTR _it$[ebp]
	call	??9?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE_NABV01@@Z ; std::_Vector_const_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >::operator!=
	mov	BYTE PTR $T133841[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T133842[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	movzx	ecx, BYTE PTR $T133841[ebp]
	test	ecx, ecx
...
; 535  : 				_Myios::rdbuf()->sputc(_Ch)))
	...
	mov	DWORD PTR $T133861[ebp], edx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv153[ebp], eax
	mov	eax, DWORD PTR tv153[ebp]
	mov	DWORD PTR $T133862[ebp], eax
	lea	ecx, DWORD PTR $T133861[ebp]
	push	ecx
	lea	edx, DWORD PTR $T133862[ebp]
	push	edx
...
; 541  : 		return (*this);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T133863[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T133863[ebp]
...
; 782  : 		return (iterator(this->_Myfirst, this));
	...
	mov	eax, DWORD PTR $T133898[ebp]
	or	eax, 1
	mov	DWORD PTR $T133898[ebp], eax
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@PBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >
	mov	eax, DWORD PTR $T133903[ebp]
	or	eax, 1
	mov	DWORD PTR $T133903[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1218 : 		erase(begin(), end());
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T133911[ebp], esp
	mov	eax, DWORD PTR tv151[ebp]
	push	eax
	call	??0?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv154[ebp], eax
	lea	ecx, DWORD PTR $T133913[ebp]
	push	ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	mov	ecx, DWORD PTR _this$[ebp]
...
; 365  : 		return (_Tmp += _Off);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T133935[ebp]
	or	edx, 1
	mov	DWORD PTR $T133935[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??H?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T133935[ebp]
	and	eax, 1
	je	$LN5@operator@2
	and	DWORD PTR $T133935[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN5@operator@2:
	ret	0
...
; 319  : 			_THROW_NCEE(failure, "ios_base::failbit set");
	...
	push	1
	lea	edx, DWORD PTR $T133964[ebp]
	push	edx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BG@FMKFHCIL@ios_base?3?3failbit?5set?$AA@
	lea	ecx, DWORD PTR $T133963[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	eax, DWORD PTR $T133963[ebp]
	push	eax
	call	__CxxThrowException@8
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	push	1
	lea	ecx, DWORD PTR $T133966[ebp]
	push	ecx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BF@OOHOMBOF@ios_base?3?3eofbit?5set?$AA@
	lea	ecx, DWORD PTR $T133965[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T133965[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
$LN5@sputc:
	...
	mov	DWORD PTR $T134016[ebp], eax
	mov	eax, DWORD PTR $T134016[ebp]
	mov	cl, BYTE PTR __Ch$[ebp]
	mov	BYTE PTR [eax], cl
	mov	edx, DWORD PTR $T134016[ebp]
	push	edx
...
; 1202 : 				_VIPTR(_First));
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Ptr$130413[ebp], eax
...
; 1210 : 			_Destroy(_Ptr, this->_Mylast);
	...
	mov	edx, DWORD PTR [ecx+8]
	push	edx
	mov	eax, DWORD PTR __Ptr$130413[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1211 : 			this->_Mylast = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$130413[ebp]
...
; 1213 : 		return (_Make_iter(_First));
	...
	mov	edx, DWORD PTR $T134041[ebp]
	or	edx, 1
	mov	DWORD PTR $T134041[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	lea	ecx, DWORD PTR __Last$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 2
...
__unwindfunclet$?erase@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QAE?AV?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@0@Z$5:
	...
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
__unwindfunclet$?erase@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QAE?AV?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@0@Z$7:
	mov	eax, DWORD PTR $T134041[ebp]
	and	eax, 1
	je	$LN14@erase
	and	DWORD PTR $T134041[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN14@erase:
	ret	0
...
; 120  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$117475[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T134071[ebp], eax
	lea	ecx, DWORD PTR __Lock$117475[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T134071[ebp]
...
_TEXT	SEGMENT
__Nw$130496 = -20					; size = 4
__Nr$130494 = -16					; size = 4
__Pn$130492 = -12					; size = 4
__Pb$130490 = -8					; size = 4
_this$ = -4						; size = 4
__File$ = 8						; size = 4
__Which$ = 12						; size = 4
...
; 574  : 			_Elem **_Pb = (_Elem **)&_File->_IOBASE;
	...
	mov	ecx, DWORD PTR __File$[ebp]
	add	ecx, 8
	mov	DWORD PTR __Pb$130490[ebp], ecx

; 575  : 			_Elem **_Pn = (_Elem **)&_File->_IOPTR;

	mov	edx, DWORD PTR __File$[ebp]
	mov	DWORD PTR __Pn$130492[ebp], edx

; 576  : 			int *_Nr = (int *)&_File->_IORCNT;

	mov	eax, DWORD PTR __File$[ebp]
	add	eax, 4
	mov	DWORD PTR __Nr$130494[ebp], eax

; 577  : 			int *_Nw = (int *)&_File->_IOWCNT;

	mov	ecx, DWORD PTR __File$[ebp]
	add	ecx, 4
	mov	DWORD PTR __Nw$130496[ebp], ecx

; 578  : 			_Mysb::_Init(_Pb, _Pn, _Nr, _Pb, _Pn, _Nw);

	mov	edx, DWORD PTR __Nw$130496[ebp]
	push	edx
	mov	eax, DWORD PTR __Pn$130492[ebp]
	push	eax
	mov	ecx, DWORD PTR __Pb$130490[ebp]
	push	ecx
	mov	edx, DWORD PTR __Nr$130494[ebp]
	push	edx
	mov	eax, DWORD PTR __Pn$130492[ebp]
	push	eax
	mov	ecx, DWORD PTR __Pb$130490[ebp]
...
; 130  : 		return (*_Plocale);
	...
	mov	edx, DWORD PTR $T134143[ebp]
	or	edx, 1
	mov	DWORD PTR $T134143[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@PBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >::_Vector_iterator<std::_Vector_val<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > > >
	mov	edx, DWORD PTR $T134163[ebp]
	or	edx, 1
	mov	DWORD PTR $T134163[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
...
__unwindfunclet$?_Make_iter@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBE?AV?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@@Z$0:
	...
	jmp	??1?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
__unwindfunclet$?_Make_iter@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBE?AV?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T134163[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T134163[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
; 511  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T134225[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv289[ebp], eax
	mov	edx, DWORD PTR tv289[ebp]
	mov	DWORD PTR $T134226[ebp], edx
	lea	eax, DWORD PTR $T134225[ebp]
	push	eax
	lea	ecx, DWORD PTR $T134226[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 523  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T134227[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv297[ebp], eax
	mov	edx, DWORD PTR tv297[ebp]
	mov	DWORD PTR $T134228[ebp], edx
	lea	eax, DWORD PTR $T134227[ebp]
	push	eax
	lea	ecx, DWORD PTR $T134228[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 533  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T134229[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T134229[ebp]
...
$T134258 = -64						; size = 4
$T134257 = -60						; size = 12
__Pfmod$131518 = -48					; size = 4
__Pf$131507 = -44					; size = 4
__Id$131506 = -40					; size = 4
__Psave$131494 = -32					; size = 4
__Lock$131493 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$131493[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$131494[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$131494[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$131494[ebp]
	mov	DWORD PTR __Pf$131507[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$131494[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T134257[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T134257[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$131494[ebp]
	mov	DWORD PTR __Pf$131507[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$131494[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$131494[ebp]
	mov	DWORD PTR __Pfmod$131518[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$131518[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$131507[ebp]
	mov	DWORD PTR $T134258[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$131493[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T134258[ebp]
$LN8@use_facet:
...
; 78   : 				_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$117464[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 2535 : 		_Dest, _Ptr_cat(_First, _Dest)));
	...
	add	esp, 8
	mov	BYTE PTR $T134287[ebp], al
	movzx	edx, BYTE PTR $T134287[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	call	??$_Ptr_cat@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@0@Z ; std::_Ptr_cat<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::basic_string<char,std::char_traits<char>,std::allocator<char> > >
	add	esp, 8
	mov	BYTE PTR $T134290[ebp], al
	movzx	edx, BYTE PTR $T134290[ebp]
	push	edx
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T134297[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T134297[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T134304[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T134304[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T134300[ebp]
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$129959[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$129959[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$129959[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 28					; 0000001cH
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T134434[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T134434[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$129938[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$129938[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase@2:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T134633[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T134633[ebp], 0
	...
	mov	ecx, DWORD PTR $T134633[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T134633[ebp]
...
; 933  : 		{	// construct unopened
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T134653[ebp]
	or	ecx, 1
	mov	DWORD PTR $T134653[ebp], ecx
$LN1@basic_ofst:
	push	0
	push	0
	mov	edx, DWORD PTR _this$[ebp]
...
__unwindfunclet$??0?$basic_ofstream@DU?$char_traits@D@std@@@std@@QAE@XZ$0:
	mov	eax, DWORD PTR $T134653[ebp]
	and	eax, 1
	je	$LN5@basic_ofst
	and	DWORD PTR $T134653[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 96					; 00000060H
...
; 359  : 			? _Traits::eof() : _Traits::to_int_type(*_Gninc()));
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T134723[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134724[ebp], eax
	lea	ecx, DWORD PTR $T134723[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134724[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 379  : 			else if (_Traits::eq_int_type(_Traits::eof(), _Meta = uflow()))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134729[ebp], eax
	lea	ecx, DWORD PTR __Meta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134729[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 408  : 				overflow(_Traits::to_int_type(*_Ptr))))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T134740[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134741[ebp], eax
	lea	ecx, DWORD PTR $T134740[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134741[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
$T134765 = -112						; size = 4
$T134762 = -108						; size = 4
__Count$129635 = -104					; size = 4
__Str$129540 = -96					; size = 32
__Dest$129539 = -56					; size = 4
__Src$129538 = -44					; size = 4
__Ch$129537 = -29					; size = 1
__STRING_INC$129536 = -24				; size = 4
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
__Meta$ = 8						; size = 4
...
; 322  : 		{	// put an element to stream
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T134784[ebp], 0

; 323  : 		if (_Traits::eq_int_type(_Traits::eof(), _Meta))

	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134762[ebp], eax
...
; 339  : 			const int _STRING_INC = 8;
	...
	mov	DWORD PTR __STRING_INC$129536[ebp], 8
...
; 340  : 			const _Elem _Ch = _Traits::to_char_type(_Meta);
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR __Ch$129537[ebp], al
...
; 344  : 			string _Str(_STRING_INC, '\0');
	...
	push	0
	push	8
	lea	ecx, DWORD PTR __Str$129540[ebp]
...
; 348  : 					&*_Str.begin(), &*_Str.begin() + _Str.size(), _Dest))
	...
	lea	edx, DWORD PTR __Dest$129539[ebp]
	push	edx
	lea	eax, DWORD PTR $T134766[ebp]
	push	eax
	lea	ecx, DWORD PTR __Str$129540[ebp]
	...
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	push	eax
	lea	ecx, DWORD PTR __Src$129538[ebp]
	push	ecx
	lea	edx, DWORD PTR __Ch$129537[ebp+1]
	push	edx
	lea	eax, DWORD PTR __Ch$129537[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 353  : 					size_t _Count = _Dest - &*_Str.begin();
	...
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	mov	ecx, DWORD PTR __Dest$129539[ebp]
	sub	ecx, eax
	mov	DWORD PTR __Count$129635[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T134768[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 355  : 						fwrite(&*_Str.begin(), 1, _Count, _Myfile))
	...
	cmp	DWORD PTR __Count$129635[ebp], 0
	jbe	SHORT $LN25@overflow
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+84]
	push	eax
	mov	ecx, DWORD PTR __Count$129635[ebp]
	push	ecx
	push	1
	lea	edx, DWORD PTR $T134770[ebp]
	push	edx
	lea	ecx, DWORD PTR __Str$129540[ebp]
	call	?begin@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE?AV?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::begin
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 4
	mov	ecx, DWORD PTR $T134784[ebp]
	or	ecx, 1
	mov	DWORD PTR $T134784[ebp], ecx
	mov	ecx, DWORD PTR tv246[ebp]
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	push	eax
	call	_fwrite
	add	esp, 16					; 00000010H
	cmp	DWORD PTR __Count$129635[ebp], eax
...
$LN26@overflow:
	...
	mov	BYTE PTR $T134769[ebp], dl
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR $T134784[ebp]
	and	eax, 1
	je	SHORT $LN35@overflow
	and	DWORD PTR $T134784[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T134770[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN35@overflow:
	movzx	ecx, BYTE PTR $T134769[ebp]
	test	ecx, ecx
...
; 356  : 						return (_Traits::eof());	// write failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134773[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129540[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134773[ebp]
	jmp	$LN21@overflow
$LN8@overflow:
...
; 359  : 					if (_Src != &_Ch)
	...
	mov	eax, DWORD PTR __Src$129538[ebp]
	lea	ecx, DWORD PTR __Ch$129537[ebp]
	cmp	eax, ecx
...
; 360  : 						return (_Meta);	// converted whole element
	...
	mov	DWORD PTR $T134774[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129540[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134774[ebp]
	jmp	$LN21@overflow
$LN7@overflow:
...
; 367  : 						return (_Traits::eof());	// conversion failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134775[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129540[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134775[ebp]
	jmp	$LN21@overflow
$LN5@overflow:
...
; 373  : 						: _Traits::eof());	// no conversion, put as is
	...
	push	ecx
	movzx	edx, BYTE PTR __Ch$129537[ebp]
	push	edx
	call	??$_Fputc@D@std@@YA_NDPAU_iobuf@@@Z	; std::_Fputc<char>
	add	esp, 8
	movzx	eax, al
...
; 376  : 					return (_Traits::eof());	// conversion failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134779[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129540[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134779[ebp]
	jmp	SHORT $LN21@overflow
$LN10@overflow:
...
; 388  : 				_Meta)))
	...
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR $T134809[ebp], eax
	lea	eax, DWORD PTR __Meta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T134809[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
; 393  : 		else if (_Myfile == 0 || _Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134810[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T134810[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
; 395  : 		else if (_Pcvt == 0 && _Ungetc(_Traits::to_char_type(_Meta), _Myfile))
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR $T134811[ebp], al
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+84]
	push	edx
	lea	eax, DWORD PTR $T134811[ebp]
	push	eax
...
; 413  : 		else if (_Traits::eq_int_type(_Traits::eof(), _Meta = uflow()))
	...
	mov	DWORD PTR __Meta$[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134816[ebp], eax
	lea	ecx, DWORD PTR __Meta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134816[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
$T134826 = -124						; size = 4
$T134825 = -120						; size = 4
__Meta$129692 = -116					; size = 4
__Nleft$129691 = -112					; size = 4
__Src$129690 = -104					; size = 4
__Dest$129689 = -92					; size = 4
__Ch$129688 = -77					; size = 1
__Str$129684 = -68					; size = 32
__Ch$129682 = -25					; size = 1
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
...
; 433  : 			_Elem _Ch = 0;
	...
	mov	BYTE PTR __Ch$129682[ebp], 0
...
; 435  : 				: _Traits::eof());
	...
	mov	eax, DWORD PTR [edx+84]
	push	eax
	lea	ecx, DWORD PTR __Ch$129682[ebp]
	push	ecx
	...
	lea	eax, DWORD PTR __Ch$129682[ebp]
	push	eax
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
...
; 439  : 			string _Str;
	...
	lea	ecx, DWORD PTR __Str$129684[ebp]
...
; 446  : 				int _Meta = fgetc(_Myfile);
	...
	call	_fgetc
	add	esp, 4
	mov	DWORD PTR __Meta$129692[ebp], eax

; 447  : 
; 448  : 				if (_Meta == EOF)

	cmp	DWORD PTR __Meta$129692[ebp], -1
...
; 451  : 				_Str.append(1, (char)_Meta);	// append byte and convert
	...
	movzx	eax, BYTE PTR __Meta$129692[ebp]
	push	eax
	push	1
	lea	ecx, DWORD PTR __Str$129684[ebp]
	call	?append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::append
...
; 454  : 					&_Ch, &_Ch + 1, _Dest))
	...
	lea	ecx, DWORD PTR __Dest$129689[ebp]
	push	ecx
	lea	edx, DWORD PTR __Ch$129688[ebp+1]
	push	edx
	lea	eax, DWORD PTR __Ch$129688[ebp]
	push	eax
	lea	ecx, DWORD PTR __Src$129690[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134827[ebp]
	push	edx
	lea	ecx, DWORD PTR __Str$129684[ebp]
	call	?begin@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE?AV?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::begin
	...
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T134827[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	edx, DWORD PTR $T134826[ebp]
...
; 458  : 					if (_Dest != &_Ch)
	...
	mov	eax, DWORD PTR __Dest$129689[ebp]
	lea	ecx, DWORD PTR __Ch$129688[ebp]
	cmp	eax, ecx
	je	$LN7@uflow@2
...
; 460  : 						_Nleft = (int)(&*_Str.begin() + _Str.size() - _Src);
	...
	call	?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::size
	add	esi, eax
	sub	esi, DWORD PTR __Src$129690[ebp]
	mov	DWORD PTR __Nleft$129691[ebp], esi
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T134829[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN6@uflow@2:

; 461  : 						for (; 0 < _Nleft; )

	cmp	DWORD PTR __Nleft$129691[ebp], 0
	jle	SHORT $LN5@uflow@2

; 462  : 							ungetc(_Src[--_Nleft], _Myfile);

	mov	ecx, DWORD PTR __Nleft$129691[ebp]
	sub	ecx, 1
	mov	DWORD PTR __Nleft$129691[ebp], ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+84]
	push	eax
	mov	ecx, DWORD PTR __Src$129690[ebp]
	add	ecx, DWORD PTR __Nleft$129691[ebp]
...
; 463  : 						return (_Traits::to_int_type(_Ch));
	...
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR $T134830[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129684[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134830[ebp]
	jmp	$LN19@uflow@2
...
; 477  : 					return (_Traits::to_int_type(_Ch));	// return result
	...
	lea	edx, DWORD PTR __Ch$129688[ebp]
	push	edx
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR $T134833[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129684[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134833[ebp]
...
; 480  : 					return (_Traits::eof());	// conversion failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134834[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$129684[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T134834[ebp]
	jmp	SHORT $LN19@uflow@2
$LN9@uflow@2:
...
; 546  : 			|| 0 <= fflush(_Myfile) ? 0 : -1);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T134882[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134883[ebp], eax
	lea	ecx, DWORD PTR $T134882[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134883[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 1351 : 		return (_STRING_ITERATOR(_Myptr()));
	...
	mov	ecx, DWORD PTR $T134918[ebp]
	or	ecx, 1
	mov	DWORD PTR $T134918[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 46   : 	explicit __CLR_OR_THIS_CALL basic_ostream(
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T134937[ebp]
	or	ecx, 1
	mov	DWORD PTR $T134937[ebp], ecx
$LN1@basic_ostr:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR [eax+4]
...
__unwindfunclet$??0?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@_N@Z$0:
	mov	eax, DWORD PTR $T134937[ebp]
	and	eax, 1
	je	$LN5@basic_ostr
	and	DWORD PTR $T134937[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN5@basic_ostr:
...
$T134988 = -88						; size = 4
$T134987 = -84						; size = 4
__Count$130521 = -80					; size = 4
__Str$130508 = -72					; size = 32
__Dest$130504 = -32					; size = 4
__STRING_INC$130503 = -24				; size = 4
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
...
; 592  : 			const int _STRING_INC = 8;
	...
	mov	DWORD PTR __STRING_INC$130503[ebp], 8
...
; 594  : 			if (_Traits::eq_int_type(_Traits::eof(), overflow()))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T134987[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T134988[ebp], eax
	lea	ecx, DWORD PTR $T134987[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134988[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 597  : 			string _Str(_STRING_INC, '\0');
	...
	push	0
	push	8
	lea	ecx, DWORD PTR __Str$130508[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
$LN11@Endwrite:
...
; 600  : 					&*_Str.begin(), &*_Str.begin() + _Str.size(), _Dest))
	...
	lea	ecx, DWORD PTR __Dest$130504[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134990[ebp]
	push	edx
	lea	ecx, DWORD PTR __Str$130508[ebp]
	call	?begin@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE?AV?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::begin
	...
	mov	DWORD PTR $T134989[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	lea	ecx, DWORD PTR $T134991[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T134990[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	edx, DWORD PTR $T134989[ebp]
...
; 607  : 					size_t _Count = _Dest - &*_Str.begin();
	...
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	mov	ecx, DWORD PTR __Dest$130504[ebp]
	sub	ecx, eax
	mov	DWORD PTR __Count$130521[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T134992[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
...
; 609  : 						fwrite(&*_Str.begin(), 1, _Count, _Myfile))
	...
	cmp	DWORD PTR __Count$130521[ebp], 0
	jbe	SHORT $LN18@Endwrite
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+84]
	push	eax
	mov	ecx, DWORD PTR __Count$130521[ebp]
	push	ecx
	push	1
	lea	edx, DWORD PTR $T134994[ebp]
	push	edx
	lea	ecx, DWORD PTR __Str$130508[ebp]
	call	?begin@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE?AV?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::begin
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 4
	mov	ecx, DWORD PTR $T135005[ebp]
	or	ecx, 1
	mov	DWORD PTR $T135005[ebp], ecx
	mov	ecx, DWORD PTR tv197[ebp]
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	push	eax
	call	_fwrite
	add	esp, 16					; 00000010H
	cmp	DWORD PTR __Count$130521[ebp], eax
...
$LN19@Endwrite:
	...
	mov	BYTE PTR $T134993[ebp], dl
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR $T135005[ebp]
	and	eax, 1
	je	SHORT $LN26@Endwrite
	and	DWORD PTR $T135005[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T134994[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN26@Endwrite:
	movzx	ecx, BYTE PTR $T134993[ebp]
	test	ecx, ecx
	je	SHORT $LN5@Endwrite

; 610  : 						return (false);	// write failed

	mov	BYTE PTR $T134997[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$130508[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	al, BYTE PTR $T134997[ebp]
	jmp	$LN16@Endwrite
$LN5@Endwrite:
...
; 612  : 						return (true);
	...
	mov	BYTE PTR $T134998[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$130508[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	al, BYTE PTR $T134998[ebp]
...
; 619  : 					return (true);	// nothing to do
	...
	mov	BYTE PTR $T134999[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$130508[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	al, BYTE PTR $T134999[ebp]
	jmp	SHORT $LN16@Endwrite
$LN1@Endwrite:
...
; 622  : 					return (false);	// conversion failed
	...
	mov	BYTE PTR $T135000[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$130508[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	al, BYTE PTR $T135000[ebp]
	jmp	SHORT $LN16@Endwrite
$LN8@Endwrite:
...
; 564  : 		_Ploc = _NEW_CRT locale;
	...
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T135049[ebp], eax
	cmp	DWORD PTR $T135049[ebp], 0
	je	SHORT $LN3@Init@2
	mov	ecx, DWORD PTR $T135049[ebp]
...
; 25   : 		{	// construct with no buffers
	...
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T135058[ebp], eax
	cmp	DWORD PTR $T135058[ebp], 0
	je	SHORT $LN3@basic_stre
	mov	ecx, DWORD PTR $T135058[ebp]
	call	??0locale@std@@QAE@XZ			; std::locale::locale
	mov	DWORD PTR tv79[ebp], eax
...
; 452  : 		return (*_Ploc);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0locale@std@@QAE@ABV01@@Z		; std::locale::locale
	mov	edx, DWORD PTR $T135092[ebp]
	or	edx, 1
	mov	DWORD PTR $T135092[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T135109 = -64						; size = 4
$T135108 = -60						; size = 12
__Pfmod$131283 = -48					; size = 4
__Pf$131267 = -44					; size = 4
__Id$131266 = -40					; size = 4
__Psave$131254 = -32					; size = 4
__Lock$131253 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$131253[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$131254[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$131266[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$131266[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$131267[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$131267[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$131254[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$131254[ebp]
	mov	DWORD PTR __Pf$131267[ebp], edx
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$131254[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T135108[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T135108[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$131254[ebp]
	mov	DWORD PTR __Pf$131267[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$131254[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$131254[ebp]
	mov	DWORD PTR __Pfmod$131283[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$131283[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$131267[ebp]
	mov	DWORD PTR $T135109[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$131253[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T135109[ebp]
$LN8@use_facet@2:
...
; 2374 : 				_Locinfo(_Ploc->c_str()));
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T135126[ebp], eax
	push	2373					; 00000945H
	push	OFFSET ??_C@_0EH@OEAMKACA@c?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T135126[ebp]
	push	ecx
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T135125[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T135125[ebp], 0
	je	SHORT $LN4@Getcat@2
	push	0
	mov	ecx, DWORD PTR __Ploc$[ebp]
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T135127[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv138[ebp], eax
	mov	edx, DWORD PTR tv138[ebp]
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T135131[ebp]
	or	eax, 1
	mov	DWORD PTR $T135131[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T135125[ebp]
...
$LN5@Getcat@2:
	mov	edx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T135124[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T135124[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T135131[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T135131[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T135127[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
; 118  : 		return (::_Getctype());
	...
	lea	eax, DWORD PTR $T135164[ebp]
	push	eax
	call	__Getctype
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T135163[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T135163[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T135163[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T135163[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T135163[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T135163[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T135163[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T135163[ebp+12]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T135194[ebp], edx
	mov	eax, DWORD PTR $T135194[ebp]
	push	eax
