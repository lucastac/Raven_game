; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Lucas\Desktop\jogos - game ai by example\Raven_Game\Buckland_Chapter7 to 10_Raven\triggers\Trigger_HealthGiver.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG132248 DB	'DefaultGiverTriggerRange', 00H
	ORG $+3
$SG132250 DB	'Health_RespawnDelay', 00H
CONST	ENDS
...
; File c:\users\lucas\desktop\jogos - game ai by example\raven_game\buckland_chapter7 to 10_raven\triggers\trigger_healthgiver.cpp
rdata$r	SEGMENT
...
; 36   :     const int sz = 5;
	...
	mov	DWORD PTR _sz$132131[ebp], 5
...
$LN9@operator:
	...
	push	eax
	lea	ecx, DWORD PTR $T140826[ebp]
	call	??0?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z ; std::istreambuf_iterator<char,std::char_traits<char> >::istreambuf_iterator<char,std::char_traits<char> >
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T140827[ebp]
	push	eax
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T140853[ebp], eax
	lea	ecx, DWORD PTR __Lock$33243[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T140853[ebp]
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T140861[ebp]
	or	edx, 1
	mov	DWORD PTR $T140861[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$LN6@operator@2:
	...
	push	eax
	lea	ecx, DWORD PTR $T140886[ebp]
	call	??0?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z ; std::istreambuf_iterator<char,std::char_traits<char> >::istreambuf_iterator<char,std::char_traits<char> >
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T140887[ebp]
	push	eax
...
; 426  : 		return (*this);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T140888[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_istream@DU?$char_traits@D@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T140888[ebp]
...
; 67   :   virtual ~Trigger(){delete m_pRegionOfInfluence;}
	...
	mov	DWORD PTR $T140939[ebp], eax
	cmp	DWORD PTR $T140939[ebp], 0
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	lea	ecx, DWORD PTR $T140973[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T140973[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
$LN5@snextc:
	...
	mov	DWORD PTR $T141066[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T141067[ebp], eax
	lea	eax, DWORD PTR $T141066[ebp]
	push	eax
	lea	ecx, DWORD PTR $T141067[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	DWORD PTR $T141112[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$136077[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T141112[ebp]
$LN8@use_facet:
...
; 2374 : 				_Locinfo(_Ploc->c_str()));
	...
	mov	eax, DWORD PTR $T141148[ebp]
	or	eax, 1
	mov	DWORD PTR $T141148[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T141142[ebp]
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T141141[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T141141[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T141148[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T141148[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T141144[ebp]
...
; 78   :             _THROW_NCEE(runtime_error, "bad locale name");
	...
	lea	ecx, DWORD PTR $T141160[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T141160[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
...
; 118  : 		return (::_Getctype());
	...
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T141221[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T141221[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T141221[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T141221[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T141221[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T141221[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T141221[ebp+12]
	mov	DWORD PTR [eax+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T141252[ebp], edx
	mov	eax, DWORD PTR $T141252[ebp]
	push	eax
...
; 91   :   if (m_pRegionOfInfluence) delete m_pRegionOfInfluence;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+64]
	mov	DWORD PTR $T141273[ebp], edx
	mov	eax, DWORD PTR $T141273[ebp]
	mov	DWORD PTR $T141272[ebp], eax
	cmp	DWORD PTR $T141272[ebp], 0
	je	SHORT $LN4@AddCircula
	mov	esi, esp
	push	1
	mov	ecx, DWORD PTR $T141272[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR $T141272[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
...
; 93   :   m_pRegionOfInfluence = new TriggerRegion_Circle(center, radius);
	...
	add	esp, 4
	mov	DWORD PTR $T141277[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T141277[ebp], 0
...
$LN7@AddCircula:
	...
	mov	DWORD PTR $T141276[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR $T141276[ebp]
...
; 165  : 		{	// construct from message string
	...
	mov	DWORD PTR $T141324[ebp], eax
	lea	eax, DWORD PTR $T141324[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	??0exception@std@@QAE@ABQBD@Z		; std::exception::exception
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T141404[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T141404[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T141470[ebp]
	or	ecx, 1
	mov	DWORD PTR $T141470[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T141470[ebp]
	and	eax, 1
	je	$LN5@operator@4
	and	DWORD PTR $T141470[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@4:
	ret	0
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T141533[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T141533[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 246  : 				_Locinfo(_Ploc->c_str()));
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T141579[ebp], 0
	je	SHORT $LN4@Getcat@2
	push	0
	mov	ecx, DWORD PTR __Ploc$[ebp]
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T141581[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv138[ebp], eax
	mov	edx, DWORD PTR tv138[ebp]
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T141585[ebp]
	or	eax, 1
	mov	DWORD PTR $T141585[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T141579[ebp]
...
$LN5@Getcat@2:
	mov	edx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T141578[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T141578[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T141585[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T141585[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T141581[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
; 859  : 		return (_Pten);
	...
	mov	ecx, DWORD PTR __Pten$[ebp]
	mov	DWORD PTR $T141855[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T141855[ebp]
$LN70@Getffld:
...
; 84   : 		return (do_falsename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T141872[ebp]
	or	ecx, 1
	mov	DWORD PTR $T141872[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 89   : 		return (do_truename());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T141877[ebp]
	or	ecx, 1
	mov	DWORD PTR $T141877[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1029 : 		return (0);	// power of 10 multiplier
	...
	mov	DWORD PTR $T141887[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T141887[ebp]
...
; 79   : 		return (do_grouping());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T141912[ebp]
	or	ecx, 1
	mov	DWORD PTR $T141912[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 548  : 				_Strbuf->sbumpc()))
	...
	lea	edx, DWORD PTR $T141918[ebp]
	push	edx
	lea	eax, DWORD PTR $T141919[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
; 728  : 	_Debug_range2(_First, _Last, _File, _Line, _Iter_cat(_First));
	...
	add	esp, 4
	mov	BYTE PTR $T141928[ebp], al
	movzx	ecx, BYTE PTR $T141928[ebp]
	push	ecx
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	DWORD PTR $T141932[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$136848[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T141932[ebp]
$LN8@use_facet@3:
...
; 582  : 	return (_Ans);	// return field number or negative value on failure
	...
	mov	ecx, DWORD PTR __Ans$[ebp]
	mov	DWORD PTR $T141952[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T141952[ebp]
...
; 114  : 				_Locinfo(_Ploc->c_str()), 0, true);
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T141981[ebp], eax
	push	113					; 00000071H
	push	OFFSET ??_C@_0EH@GHEBKCIB@c?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T141981[ebp]
	push	ecx
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	...
	mov	DWORD PTR tv134[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T141986[ebp]
	or	eax, 1
	mov	DWORD PTR $T141986[ebp], eax
	mov	ecx, DWORD PTR tv134[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T141980[ebp]
...
$LN5@Getcat@3:
	...
	mov	DWORD PTR $T141979[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T141979[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T141986[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@3
	and	DWORD PTR $T141986[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T141982[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@3:
...
; 174  : 		return (string(_Grouping));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T142012[ebp]
	or	edx, 1
	mov	DWORD PTR $T142012[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 179  : 		return (string_type(_Falsename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T142017[ebp]
	or	edx, 1
	mov	DWORD PTR $T142017[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 184  : 		return (string_type(_Truename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T142022[ebp]
	or	edx, 1
	mov	DWORD PTR $T142022[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 123  : 		return (::_Getcvt());
	...
	call	__Getcvt
	mov	DWORD PTR $T142044[ebp], eax
	mov	DWORD PTR $T142044[ebp+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T142044[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T142044[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 660  : 	_Elem *_Ptrdest = _NEW_CRT _Elem[_Count];
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T142097[ebp], eax
	mov	edx, DWORD PTR $T142097[ebp]
