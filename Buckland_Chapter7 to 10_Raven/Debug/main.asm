; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Lucas\Desktop\jogos - game ai by example\Bluckland_SourceCode - new version\VS2010\Raven_Game\Buckland_Chapter7 to 10_Raven\main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
_DATA	SEGMENT
?g_szApplicationName@@3PADA DD FLAT:$SG141266		; g_szApplicationName
?g_szWindowClassName@@3PADA DD FLAT:$SG141268		; g_szWindowClassName
_DATA	ENDS
CONST	SEGMENT
...
$SG141329 DB	'map', 00H
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG141266 DB	'Raven', 00H
$SG141341 DB	00H
	ORG $+1
$SG141268 DB	'MyWindowClass', 00H
	ORG $+2
$SG141330 DB	'Raven map file (*.map)', 00H
	ORG $+1
$SG141340 DB	'Filename: ', 00H
	ORG $+1
$SG141393 DB	'Error', 00H
	ORG $+2
$SG141394 DB	'Registration Failed!', 00H
	ORG $+3
$SG141397 DB	'Error!', 00H
	ORG $+1
$SG141398 DB	'CreateWindowEx Failed!', 00H
CONST	ENDS
...
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\raven_game\buckland_chapter7 to 10_raven\main.cpp
_BSS	SEGMENT
...
$T152102 = -224						; size = 4
$T152101 = -220						; size = 4
_hdc$141368 = -216					; size = 4
_ps$141360 = -208					; size = 64
$T141343 = -140						; size = 32
$T141328 = -108						; size = 32
$T141327 = -76						; size = 32
_hdc$141297 = -44					; size = 4
_rect$141295 = -36					; size = 16
...
; 69   : 			   GetClientRect(hwnd, &rect);
	...
	mov	esi, esp
	lea	ecx, DWORD PTR _rect$141295[ebp]
	push	ecx
...
; 84   :          HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$141297[ebp], eax
...
; 88   :                                           cyClient);
	...
	push	ecx
	mov	edx, DWORD PTR _hdc$141297[ebp]
	push	edx
...
; 98   :          g_pRaven = new Raven_Game();
	...
	add	esp, 4
	mov	DWORD PTR $T152102[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T152102[ebp], 0
	je	SHORT $LN43@WindowProc
	mov	ecx, DWORD PTR $T152102[ebp]
...
$LN44@WindowProc:
	...
	mov	DWORD PTR $T152101[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T152101[ebp]
...
; 204  :           FileOpenDlg(hwnd, szFileName, szTitleName, "Raven map file (*.map)", "map");
	...
	push	OFFSET $SG141329
	lea	ecx, DWORD PTR $T141327[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 1
	push	OFFSET $SG141330
	lea	ecx, DWORD PTR $T141328[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	lea	ecx, DWORD PTR $T141327[ebp]
	push	ecx
	lea	edx, DWORD PTR $T141328[ebp]
	push	edx
...
; 206  :           debug_con << "Filename: " << szTitleName << "";
	...
	push	OFFSET $SG141341
	push	OFFSET ?szTitleName@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4PADA
	push	OFFSET $SG141340
...
; 343  :          BeginPaint (hwnd, &ps);
	...
	mov	esi, esp
	lea	eax, DWORD PTR _ps$141360[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
...
; 365  : 			   BitBlt(ps.hdc, 0, 0, cxClient, cyClient, hdcBackBuffer, 0, 0, SRCCOPY); 
	...
	push	0
	push	0
	mov	ecx, DWORD PTR _ps$141360[ebp]
	push	ecx
	call	DWORD PTR __imp__BitBlt@36
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 367  :          EndPaint (hwnd, &ps);
	...
	mov	esi, esp
	lea	edx, DWORD PTR _ps$141360[ebp]
	push	edx
	mov	eax, DWORD PTR _hwnd$[ebp]
	push	eax
...
; 389  :         HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$141368[ebp], eax
...
; 395  : 											  cyClient);
	...
	mov	ecx, DWORD PTR ?cxClient@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4HA
	push	ecx
	mov	edx, DWORD PTR _hdc$141368[ebp]
	push	edx
	call	DWORD PTR __imp__CreateCompatibleBitmap@12
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 397  : 			  ReleaseDC(hwnd, hdc);
	...
	mov	esi, esp
	mov	eax, DWORD PTR _hdc$141368[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
	call	DWORD PTR __imp__ReleaseDC@8
...
PUBLIC	??_C@_1NO@HPPJILJN@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAL?$AAu?$AAc?$AAa?$AAs?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAj?$AAo?$AAg?$AAo?$AAs?$AA?5?$AA?9?$AA?5?$AAg@ ; `string'
...
??_C@_1BM@MMNOPHKK@?$AAm?$AA_?$AAh?$AAd?$AAc?$AA?5?$AA?$DN?$AA?$DN?$AA?5?$AAN?$AAU?$AAL?$AAL?$AA?$AA@ DB 'm'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1NO@HPPJILJN@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAL?$AAu?$AAc?$AAa?$AAs?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAj?$AAo?$AAg?$AAo?$AAs?$AA?5?$AA?9?$AA?5?$AAg@
CONST	SEGMENT
??_C@_1NO@HPPJILJN@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAL?$AAu?$AAc?$AAa?$AAs?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAj?$AAo?$AAg?$AAo?$AAs?$AA?5?$AA?9?$AA?5?$AAg@ DB 'C'
...
; 177  :     assert(m_hdc == NULL);
	...
	push	177					; 000000b1H
	push	OFFSET ??_C@_1NO@HPPJILJN@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAL?$AAu?$AAc?$AAa?$AAs?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAj?$AAo?$AAg?$AAo?$AAs?$AA?5?$AA?9?$AA?5?$AAg@
...
$T152147 = -280						; size = 4
$T141411 = -276						; size = 32
_err$141410 = -240					; size = 4
_bDone$141400 = -229					; size = 1
_timer$141399 = -224					; size = 104
...
; 463  : 		MessageBox(NULL, "Registration Failed!", "Error", 0);
	...
	mov	esi, esp
	push	0
	push	OFFSET $SG141393
	push	OFFSET $SG141394
	push	0
...
; 489  :        MessageBox(NULL, "CreateWindowEx Failed!", "Error!", 0);
	...
	mov	esi, esp
	push	0
	push	OFFSET $SG141397
	push	OFFSET $SG141398
	push	0
	call	DWORD PTR __imp__MessageBoxA@16
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 498  :     PrecisionTimer timer(FrameRate);
	...
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _timer$141399[ebp]
...
; 504  :     bool bDone = false;
	...
	mov	BYTE PTR _bDone$141400[ebp], 0
$LN7@WinMain:

; 505  : 
; 506  :     while(!bDone)

	movzx	ecx, BYTE PTR _bDone$141400[ebp]
	test	ecx, ecx
	jne	$LN6@WinMain
$LN5@WinMain:
...
; 513  : 	        bDone = true;
	...
	mov	BYTE PTR _bDone$141400[ebp], 1
...
; 540  :     ErrorBox(std::string(err.what()));
	...
	mov	esi, esp
	mov	ecx, DWORD PTR _err$141410[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _err$141410[ebp]
...
; 542  :     delete g_pRaven;
	...
	mov	DWORD PTR $T152148[ebp], eax
	mov	ecx, DWORD PTR $T152148[ebp]
	mov	DWORD PTR $T152147[ebp], ecx
	cmp	DWORD PTR $T152147[ebp], 0
	je	SHORT $LN13@WinMain
	push	1
	mov	ecx, DWORD PTR $T152147[ebp]
...
; 549  :  delete g_pRaven;
	...
	mov	eax, DWORD PTR ?g_pRaven@@3PAVRaven_Game@@A ; g_pRaven
	mov	DWORD PTR $T152153[ebp], eax
	mov	ecx, DWORD PTR $T152153[ebp]
	mov	DWORD PTR $T152152[ebp], ecx
	cmp	DWORD PTR $T152152[ebp], 0
	je	SHORT $LN15@WinMain
	push	1
	mov	ecx, DWORD PTR $T152152[ebp]
	call	??_GRaven_Game@@QAEPAXI@Z
...
PUBLIC	??_C@_1PC@IHHJPKAI@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAL?$AAu?$AAc?$AAa?$AAs?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAj?$AAo?$AAg?$AAo?$AAs?$AA?5?$AA?9?$AA?5?$AAg@ ; `string'
...
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\common\time\precisiontimer.h
CONST	SEGMENT
...
CONST	ENDS
;	COMDAT ??_C@_1PC@IHHJPKAI@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAL?$AAu?$AAc?$AAa?$AAs?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAj?$AAo?$AAg?$AAo?$AAs?$AA?5?$AA?9?$AA?5?$AAg@
CONST	SEGMENT
??_C@_1PC@IHHJPKAI@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAL?$AAu?$AAc?$AAa?$AAs?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAj?$AAo?$AAg?$AAo?$AAs?$AA?5?$AA?9?$AA?5?$AAg@ DB 'C'
	DB	00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H, 'r', 00H
	DB	's', 00H, '\', 00H, 'L', 00H, 'u', 00H, 'c', 00H, 'a', 00H, 's'
	DB	00H, '\', 00H, 'D', 00H, 'e', 00H, 's', 00H, 'k', 00H, 't', 00H
	DB	'o', 00H, 'p', 00H, '\', 00H, 'j', 00H, 'o', 00H, 'g', 00H, 'o'
...
$LN4@ReadyForNe:
	push	90					; 0000005aH
	push	OFFSET ??_C@_1PC@IHHJPKAI@?$AAC?$AA?3?$AA?2?$AAU?$AAs?$AAe?$AAr?$AAs?$AA?2?$AAL?$AAu?$AAc?$AAa?$AAs?$AA?2?$AAD?$AAe?$AAs?$AAk?$AAt?$AAo?$AAp?$AA?2?$AAj?$AAo?$AAg?$AAo?$AAs?$AA?5?$AA?9?$AA?5?$AAg@
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\common\misc\windowutils.h
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$143253[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$143253[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$143253[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T152262[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T152262[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$143232[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$143232[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T152333[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T152333[ebp]
$LN7@operator:
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T152359[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T152360[ebp], edx
	lea	eax, DWORD PTR $T152359[ebp]
	push	eax
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T152361[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T152362[ebp], edx
	lea	eax, DWORD PTR $T152361[ebp]
	push	eax
	lea	ecx, DWORD PTR $T152362[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	push	1
	lea	ecx, DWORD PTR $T152413[ebp]
	push	ecx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BF@OOHOMBOF@ios_base?3?3eofbit?5set?$AA@
	lea	ecx, DWORD PTR $T152412[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T152412[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
$LN5@sputc:
	...
	mov	eax, DWORD PTR $T152461[ebp]
	mov	cl, BYTE PTR __Ch$[ebp]
	mov	BYTE PTR [eax], cl
	mov	edx, DWORD PTR $T152461[ebp]
	push	edx
...
; 166  :     if (ss.str() == ""){flush(); return *this;}
	...
	call	??$?8DU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z ; std::operator==<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 8
	mov	BYTE PTR $T152525[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T146747[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	movzx	ecx, BYTE PTR $T152525[ebp]
	test	ecx, ecx
	je	SHORT $LN3@operator@3
	call	?flush@DebugConsole@@SAXXZ		; DebugConsole::flush
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T152526[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T152526[ebp]
	jmp	$LN7@operator@3
$LN3@operator@3:
...
; 166  :     if (ss.str() == ""){flush(); return *this;}
	...
	call	??$?8DU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z ; std::operator==<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 8
	mov	BYTE PTR $T152544[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T146762[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	movzx	ecx, BYTE PTR $T152544[ebp]
	test	ecx, ecx
	je	SHORT $LN3@operator@4
	call	?flush@DebugConsole@@SAXXZ		; DebugConsole::flush
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T152545[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
...
; 634  : 			size_type _Idx = _STD addressof(_Val) - this->_Myfirst;
	...
	sar	eax, 5
	mov	DWORD PTR __Idx$147917[ebp], eax
...
; 640  : 				_STD forward<_Ty>(this->_Myfirst[_Idx]));
	...
	mov	eax, DWORD PTR __Idx$147917[ebp]
	shl	eax, 5
	mov	ecx, DWORD PTR _this$[ebp]
	add	eax, DWORD PTR [ecx+4]
	push	eax
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T152697[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T152697[ebp], 0
...
; 537  : 		{	// construct empty writable character buffer
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T152715[ebp]
	or	ecx, 1
	mov	DWORD PTR $T152715[ebp], ecx
$LN1@basic_ostr:
	push	0
	push	0
	mov	edx, DWORD PTR _this$[ebp]
...
__unwindfunclet$??0?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@H@Z$0:
	mov	eax, DWORD PTR $T152715[ebp]
	and	eax, 1
	je	$LN5@basic_ostr
	and	DWORD PTR $T152715[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 80					; 00000050H
...
; 379  : 			else if (_Traits::eq_int_type(_Traits::eof(), _Meta = uflow()))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T152785[ebp], eax
	lea	ecx, DWORD PTR __Meta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T152785[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 408  : 				overflow(_Traits::to_int_type(*_Ptr))))
	...
	lea	ecx, DWORD PTR $T152796[ebp]
	push	ecx
	lea	edx, DWORD PTR $T152797[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
tv195 = -32						; size = 4
$T152846 = -28						; size = 4
__Oldptr$148155 = -24					; size = 4
__Newptr$148154 = -20					; size = 4
__Inc$148149 = -16					; size = 4
__Newsize$148148 = -12					; size = 4
__Oldsize$148147 = -8					; size = 4
_this$ = -4						; size = 4
__Meta$ = 8						; size = 4
...
$LN22@overflow:
	...
	mov	DWORD PTR __Oldsize$148147[ebp], eax

; 139  : 			size_t _Newsize = _Oldsize;

	mov	ecx, DWORD PTR __Oldsize$148147[ebp]
	mov	DWORD PTR __Newsize$148148[ebp], ecx

; 140  : 			size_t _Inc = _Newsize / 2 < _MINSIZE
; 141  : 				? _MINSIZE : _Newsize / 2;	// grow by 50 per cent

	mov	edx, DWORD PTR __Newsize$148148[ebp]
	shr	edx, 1
...
$LN23@overflow:
	mov	eax, DWORD PTR __Newsize$148148[ebp]
	shr	eax, 1
	mov	DWORD PTR tv199[ebp], eax
$LN24@overflow:
	mov	ecx, DWORD PTR tv199[ebp]
	mov	DWORD PTR __Inc$148149[ebp], ecx
$LN11@overflow:

; 142  : 
; 143  : 			while (0 < _Inc && INT_MAX - _Inc < _Newsize)

	cmp	DWORD PTR __Inc$148149[ebp], 0
	jbe	SHORT $LN10@overflow
	mov	edx, 2147483647				; 7fffffffH
	sub	edx, DWORD PTR __Inc$148149[ebp]
	cmp	edx, DWORD PTR __Newsize$148148[ebp]
	jae	SHORT $LN10@overflow

; 144  : 				_Inc /= 2;	// increment causes overflow, halve it

	mov	eax, DWORD PTR __Inc$148149[ebp]
	shr	eax, 1
	mov	DWORD PTR __Inc$148149[ebp], eax
...
; 148  : 			_Newsize += _Inc;
	...
	mov	ecx, DWORD PTR __Newsize$148148[ebp]
	add	ecx, DWORD PTR __Inc$148149[ebp]
	mov	DWORD PTR __Newsize$148148[ebp], ecx
...
; 150  : 			_Elem *_Newptr = _Al.allocate(_Newsize);
	...
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Newptr$148154[ebp], eax

; 151  : 			_Elem *_Oldptr = _Mysb::eback();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	mov	DWORD PTR __Oldptr$148155[ebp], eax

; 152  : 
; 153  : 			if (0 < _Oldsize)

	cmp	DWORD PTR __Oldsize$148147[ebp], 0
	jbe	SHORT $LN8@overflow

; 154  : 				_Traits::copy(_Newptr, _Oldptr, _Oldsize);

	mov	eax, DWORD PTR __Oldsize$148147[ebp]
	push	eax
	mov	ecx, DWORD PTR __Oldptr$148155[ebp]
	push	ecx
	mov	edx, DWORD PTR __Newptr$148154[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
$LN8@overflow:
...
; 158  : 				_Seekhigh = _Newptr;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newptr$148154[ebp]
	mov	DWORD PTR [eax+60], ecx

; 159  : 				_Mysb::setp(_Newptr, _Newptr + _Newsize);

	mov	edx, DWORD PTR __Newptr$148154[ebp]
	add	edx, DWORD PTR __Newsize$148148[ebp]
	push	edx
	mov	eax, DWORD PTR __Newptr$148154[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 167  : 				_Seekhigh = _Newptr + (_Seekhigh - _Oldptr);
	...
	sub	eax, DWORD PTR __Oldptr$148155[ebp]
	add	eax, DWORD PTR __Newptr$148154[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 180  : 				_Al.deallocate(_Oldptr, _Oldsize);
	...
	mov	ecx, DWORD PTR __Oldsize$148147[ebp]
	push	ecx
	mov	edx, DWORD PTR __Oldptr$148155[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 68					; 00000044H
	call	?deallocate@?$allocator@D@std@@QAEXPADI@Z ; std::allocator<char>::deallocate
...
; 194  : 			&& _Mystate & _Constant)
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR $T152866[ebp], al
	mov	ecx, DWORD PTR _this$[ebp]
	call	?gptr@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::gptr
	sub	eax, 1
	push	eax
	lea	ecx, DWORD PTR $T152866[ebp]
	push	ecx
...
; 199  : 			if (!_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T152867[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T152867[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
__unwindfunclet$??0?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@_N@Z$0:
	mov	eax, DWORD PTR $T152894[ebp]
	and	eax, 1
	je	$LN5@basic_ostr@2
	and	DWORD PTR $T152894[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN5@basic_ostr@2:
...
; 376  : 		return (_Tmp -= _Off);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T152924[ebp]
	or	edx, 1
	mov	DWORD PTR $T152924[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T152924[ebp]
	and	eax, 1
	je	$LN5@operator@5
	and	DWORD PTR $T152924[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN5@operator@5:
	ret	0
...
tv91 = -148						; size = 4
$T152951 = -144						; size = 4
__Nul$148412 = -136					; size = 32
__Str$148410 = -96					; size = 32
__Str$148407 = -56					; size = 32
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
$LN8@str:
	...
	call	?pbase@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::pbase
	push	eax
	lea	ecx, DWORD PTR __Str$148407[ebp]
...
; 98   : 			return (_Str);
	...
	lea	eax, DWORD PTR __Str$148407[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
...
; 102  : 			_Mystr _Str(_Mysb::eback(), _Mysb::egptr() - _Mysb::eback());
	...
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	push	eax
	lea	ecx, DWORD PTR __Str$148410[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; 107  : 			_Mystr _Nul;
	...
	lea	ecx, DWORD PTR __Nul$148412[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 3

; 108  : 			return (_Nul);

	lea	eax, DWORD PTR __Nul$148412[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T152951[ebp]
...
; 564  : 		_Ploc = _NEW_CRT locale;
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T153031[ebp], eax
	cmp	DWORD PTR $T153031[ebp], 0
	je	SHORT $LN3@Init
	mov	ecx, DWORD PTR $T153031[ebp]
...
; 25   : 		{	// construct with no buffers
	...
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T153046[ebp], eax
	cmp	DWORD PTR $T153046[ebp], 0
...
_TEXT	SEGMENT
__Size$148575 = -28					; size = 4
__Ptr$148568 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$148568[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$148568[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBEIXZ ; std::vector<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > >::size
	mov	DWORD PTR __Size$148575[ebp], eax
...
; 769  : 			this->_Myend = _Ptr + _Count;
	...
	mov	eax, DWORD PTR __Count$[ebp]
	shl	eax, 5
	add	eax, DWORD PTR __Ptr$148568[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+12], eax

; 770  : 			this->_Mylast = _Ptr + _Size;

	mov	edx, DWORD PTR __Size$148575[ebp]
	shl	edx, 5
	add	edx, DWORD PTR __Ptr$148568[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], edx
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$148568[ebp]
	mov	DWORD PTR [ecx+4], edx
$LN7@reserve:
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	add	esp, 8
	mov	BYTE PTR $T153077[ebp], al
	movzx	edx, BYTE PTR $T153077[ebp]
	push	edx
...
; 320  : 			_Elem *_Pnew = _Al.allocate(_Count);
	...
	add	ecx, 68					; 00000044H
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Pnew$148669[ebp], eax
...
; 321  : 			_Traits::copy(_Pnew, _Ptr, _Count);
	...
	mov	ecx, DWORD PTR __Ptr$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$148669[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
...
; 322  : 			_Seekhigh = _Pnew + _Count;
	...
	mov	eax, DWORD PTR __Pnew$148669[ebp]
	add	eax, DWORD PTR __Count$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+60], eax
...
; 326  : 					_Pnew + _Count);	// setup read buffer
	...
	mov	ecx, DWORD PTR __Pnew$148669[ebp]
...
$T153126 = -64						; size = 4
$T153125 = -60						; size = 12
__Pfmod$145713 = -48					; size = 4
__Pf$145697 = -44					; size = 4
__Id$145696 = -40					; size = 4
__Psave$145684 = -32					; size = 4
__Lock$145683 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$145683[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$145684[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$145684[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$145684[ebp]
	mov	DWORD PTR __Pf$145697[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$145684[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T153125[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T153125[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$145684[ebp]
	mov	DWORD PTR __Pf$145697[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$145684[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$145684[ebp]
	mov	DWORD PTR __Pfmod$145713[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$145713[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$145697[ebp]
	mov	DWORD PTR $T153126[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$145683[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T153126[ebp]
$LN8@use_facet:
...
; 2374 : 				_Locinfo(_Ploc->c_str()));
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T153162[ebp]
	or	eax, 1
	mov	DWORD PTR $T153162[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T153156[ebp]
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T153155[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T153155[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T153162[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T153162[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T153158[ebp]
...
; 118  : 		return (::_Getctype());
	...
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T153235[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T153235[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T153235[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T153235[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T153235[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T153235[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T153235[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T153235[ebp+12]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T153266[ebp], edx
	mov	eax, DWORD PTR $T153266[ebp]
	push	eax
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T153342[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T153342[ebp], 0
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@0@Z ; std::_Ptr_cat<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::basic_string<char,std::char_traits<char>,std::allocator<char> > >
	add	esp, 8
	mov	BYTE PTR $T153356[ebp], al
	movzx	edx, BYTE PTR $T153356[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
