; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Lucas\Desktop\jogos - game ai by example\Raven_Game\Buckland_Chapter7 to 10_Raven\main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
_DATA	SEGMENT
?g_szApplicationName@@3PADA DD FLAT:$SG140119		; g_szApplicationName
?g_szWindowClassName@@3PADA DD FLAT:$SG140121		; g_szWindowClassName
_DATA	ENDS
CONST	SEGMENT
...
$SG140182 DB	'map', 00H
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG140119 DB	'Raven', 00H
$SG140194 DB	00H
	ORG $+1
$SG140121 DB	'MyWindowClass', 00H
	ORG $+2
$SG140183 DB	'Raven map file (*.map)', 00H
	ORG $+1
$SG140193 DB	'Filename: ', 00H
	ORG $+1
$SG140246 DB	'Error', 00H
	ORG $+2
$SG140247 DB	'Registration Failed!', 00H
	ORG $+3
$SG140250 DB	'Error!', 00H
	ORG $+1
$SG140251 DB	'CreateWindowEx Failed!', 00H
CONST	ENDS
...
; File c:\users\lucas\desktop\jogos - game ai by example\raven_game\buckland_chapter7 to 10_raven\main.cpp
_BSS	SEGMENT
...
$T149937 = -224						; size = 4
$T149936 = -220						; size = 4
_hdc$140221 = -216					; size = 4
_ps$140213 = -208					; size = 64
$T140196 = -140						; size = 32
$T140181 = -108						; size = 32
$T140180 = -76						; size = 32
_hdc$140150 = -44					; size = 4
_rect$140148 = -36					; size = 16
...
; 69   : 			   GetClientRect(hwnd, &rect);
	...
	mov	esi, esp
	lea	ecx, DWORD PTR _rect$140148[ebp]
	push	ecx
...
; 84   :          HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$140150[ebp], eax
...
; 88   :                                           cyClient);
	...
	push	ecx
	mov	edx, DWORD PTR _hdc$140150[ebp]
	push	edx
...
; 98   :          g_pRaven = new Raven_Game();
	...
	add	esp, 4
	mov	DWORD PTR $T149937[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T149937[ebp], 0
	je	SHORT $LN43@WindowProc
	mov	ecx, DWORD PTR $T149937[ebp]
...
; 204  :           FileOpenDlg(hwnd, szFileName, szTitleName, "Raven map file (*.map)", "map");
	...
	lea	ecx, DWORD PTR $T140180[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 1
	push	OFFSET $SG140183
	lea	ecx, DWORD PTR $T140181[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	lea	ecx, DWORD PTR $T140180[ebp]
	push	ecx
	lea	edx, DWORD PTR $T140181[ebp]
	push	edx
...
; 343  :          BeginPaint (hwnd, &ps);
	...
	mov	esi, esp
	lea	eax, DWORD PTR _ps$140213[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
...
; 365  : 			   BitBlt(ps.hdc, 0, 0, cxClient, cyClient, hdcBackBuffer, 0, 0, SRCCOPY); 
	...
	push	0
	push	0
	mov	ecx, DWORD PTR _ps$140213[ebp]
	push	ecx
	call	DWORD PTR __imp__BitBlt@36
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 367  :          EndPaint (hwnd, &ps);
	...
	mov	esi, esp
	lea	edx, DWORD PTR _ps$140213[ebp]
	push	edx
	mov	eax, DWORD PTR _hwnd$[ebp]
	push	eax
...
; 389  :         HDC hdc = GetDC(hwnd);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hdc$140221[ebp], eax
...
; 395  : 											  cyClient);
	...
	mov	ecx, DWORD PTR ?cxClient@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4HA
	push	ecx
	mov	edx, DWORD PTR _hdc$140221[ebp]
	push	edx
	call	DWORD PTR __imp__CreateCompatibleBitmap@12
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 397  : 			  ReleaseDC(hwnd, hdc);
	...
	mov	esi, esp
	mov	eax, DWORD PTR _hdc$140221[ebp]
	push	eax
	mov	ecx, DWORD PTR _hwnd$[ebp]
	push	ecx
	call	DWORD PTR __imp__ReleaseDC@8
...
$T149982 = -280						; size = 4
$T140264 = -276						; size = 32
_err$140263 = -240					; size = 4
_bDone$140253 = -229					; size = 1
_timer$140252 = -224					; size = 104
...
; 463  : 		MessageBox(NULL, "Registration Failed!", "Error", 0);
	...
	mov	esi, esp
	push	0
	push	OFFSET $SG140246
	push	OFFSET $SG140247
	push	0
...
; 489  :        MessageBox(NULL, "CreateWindowEx Failed!", "Error!", 0);
	...
	mov	esi, esp
	push	0
	push	OFFSET $SG140250
	push	OFFSET $SG140251
	push	0
	call	DWORD PTR __imp__MessageBoxA@16
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 498  :     PrecisionTimer timer(FrameRate);
	...
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _timer$140252[ebp]
...
; 504  :     bool bDone = false;
	...
	mov	BYTE PTR _bDone$140253[ebp], 0
$LN7@WinMain:

; 505  : 
; 506  :     while(!bDone)

	movzx	ecx, BYTE PTR _bDone$140253[ebp]
	test	ecx, ecx
	jne	$LN6@WinMain
$LN5@WinMain:
...
; 513  : 	        bDone = true;
	...
	mov	BYTE PTR _bDone$140253[ebp], 1
...
; 540  :     ErrorBox(std::string(err.what()));
	...
	mov	esi, esp
	mov	ecx, DWORD PTR _err$140263[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _err$140263[ebp]
...
; 542  :     delete g_pRaven;
	...
	mov	DWORD PTR $T149983[ebp], eax
	mov	ecx, DWORD PTR $T149983[ebp]
	mov	DWORD PTR $T149982[ebp], ecx
	cmp	DWORD PTR $T149982[ebp], 0
	je	SHORT $LN13@WinMain
	push	1
	mov	ecx, DWORD PTR $T149982[ebp]
...
; 549  :  delete g_pRaven;
	...
	mov	eax, DWORD PTR ?g_pRaven@@3PAVRaven_Game@@A ; g_pRaven
	mov	DWORD PTR $T149988[ebp], eax
	mov	ecx, DWORD PTR $T149988[ebp]
	mov	DWORD PTR $T149987[ebp], ecx
	cmp	DWORD PTR $T149987[ebp], 0
	je	SHORT $LN15@WinMain
	push	1
	mov	ecx, DWORD PTR $T149987[ebp]
	call	??_GRaven_Game@@QAEPAXI@Z
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$142083[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$142083[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$142083[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T150097[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T150097[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$142062[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$142062[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T150168[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T150168[ebp]
$LN7@operator:
...
; 784  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T150194[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv285[ebp], eax
	mov	edx, DWORD PTR tv285[ebp]
	mov	DWORD PTR $T150195[ebp], edx
	lea	eax, DWORD PTR $T150194[ebp]
	push	eax
	lea	ecx, DWORD PTR $T150195[ebp]
	push	ecx
...
; 797  : 					_Ostr.rdbuf()->sputc(_Ostr.fill())))
	...
	mov	DWORD PTR $T150196[ebp], ecx
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR tv292[ebp], eax
	mov	edx, DWORD PTR tv292[ebp]
	mov	DWORD PTR $T150197[ebp], edx
	lea	eax, DWORD PTR $T150196[ebp]
	push	eax
	lea	ecx, DWORD PTR $T150197[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 807  : 	return (_Ostr);
	...
	mov	eax, DWORD PTR __Ostr$[ebp]
	mov	DWORD PTR $T150198[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T150198[ebp]
...
; 319  : 			_THROW_NCEE(failure, "ios_base::failbit set");
	...
	push	1
	lea	edx, DWORD PTR $T150246[ebp]
	push	edx
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BG@FMKFHCIL@ios_base?3?3failbit?5set?$AA@
	lea	ecx, DWORD PTR $T150245[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	eax, DWORD PTR $T150245[ebp]
	push	eax
	call	__CxxThrowException@8
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	lea	ecx, DWORD PTR $T150247[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T150247[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
$LN5@sputc:
	...
	mov	DWORD PTR $T150296[ebp], eax
	mov	eax, DWORD PTR $T150296[ebp]
	mov	cl, BYTE PTR __Ch$[ebp]
	mov	BYTE PTR [eax], cl
	mov	edx, DWORD PTR $T150296[ebp]
	push	edx
...
; 166  :     if (ss.str() == ""){flush(); return *this;}
	...
	call	??$?8DU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z ; std::operator==<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 8
	mov	BYTE PTR $T150360[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T145080[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	movzx	ecx, BYTE PTR $T150360[ebp]
	test	ecx, ecx
	je	SHORT $LN3@operator@3
	call	?flush@DebugConsole@@SAXXZ		; DebugConsole::flush
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T150361[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T150361[ebp]
	jmp	$LN7@operator@3
$LN3@operator@3:
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T150362[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T150362[ebp]
$LN7@operator@3:
...
; 166  :     if (ss.str() == ""){flush(); return *this;}
	...
	call	??$?8DU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@PBD@Z ; std::operator==<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 8
	mov	BYTE PTR $T150379[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T145095[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	movzx	ecx, BYTE PTR $T150379[ebp]
	test	ecx, ecx
	je	SHORT $LN3@operator@4
	call	?flush@DebugConsole@@SAXXZ		; DebugConsole::flush
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T150380[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T150380[ebp]
	jmp	$LN7@operator@4
$LN3@operator@4:
...
; 173  :     return *this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T150381[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _ss$[ebp]
	call	??_D?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXXZ
	mov	eax, DWORD PTR $T150381[ebp]
$LN7@operator@4:
...
; 634  : 			size_type _Idx = _STD addressof(_Val) - this->_Myfirst;
	...
	sar	eax, 5
	mov	DWORD PTR __Idx$146220[ebp], eax
...
; 640  : 				_STD forward<_Ty>(this->_Myfirst[_Idx]));
	...
	mov	eax, DWORD PTR __Idx$146220[ebp]
	shl	eax, 5
	mov	ecx, DWORD PTR _this$[ebp]
	add	eax, DWORD PTR [ecx+4]
	push	eax
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	eax, DWORD PTR $T150498[ebp]
	or	eax, 1
	mov	DWORD PTR $T150498[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T150532[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150532[ebp], 0
	...
	mov	edx, DWORD PTR [eax]
	mov	eax, DWORD PTR [eax+4]
	mov	ecx, DWORD PTR $T150532[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T150532[ebp]
...
; 537  : 		{	// construct empty writable character buffer
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T150550[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150550[ebp], ecx
$LN1@basic_ostr:
	push	0
	push	0
	mov	edx, DWORD PTR _this$[ebp]
...
__unwindfunclet$??0?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@H@Z$0:
	mov	eax, DWORD PTR $T150550[ebp]
	and	eax, 1
	je	$LN5@basic_ostr
	and	DWORD PTR $T150550[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 80					; 00000050H
...
; 593  : 		return (_Stringbuffer.str());
	...
	mov	ecx, DWORD PTR $T150580[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150580[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 359  : 			? _Traits::eof() : _Traits::to_int_type(*_Gninc()));
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T150614[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150615[ebp], eax
	lea	ecx, DWORD PTR $T150614[ebp]
	push	ecx
	lea	edx, DWORD PTR $T150615[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 379  : 			else if (_Traits::eq_int_type(_Traits::eof(), _Meta = uflow()))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150620[ebp], eax
	lea	ecx, DWORD PTR __Meta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T150620[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 408  : 				overflow(_Traits::to_int_type(*_Ptr))))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150632[ebp], eax
	lea	ecx, DWORD PTR $T150631[ebp]
	push	ecx
	lea	edx, DWORD PTR $T150632[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T150672[ebp], eax
	lea	ecx, DWORD PTR __Lock$104593[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T150672[ebp]
...
tv195 = -32						; size = 4
$T150681 = -28						; size = 4
__Oldptr$146365 = -24					; size = 4
__Newptr$146364 = -20					; size = 4
__Inc$146359 = -16					; size = 4
__Newsize$146358 = -12					; size = 4
__Oldsize$146357 = -8					; size = 4
_this$ = -4						; size = 4
__Meta$ = 8						; size = 4
...
; 125  : 		if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150681[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T150681[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
$LN22@overflow:
	...
	mov	DWORD PTR __Oldsize$146357[ebp], eax

; 139  : 			size_t _Newsize = _Oldsize;

	mov	ecx, DWORD PTR __Oldsize$146357[ebp]
	mov	DWORD PTR __Newsize$146358[ebp], ecx

; 140  : 			size_t _Inc = _Newsize / 2 < _MINSIZE
; 141  : 				? _MINSIZE : _Newsize / 2;	// grow by 50 per cent

	mov	edx, DWORD PTR __Newsize$146358[ebp]
	shr	edx, 1
...
$LN23@overflow:
	mov	eax, DWORD PTR __Newsize$146358[ebp]
	shr	eax, 1
	mov	DWORD PTR tv199[ebp], eax
$LN24@overflow:
	mov	ecx, DWORD PTR tv199[ebp]
	mov	DWORD PTR __Inc$146359[ebp], ecx
$LN11@overflow:

; 142  : 
; 143  : 			while (0 < _Inc && INT_MAX - _Inc < _Newsize)

	cmp	DWORD PTR __Inc$146359[ebp], 0
	jbe	SHORT $LN10@overflow
	mov	edx, 2147483647				; 7fffffffH
	sub	edx, DWORD PTR __Inc$146359[ebp]
	cmp	edx, DWORD PTR __Newsize$146358[ebp]
	jae	SHORT $LN10@overflow

; 144  : 				_Inc /= 2;	// increment causes overflow, halve it

	mov	eax, DWORD PTR __Inc$146359[ebp]
	shr	eax, 1
	mov	DWORD PTR __Inc$146359[ebp], eax
...
; 148  : 			_Newsize += _Inc;
	...
	mov	ecx, DWORD PTR __Newsize$146358[ebp]
	add	ecx, DWORD PTR __Inc$146359[ebp]
	mov	DWORD PTR __Newsize$146358[ebp], ecx
...
; 150  : 			_Elem *_Newptr = _Al.allocate(_Newsize);
	...
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Newptr$146364[ebp], eax

; 151  : 			_Elem *_Oldptr = _Mysb::eback();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	mov	DWORD PTR __Oldptr$146365[ebp], eax

; 152  : 
; 153  : 			if (0 < _Oldsize)

	cmp	DWORD PTR __Oldsize$146357[ebp], 0
	jbe	SHORT $LN8@overflow

; 154  : 				_Traits::copy(_Newptr, _Oldptr, _Oldsize);

	mov	eax, DWORD PTR __Oldsize$146357[ebp]
	push	eax
	mov	ecx, DWORD PTR __Oldptr$146365[ebp]
	push	ecx
	mov	edx, DWORD PTR __Newptr$146364[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
$LN8@overflow:
...
; 158  : 				_Seekhigh = _Newptr;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newptr$146364[ebp]
	mov	DWORD PTR [eax+60], ecx

; 159  : 				_Mysb::setp(_Newptr, _Newptr + _Newsize);

	mov	edx, DWORD PTR __Newptr$146364[ebp]
	add	edx, DWORD PTR __Newsize$146358[ebp]
	push	edx
	mov	eax, DWORD PTR __Newptr$146364[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 167  : 				_Seekhigh = _Newptr + (_Seekhigh - _Oldptr);
	...
	sub	eax, DWORD PTR __Oldptr$146365[ebp]
	add	eax, DWORD PTR __Newptr$146364[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 180  : 				_Al.deallocate(_Oldptr, _Oldsize);
	...
	mov	ecx, DWORD PTR __Oldsize$146357[ebp]
	push	ecx
	mov	edx, DWORD PTR __Oldptr$146365[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 68					; 00000044H
	call	?deallocate@?$allocator@D@std@@QAEXPADI@Z ; std::allocator<char>::deallocate
...
; 194  : 			&& _Mystate & _Constant)
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T150700[ebp], eax
	lea	eax, DWORD PTR __Meta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T150700[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR $T150701[ebp], al
	mov	ecx, DWORD PTR _this$[ebp]
	call	?gptr@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::gptr
	sub	eax, 1
	push	eax
	lea	ecx, DWORD PTR $T150701[ebp]
	push	ecx
...
; 46   : 	explicit __CLR_OR_THIS_CALL basic_ostream(
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T150729[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150729[ebp], ecx
$LN1@basic_ostr@2:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
...
__unwindfunclet$??0?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@_N@Z$0:
	mov	eax, DWORD PTR $T150729[ebp]
	and	eax, 1
	je	$LN5@basic_ostr@2
	and	DWORD PTR $T150729[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN5@basic_ostr@2:
...
; 376  : 		return (_Tmp -= _Off);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T150759[ebp]
	or	edx, 1
	mov	DWORD PTR $T150759[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??G?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QBE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T150759[ebp]
	and	eax, 1
	je	$LN5@operator@5
	and	DWORD PTR $T150759[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@@std@@QAE@XZ
$LN5@operator@5:
	ret	0
...
tv91 = -148						; size = 4
$T150786 = -144						; size = 4
__Nul$146551 = -136					; size = 32
__Str$146549 = -96					; size = 32
__Str$146546 = -56					; size = 32
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
$LN8@str:
	...
	call	?pbase@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::pbase
	push	eax
	lea	ecx, DWORD PTR __Str$146546[ebp]
...
; 98   : 			return (_Str);
	...
	lea	eax, DWORD PTR __Str$146546[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T150786[ebp]
	or	ecx, 1
	mov	DWORD PTR $T150786[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$146546[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 102  : 			_Mystr _Str(_Mysb::eback(), _Mysb::egptr() - _Mysb::eback());
	...
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	push	eax
	lea	ecx, DWORD PTR __Str$146549[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; 103  : 			return (_Str);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T150786[ebp]
	or	edx, 1
	mov	DWORD PTR $T150786[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$146549[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 107  : 			_Mystr _Nul;
	...
	lea	ecx, DWORD PTR __Nul$146551[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 3

; 108  : 			return (_Nul);

	lea	eax, DWORD PTR __Nul$146551[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T150786[ebp]
...
__unwindfunclet$?str@?$basic_stringbuf@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ$1:
	mov	eax, DWORD PTR $T150786[ebp]
	and	eax, 1
	je	$LN11@str
	and	DWORD PTR $T150786[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN11@str:
	ret	0
...
; 564  : 		_Ploc = _NEW_CRT locale;
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T150866[ebp], eax
	cmp	DWORD PTR $T150866[ebp], 0
	je	SHORT $LN3@Init
	mov	ecx, DWORD PTR $T150866[ebp]
...
; 25   : 		{	// construct with no buffers
	...
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T150881[ebp], eax
	cmp	DWORD PTR $T150881[ebp], 0
	je	SHORT $LN3@basic_stre
	mov	ecx, DWORD PTR $T150881[ebp]
	call	??0locale@std@@QAE@XZ			; std::locale::locale
	mov	DWORD PTR tv79[ebp], eax
...
_TEXT	SEGMENT
__Size$146714 = -28					; size = 4
__Ptr$146707 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$146707[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$146707[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V?$allocator@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@2@@std@@QBEIXZ ; std::vector<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::allocator<std::basic_string<char,std::char_traits<char>,std::allocator<char> > > >::size
	mov	DWORD PTR __Size$146714[ebp], eax
...
; 769  : 			this->_Myend = _Ptr + _Count;
	...
	mov	eax, DWORD PTR __Count$[ebp]
	shl	eax, 5
	add	eax, DWORD PTR __Ptr$146707[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+12], eax

; 770  : 			this->_Mylast = _Ptr + _Size;

	mov	edx, DWORD PTR __Size$146714[ebp]
	shl	edx, 5
	add	edx, DWORD PTR __Ptr$146707[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], edx
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$146707[ebp]
	mov	DWORD PTR [ecx+4], edx
$LN7@reserve:
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	add	esp, 8
	mov	BYTE PTR $T150912[ebp], al
	movzx	edx, BYTE PTR $T150912[ebp]
	push	edx
...
; 320  : 			_Elem *_Pnew = _Al.allocate(_Count);
	...
	add	ecx, 68					; 00000044H
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Pnew$146778[ebp], eax
...
; 321  : 			_Traits::copy(_Pnew, _Ptr, _Count);
	...
	mov	ecx, DWORD PTR __Ptr$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$146778[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
...
; 322  : 			_Seekhigh = _Pnew + _Count;
	...
	mov	eax, DWORD PTR __Pnew$146778[ebp]
	add	eax, DWORD PTR __Count$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+60], eax
...
; 326  : 					_Pnew + _Count);	// setup read buffer
	...
	mov	ecx, DWORD PTR __Pnew$146778[ebp]
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T150954[ebp]
	or	edx, 1
	mov	DWORD PTR $T150954[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T150961 = -64						; size = 4
$T150960 = -60						; size = 12
__Pfmod$144362 = -48					; size = 4
__Pf$144346 = -44					; size = 4
__Id$144345 = -40					; size = 4
__Psave$144333 = -32					; size = 4
__Lock$144332 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$144332[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$144333[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$144333[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$144333[ebp]
	mov	DWORD PTR __Pf$144346[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$144333[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T150960[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T150960[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$144333[ebp]
	mov	DWORD PTR __Pf$144346[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$144333[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$144333[ebp]
	mov	DWORD PTR __Pfmod$144362[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$144362[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$144346[ebp]
	mov	DWORD PTR $T150961[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$144332[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T150961[ebp]
$LN8@use_facet:
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T150990[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T150990[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T150997[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T150997[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T150993[ebp]
...
; 78   :             _THROW_NCEE(runtime_error, "bad locale name");
	...
	lea	ecx, DWORD PTR $T151009[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T151009[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
...
; 118  : 		return (::_Getctype());
	...
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T151070[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T151070[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T151070[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T151070[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T151070[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T151070[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T151070[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T151070[ebp+12]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T151101[ebp], edx
	mov	eax, DWORD PTR $T151101[ebp]
	push	eax
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T151177[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T151177[ebp], 0
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@0@Z ; std::_Ptr_cat<std::basic_string<char,std::char_traits<char>,std::allocator<char> >,std::basic_string<char,std::char_traits<char>,std::allocator<char> > >
	add	esp, 8
	mov	BYTE PTR $T151191[ebp], al
	movzx	edx, BYTE PTR $T151191[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
