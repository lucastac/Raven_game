...
$T142509 = -76						; size = 8
$T142506 = -68						; size = 4
__Nget_fac$134100 = -64					; size = 4
__Tmp$134099 = -56					; size = 4
__Ok$ = -44						; size = 8
__State$ = -28						; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
...
; 279  : 			long _Tmp = 0;
	...
	mov	DWORD PTR __Tmp$134099[ebp], 0
...
; 280  : 			const _Nget& _Nget_fac = _USE(ios_base::getloc(), _Nget);
	...
	add	esp, 4
	mov	DWORD PTR __Nget_fac$134100[ebp], eax
...
$LN9@operator:
	...
	lea	eax, DWORD PTR __Tmp$134099[ebp]
	push	eax
	...
	push	eax
	mov	ecx, DWORD PTR __Nget_fac$134100[ebp]
...
; 288  : 				|| _Tmp < INT_MIN || INT_MAX < _Tmp)
	...
	cmp	DWORD PTR __Tmp$134099[ebp], -2147483648 ; 80000000H
	jl	SHORT $LN2@operator
	cmp	DWORD PTR __Tmp$134099[ebp], 2147483647	; 7fffffffH
...
; 291  : 				_Val = _Tmp;
	...
	mov	eax, DWORD PTR __Tmp$134099[ebp]
...
; 417  : 			const _Nget& _Nget_fac = _USE(ios_base::getloc(), _Nget);
	...
	call	??$use_facet@V?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@@std@@YAABV?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@0@ABVlocale@0@@Z ; std::use_facet<std::num_get<char,std::istreambuf_iterator<char,std::char_traits<char> > > >
	add	esp, 4
	mov	DWORD PTR __Nget_fac$134371[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	lea	ecx, DWORD PTR $T142566[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
$LN6@operator@2:
	...
	push	eax
	mov	ecx, DWORD PTR __Nget_fac$134371[ebp]
...
$T142707 = -44						; size = 4
$T142706 = -40						; size = 4
__Meta$135609 = -32					; size = 4
__Ctype_fac$135605 = -24				; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Noskip$ = 8						; size = 1
...
; 124  : 				const _Ctype& _Ctype_fac = _USE(ios_base::getloc(), _Ctype);
	...
	add	esp, 4
	mov	DWORD PTR __Ctype_fac$135605[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
...
; 127  : 				int_type _Meta = _Myios::rdbuf()->sgetc();
	...
	mov	DWORD PTR __Meta$135609[ebp], ecx
	jmp	SHORT $LN7@Ipfx
$LN6@Ipfx:
...
; 130  : 					if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	lea	eax, DWORD PTR __Meta$135609[ebp]
	push	eax
...
; 136  : 						_Traits::to_char_type(_Meta)))
	...
	push	ecx
	push	72					; 00000048H
	mov	ecx, DWORD PTR __Ctype_fac$135605[ebp]
...
$T142796 = -64						; size = 4
$T142795 = -60						; size = 12
__Pfmod$138215 = -48					; size = 4
__Pf$138199 = -44					; size = 4
__Id$138198 = -40					; size = 4
__Psave$138186 = -32					; size = 4
__Lock$138185 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$138185[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$138186[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$138186[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$138186[ebp]
	mov	DWORD PTR __Pf$138199[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$138186[ebp]
	push	ecx
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$138186[ebp]
	mov	DWORD PTR __Pf$138199[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$138186[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$138186[ebp]
	mov	DWORD PTR __Pfmod$138215[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$138215[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$138199[ebp]
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$138694[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$138694[ebp]
	push	edx
	lea	eax, DWORD PTR $T138695[ebp]
	push	eax
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$135308[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$135308[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$135308[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 28					; 0000001cH
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$135287[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$135287[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
$T143218 = -64						; size = 4
$T143217 = -60						; size = 12
__Pfmod$138768 = -48					; size = 4
__Pf$138757 = -44					; size = 4
__Id$138756 = -40					; size = 4
__Psave$138744 = -32					; size = 4
__Lock$138743 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$138743[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$138744[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$138756[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$138756[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$138757[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$138757[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$138744[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$138744[ebp]
	mov	DWORD PTR __Pf$138757[ebp], edx
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$138744[ebp]
	push	ecx
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$138744[ebp]
	mov	DWORD PTR __Pf$138757[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$138744[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$138744[ebp]
	mov	DWORD PTR __Pfmod$138768[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$138768[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$138757[ebp]
...
; 1542 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$139370[ebp], edx
...
; 1544 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$139370[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
$T143313 = -208						; size = 4
$T143312 = -204						; size = 4
__Ulo$136395 = -200					; size = 4
__Errno$136394 = -192					; size = 4
__Ep$136393 = -180					; size = 4
__Ac$136392 = -168					; size = 32
$T136381 = -132						; size = 32
$T136379 = -100						; size = 32
__Str$136378 = -64					; size = 32
__Punct_fac$136373 = -28				; size = 4
__Ans$ = -24						; size = 4
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
...
; 372  : 			const _Mypunct& _Punct_fac = _USE(_Iosbase.getloc(), _Mypunct);
	...
	add	esp, 4
	mov	DWORD PTR __Punct_fac$136373[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T143312[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 373  : 			_Mystr _Str((_Mystrsize)1, (char_type)0);
	...
	push	0
	push	1
	lea	ecx, DWORD PTR __Str$136378[ebp]
...
; 374  : 			_Str += _Punct_fac.falsename();
	...
	lea	ecx, DWORD PTR $T136379[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Punct_fac$136373[ebp]
...
; 385  : 					_Iosbase.getloc()), &_Errno);
	...
	lea	edx, DWORD PTR __First$[ebp]
	push	edx
	lea	eax, DWORD PTR __Ac$136392[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	push	ecx
	...
	add	esp, 24					; 00000018H
	push	eax
	lea	edx, DWORD PTR __Ep$136393[ebp]
	push	edx
	lea	eax, DWORD PTR __Ac$136392[ebp]
	push	eax
	call	__Stoulx
	add	esp, 16					; 00000010H
	mov	DWORD PTR __Ulo$136395[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T143313[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 386  : 			if (_Ep != _Ac && _Errno == 0 && _Ulo <= 1)
	...
	mov	ecx, DWORD PTR __Ep$136393[ebp]
	lea	edx, DWORD PTR __Ac$136392[ebp]
	cmp	ecx, edx
	je	SHORT $LN5@do_get
	cmp	DWORD PTR __Errno$136394[ebp], 0
	jne	SHORT $LN5@do_get
	cmp	DWORD PTR __Ulo$136395[ebp], 1
	ja	SHORT $LN5@do_get

; 387  : 				_Ans = _Ulo;

	mov	eax, DWORD PTR __Ulo$136395[ebp]
	mov	DWORD PTR __Ans$[ebp], eax
$LN5@do_get:
...
tv75 = -137						; size = 1
$T143520 = -136						; size = 4
__Pg$137075 = -132					; size = 4
__Pe$137049 = -128					; size = 4
__Group$ = -124						; size = 4
...
; 672  : 		for (char *const _Pe = &_Ac[_MAX_INT_DIG - 1];
	...
	mov	DWORD PTR __Pe$137049[ebp], edx
...
$LN22@Getifld:
	mov	eax, DWORD PTR __Ptr$[ebp]
	cmp	eax, DWORD PTR __Pe$137049[ebp]
...
; 700  : 		for (const char *_Pg = _Grouping.c_str(); _Seendigit && 0 < _Group; )
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$137075[ebp], eax
$LN12@Getifld:
...
; 701  : 			if (*_Pg == CHAR_MAX)
	...
	mov	eax, DWORD PTR __Pg$137075[ebp]
...
; 707  : 				++_Pg;	// group size okay, advance to next test
	...
	mov	edx, DWORD PTR __Pg$137075[ebp]
	add	edx, 1
	mov	DWORD PTR __Pg$137075[ebp], edx
$LN9@Getifld:
...
$T143539 = -140						; size = 4
$T143536 = -136						; size = 4
__Pg$137148 = -132					; size = 4
__Group$137127 = -128					; size = 4
__Groups$137126 = -120					; size = 32
__Kseparator$137123 = -81				; size = 1
__Pten$ = -80						; size = 4
...
$LN73@Getffld:
	...
	mov	BYTE PTR __Kseparator$137123[ebp], al

; 759  : 			string _Groups((size_t)1, '\0');

	push	0
	push	1
	lea	ecx, DWORD PTR __Groups$137126[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2

; 760  : 			size_t _Group = 0;

	mov	DWORD PTR __Group$137127[ebp], 0
...
; 775  : 					if (_Groups[_Group] != CHAR_MAX)
	...
	mov	eax, DWORD PTR __Group$137127[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groups$137126[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
...
; 776  : 						++_Groups[_Group];
	...
	mov	edx, DWORD PTR __Group$137127[ebp]
	push	edx
	lea	ecx, DWORD PTR __Groups$137126[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
...
; 780  : 					|| *_First != _Kseparator)
	...
	movsx	edx, BYTE PTR __Kseparator$137123[ebp]
	test	edx, edx
	je	SHORT $LN42@Getffld
	mov	ecx, DWORD PTR __First$[ebp]
	call	??D?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QBEDXZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator*
	movsx	eax, al
	movsx	ecx, BYTE PTR __Kseparator$137123[ebp]
	cmp	eax, ecx
...
; 785  : 					++_Group;
	...
	mov	edx, DWORD PTR __Group$137127[ebp]
	add	edx, 1
	mov	DWORD PTR __Group$137127[ebp], edx
$LN44@Getffld:
...
; 787  : 			if (_Group == 0)
	...
	cmp	DWORD PTR __Group$137127[ebp], 0
...
; 794  : 			for (const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$137148[ebp], eax
$LN36@Getffld:
...
; 796  : 				if (*_Pg == CHAR_MAX)
	...
	mov	ecx, DWORD PTR __Pg$137148[ebp]
	movsx	edx, BYTE PTR [ecx]
	cmp	edx, 127				; 0000007fH
...
; 799  : 					|| 0 == _Group && *_Pg < _Groups[_Group])
	...
	mov	eax, DWORD PTR __Group$137127[ebp]
	sub	eax, 1
	mov	DWORD PTR __Group$137127[ebp], eax
...
; 802  : 					++_Pg;	// group size okay, advance to next test
	...
	mov	eax, DWORD PTR __Pg$137148[ebp]
	add	eax, 1
	mov	DWORD PTR __Pg$137148[ebp], eax
$LN33@Getffld:
...
$T143571 = -148						; size = 4
$T143568 = -144						; size = 4
__Pg$137607 = -140					; size = 4
__Group$137587 = -136					; size = 4
__Groups$137586 = -128					; size = 32
__Kseparator$137583 = -89				; size = 1
__Phex$ = -88						; size = 4
...
$LN78@Getffldx:
	...
	mov	BYTE PTR __Kseparator$137583[ebp], cl

; 928  : 			string _Groups((size_t)1, '\0');

	push	0
	push	1
	lea	ecx, DWORD PTR __Groups$137586[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 2

; 929  : 			size_t _Group = 0;

	mov	DWORD PTR __Group$137587[ebp], 0
...
; 944  : 					if (_Groups[_Group] != CHAR_MAX)
	...
	mov	eax, DWORD PTR __Group$137587[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groups$137586[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
...
; 945  : 						++_Groups[_Group];
	...
	mov	edx, DWORD PTR __Group$137587[ebp]
	push	edx
	lea	ecx, DWORD PTR __Groups$137586[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
...
; 949  : 					|| *_First != _Kseparator)
	...
	movsx	edx, BYTE PTR __Kseparator$137583[ebp]
	test	edx, edx
	je	SHORT $LN42@Getffldx
	mov	ecx, DWORD PTR __First$[ebp]
	call	??D?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QBEDXZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator*
	movsx	eax, al
	movsx	ecx, BYTE PTR __Kseparator$137583[ebp]
	cmp	eax, ecx
...
; 954  : 					++_Group;
	...
	mov	edx, DWORD PTR __Group$137587[ebp]
	add	edx, 1
	mov	DWORD PTR __Group$137587[ebp], edx
$LN44@Getffldx:
...
; 956  : 			if (_Group == 0)
	...
	cmp	DWORD PTR __Group$137587[ebp], 0
...
; 963  : 			for (const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$137607[ebp], eax
$LN36@Getffldx:
...
; 965  : 				if (*_Pg == CHAR_MAX)
	...
	mov	ecx, DWORD PTR __Pg$137607[ebp]
	movsx	edx, BYTE PTR [ecx]
	cmp	edx, 127				; 0000007fH
...
; 968  : 					|| 0 == _Group && *_Pg < _Groups[_Group])
	...
	mov	eax, DWORD PTR __Group$137587[ebp]
	sub	eax, 1
	mov	DWORD PTR __Group$137587[ebp], eax
...
; 971  : 					++_Pg;	// group size okay, advance to next test
	...
	mov	eax, DWORD PTR __Pg$137607[ebp]
	add	eax, 1
	mov	DWORD PTR __Pg$137607[ebp], eax
$LN33@Getffldx:
...
$T143613 = -64						; size = 4
$T143612 = -60						; size = 12
__Pfmod$138909 = -48					; size = 4
__Pf$138898 = -44					; size = 4
__Id$138897 = -40					; size = 4
__Psave$138885 = -32					; size = 4
__Lock$138884 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$138884[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$138885[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$138897[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$138897[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$138898[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$138898[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$138885[ebp], 0
	je	SHORT $LN4@use_facet@3

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$138885[ebp]
	mov	DWORD PTR __Pf$138898[ebp], edx
	jmp	SHORT $LN5@use_facet@3
$LN4@use_facet@3:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$138885[ebp]
	push	ecx
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$138885[ebp]
	mov	DWORD PTR __Pf$138898[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$138885[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$138885[ebp]
	mov	DWORD PTR __Pfmod$138909[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$138909[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$138898[ebp]
...
tv144 = -88						; size = 4
$T143636 = -84						; size = 4
__Field$138965 = -80					; size = 4
__Off$138964 = -76					; size = 4
__Prefix$138963 = -69					; size = 1
__Column$138959 = -68					; size = 4
__Ans$ = -64						; size = 4
__Str$ = -56						; size = 32
__Off$138951 = -20					; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
__First$ = 8						; size = 4
__Last$ = 12						; size = 4
...
; 546  : 	for (size_t _Off = 0; _Ptr[_Off] != (_Elem)0; ++_Off)
	...
	mov	DWORD PTR __Off$138951[ebp], 0
	jmp	SHORT $LN23@Getloctxt
$LN22@Getloctxt:
	mov	eax, DWORD PTR __Off$138951[ebp]
	add	eax, 1
	mov	DWORD PTR __Off$138951[ebp], eax
$LN23@Getloctxt:
	mov	ecx, DWORD PTR __Ptr$[ebp]
	add	ecx, DWORD PTR __Off$138951[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
...
; 547  : 		if (_Ptr[_Off] == _Ptr[0])
	...
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$138951[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
...
; 552  : 	for (size_t _Column = 1; ; ++_Column, ++_First, _Ans = -1)
	...
	mov	DWORD PTR __Column$138959[ebp], 1
	jmp	SHORT $LN19@Getloctxt
$LN18@Getloctxt:
	mov	eax, DWORD PTR __Column$138959[ebp]
	add	eax, 1
	mov	DWORD PTR __Column$138959[ebp], eax
	mov	ecx, DWORD PTR __First$[ebp]
	call	??E?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@QAEAAV01@XZ ; std::istreambuf_iterator<char,std::char_traits<char> >::operator++
	mov	DWORD PTR __Ans$[ebp], -1
$LN19@Getloctxt:
...
; 554  : 		bool _Prefix = false;	// seen at least one valid prefix
	...
	mov	BYTE PTR __Prefix$138963[ebp], 0

; 555  : 		size_t _Off = 0;	// offset into fields

	mov	DWORD PTR __Off$138964[ebp], 0

; 556  : 		size_t _Field = 0;	// current field number

	mov	DWORD PTR __Field$138965[ebp], 0
...
$LN15@Getloctxt:
	mov	ecx, DWORD PTR __Field$138965[ebp]
	add	ecx, 1
	mov	DWORD PTR __Field$138965[ebp], ecx
$LN16@Getloctxt:
	mov	edx, DWORD PTR __Field$138965[ebp]
...
$LN12@Getloctxt:
	mov	eax, DWORD PTR __Off$138964[ebp]
	add	eax, 1
	mov	DWORD PTR __Off$138964[ebp], eax
$LN13@Getloctxt:
	mov	ecx, DWORD PTR __Ptr$[ebp]
	add	ecx, DWORD PTR __Off$138964[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	je	SHORT $LN11@Getloctxt
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$138964[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	ecx, eax
...
; 564  : 				_Off += _Str[_Field];	// skip tested columns in field
	...
	mov	eax, DWORD PTR __Field$138965[ebp]
	push	eax
	lea	ecx, DWORD PTR __Str$[ebp]
	call	??A?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAADI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::operator[]
	movsx	ecx, BYTE PTR [eax]
	add	ecx, DWORD PTR __Off$138964[ebp]
	mov	DWORD PTR __Off$138964[ebp], ecx
...
; 566  : 				|| _Ptr[_Off] == (_Elem)0)
	...
	mov	edx, DWORD PTR __Off$138964[ebp]
	add	edx, DWORD PTR __Column$138959[ebp]
	mov	DWORD PTR __Off$138964[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Off$138964[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Ptr$[ebp]
...
; 569  : 					? _Column : 127);	// save skip count if small enough
	...
	cmp	DWORD PTR __Column$138959[ebp], 127	; 0000007fH
...
; 576  : 				_Prefix = true;	// still a valid prefix
	...
	mov	BYTE PTR __Prefix$138963[ebp], 1
$LN9@Getloctxt:
...
; 579  : 		if (!_Prefix || _First == _Last)
	...
	movzx	eax, BYTE PTR __Prefix$138963[ebp]
	test	eax, eax
...
; 664  : 	for (_Elem *_Ptrnext = _Ptrdest; 0 < _Count; --_Count, ++_Ptrnext, ++_Ptr)
	...
	mov	DWORD PTR __Ptrnext$139975[ebp], eax
	jmp	SHORT $LN3@Maklocstr
$LN2@Maklocstr:
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, 1
	mov	DWORD PTR __Count$[ebp], ecx
	mov	edx, DWORD PTR __Ptrnext$139975[ebp]
	add	edx, 1
	mov	DWORD PTR __Ptrnext$139975[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, 1
	mov	DWORD PTR __Ptr$[ebp], eax
$LN3@Maklocstr:
...
; 665  : 		*_Ptrnext = (_Elem)(unsigned char)*_Ptr;
	...
	mov	ecx, DWORD PTR __Ptrnext$139975[ebp]
	mov	edx, DWORD PTR __Ptr$[ebp]
	mov	al, BYTE PTR [edx]
	mov	BYTE PTR [ecx], al
