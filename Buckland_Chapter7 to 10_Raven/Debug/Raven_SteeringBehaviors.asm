; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Lucas\Desktop\jogos - game ai by example\Bluckland_SourceCode - new version\VS2010\Raven_Game\Buckland_Chapter7 to 10_Raven\Raven_SteeringBehaviors.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG137993 DB	'WallDetectionFeelerLength', 00H
	ORG $+2
$SG137994 DB	'SeparationWeight', 00H
	ORG $+3
$SG137995 DB	'WanderWeight', 00H
	ORG $+3
$SG137996 DB	'WallAvoidanceWeight', 00H
$SG137997 DB	'SeekWeight', 00H
	ORG $+1
$SG137998 DB	'ArriveWeight', 00H
	ORG $+3
$SG137999 DB	'ViewDistance', 00H
CONST	ENDS
...
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\raven_game\buckland_chapter7 to 10_raven\raven_steeringbehaviors.cpp
rdata$r	SEGMENT
...
; 47   : {
	...
	push	OFFSET $SG137996
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	ecx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [ecx+144]
	push	OFFSET $SG137997
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	edx, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [edx+152]
	push	OFFSET $SG137998
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	eax, DWORD PTR _this$[ebp]
	fstp	QWORD PTR [eax+160]
	push	OFFSET $SG137999
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	mov	ecx, DWORD PTR _this$[ebp]
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\raven_game\buckland_chapter7 to 10_raven\raven_steeringbehaviors.h
_TEXT	ENDS
...
; 166  :               {TagNeighbors(pRaven_Bot, m_Bots, range);}  
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\raven_game\buckland_chapter7 to 10_raven\raven_map.h
_TEXT	ENDS
...
; 215  :                             * m_pRaven_Bot->MaxSpeed();
	...
	push	eax
	lea	ecx, DWORD PTR $T148283[ebp]
	push	ecx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
	push	eax
	lea	edx, DWORD PTR $T148284[ebp]
	push	edx
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8
	push	eax
...
$T148302 = -108						; size = 8
$T148301 = -100						; size = 16
_DesiredVelocity$138093 = -80				; size = 16
_speed$138085 = -56					; size = 8
_DecelerationTweaker$138084 = -44			; size = 8
_dist$ = -36						; size = 8
...
; 238  :     const double DecelerationTweaker = 0.3;
	...
	fstp	QWORD PTR _DecelerationTweaker$138084[ebp]
...
; 242  :     double speed =  dist / ((double)deceleration * DecelerationTweaker);     
	...
	fmul	QWORD PTR _DecelerationTweaker$138084[ebp]
	fdivr	QWORD PTR _dist$[ebp]
	fstp	QWORD PTR _speed$138085[ebp]
...
; 245  :     speed = MinOf(speed, m_pRaven_Bot->MaxSpeed());
	...
	mov	ecx, DWORD PTR [ecx+8]
	call	?MaxSpeed@MovingEntity@@QBENXZ		; MovingEntity::MaxSpeed
	fstp	QWORD PTR $T148302[ebp]
	lea	edx, DWORD PTR $T148302[ebp]
	push	edx
	lea	eax, DWORD PTR _speed$138085[ebp]
	push	eax
...
; 250  :     Vector2D DesiredVelocity =  ToTarget * speed / dist;
	...
	fstp	QWORD PTR [esp]
	sub	esp, 8
	fld	QWORD PTR _speed$138085[ebp]
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _ToTarget$[ebp]
	push	ecx
	...
	add	esp, 16					; 00000010H
	push	eax
	lea	eax, DWORD PTR _DesiredVelocity$138093[ebp]
	push	eax
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\common\2d\transformations.h
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\common\2d\c2dmatrix.h
...
$T148370 = -168						; size = 16
$T148369 = -152						; size = 16
_OverShoot$138143 = -132				; size = 16
_w$138133 = -112					; size = 4
_flr$138129 = -108					; size = 4
...
; 315  :     for (unsigned int w=0; w<walls.size(); ++w)
	...
	mov	DWORD PTR _w$138133[ebp], 0
	jmp	SHORT $LN6@WallAvoida
$LN5@WallAvoida:
	mov	ecx, DWORD PTR _w$138133[ebp]
	add	ecx, 1
	mov	DWORD PTR _w$138133[ebp], ecx
$LN6@WallAvoida:
	...
	cmp	DWORD PTR _w$138133[ebp], eax
	jae	$LN4@WallAvoida
...
; 322  :                              point))
	...
	push	eax
	lea	ecx, DWORD PTR $T148369[ebp]
	push	ecx
	mov	edx, DWORD PTR _w$138133[ebp]
	push	edx
	mov	ecx, DWORD PTR _walls$[ebp]
	...
	mov	eax, DWORD PTR [eax+12]
	mov	DWORD PTR [ecx+12], eax
	mov	ecx, DWORD PTR _flr$138129[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 56					; 00000038H
...
; 343  :       Vector2D OverShoot = m_Feelers[flr] - ClosestPoint;
	...
	lea	ecx, DWORD PTR _ClosestPoint$[ebp]
	push	ecx
	mov	edx, DWORD PTR _flr$138129[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 56					; 00000038H
	call	??A?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QAEAAUVector2D@@I@Z ; std::vector<Vector2D,std::allocator<Vector2D> >::operator[]
	push	eax
	lea	eax, DWORD PTR _OverShoot$138143[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
...
; 347  :       SteeringForce = walls[ClosestWall]->Normal() * OverShoot.Length();
	...
	lea	ecx, DWORD PTR _OverShoot$138143[ebp]
	call	?Length@Vector2D@@QBENXZ		; Vector2D::Length
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR $T148372[ebp]
	push	ecx
...
; 363  :                  m_pRaven_Bot->Heading() * m_pRaven_Bot->Speed();
	...
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR $T148401[ebp]
	push	ecx
	call	??D@YA?AUVector2D@@NABU0@@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	edx, DWORD PTR $T148402[ebp]
	push	edx
	call	??D@YA?AUVector2D@@ABU0@N@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	eax, DWORD PTR $T148403[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T148404[ebp]
	push	edx
	call	??H@YA?AUVector2D@@ABU0@0@Z		; operator+
	add	esp, 12					; 0000000cH
	mov	esi, eax
...
; 368  :   m_Feelers[1] = m_pRaven_Bot->Pos() + m_dWallDetectionFeelerLength/2.0 * temp;
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	edx, DWORD PTR $T148405[ebp]
	push	edx
	call	??D@YA?AUVector2D@@NABU0@@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	eax, DWORD PTR $T148406[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T148407[ebp]
	push	edx
	call	??H@YA?AUVector2D@@ABU0@0@Z		; operator+
	add	esp, 12					; 0000000cH
	mov	esi, eax
...
; 373  :   m_Feelers[2] = m_pRaven_Bot->Pos() + m_dWallDetectionFeelerLength/2.0 * temp;
	...
	add	esp, 16					; 00000010H
	push	eax
	lea	edx, DWORD PTR $T148410[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	ecx, DWORD PTR $T148411[ebp]
	push	ecx
	call	??H@YA?AUVector2D@@ABU0@0@Z		; operator+
	add	esp, 12					; 0000000cH
	mov	esi, eax
...
; 395  :       Vector2D ToAgent = m_pRaven_Bot->Pos() - (*it)->Pos();
	...
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	edx, DWORD PTR $T148437[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	ecx, DWORD PTR _ToAgent$138316[ebp]
	push	ecx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
...
; 399  :       SteeringForce += Vec2DNormalize(ToAgent)/ToAgent.Length();
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	lea	edx, DWORD PTR _ToAgent$138316[ebp]
	push	edx
...
; 98   :   bool         IsTagged()const{return m_bTag;}
...
; 797  : 		return (const_iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T148508[ebp]
	or	eax, 1
	mov	DWORD PTR $T148508[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 859  : 			erase(begin() + _Newsize, end());
	...
	push	ecx
	lea	edx, DWORD PTR $T148536[ebp]
	push	edx
	lea	eax, DWORD PTR $T148535[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T148534[ebp], esp
	mov	eax, DWORD PTR tv198[ebp]
	push	eax
	call	??0?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv201[ebp], eax
	lea	ecx, DWORD PTR $T148537[ebp]
	push	ecx
	...
	lea	ecx, DWORD PTR $T148536[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T148535[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
...
_TEXT	SEGMENT
__Size$141609 = -28					; size = 4
__Ptr$141602 = -24					; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -16						; size = 16
__Count$ = 8						; size = 4
...
; 751  : 			pointer _Ptr = this->_Alval.allocate(_Count);
	...
	mov	DWORD PTR __Ptr$141602[ebp], eax
...
; 754  : 			_Umove(this->_Myfirst, this->_Mylast, _Ptr);
	...
	mov	ecx, DWORD PTR __Ptr$141602[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
...
; 760  : 			size_type _Size = size();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?size@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QBEIXZ ; std::vector<Vector2D,std::allocator<Vector2D> >::size
	mov	DWORD PTR __Size$141609[ebp], eax
...
; 769  : 			this->_Myend = _Ptr + _Count;
	...
	mov	eax, DWORD PTR __Count$[ebp]
	shl	eax, 4
	add	eax, DWORD PTR __Ptr$141602[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+12], eax

; 770  : 			this->_Mylast = _Ptr + _Size;

	mov	edx, DWORD PTR __Size$141609[ebp]
	shl	edx, 4
	add	edx, DWORD PTR __Ptr$141602[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+8], edx
...
; 771  : 			this->_Myfirst = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$141602[ebp]
	mov	DWORD PTR [ecx+4], edx
$LN7@reserve:
...
; 792  : 		return (iterator(this->_Mylast, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@PAUVector2D@@PBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >
	mov	eax, DWORD PTR $T148663[ebp]
	or	eax, 1
	mov	DWORD PTR $T148663[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1202 : 				_VIPTR(_First));
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Ptr$141639[ebp], eax
...
; 1210 : 			_Destroy(_Ptr, this->_Mylast);
	...
	mov	edx, DWORD PTR [ecx+8]
	push	edx
	mov	eax, DWORD PTR __Ptr$141639[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Destroy@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@IAEXPAUVector2D@@0@Z ; std::vector<Vector2D,std::allocator<Vector2D> >::_Destroy
...
; 1211 : 			this->_Mylast = _Ptr;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Ptr$141639[ebp]
	mov	DWORD PTR [ecx+8], edx
$LN3@erase:
...
; 1213 : 		return (_Make_iter(_First));
	...
	mov	edx, DWORD PTR $T148680[ebp]
	or	edx, 1
	mov	DWORD PTR $T148680[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	lea	ecx, DWORD PTR __Last$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 2
...
__unwindfunclet$?erase@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QAE?AV?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@0@Z$7:
	mov	eax, DWORD PTR $T148680[ebp]
	and	eax, 1
	je	$LN14@erase
	and	DWORD PTR $T148680[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN14@erase:
	ret	0
...
; 365  : 		return (_Tmp += _Off);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T148743[ebp]
	or	edx, 1
	mov	DWORD PTR $T148743[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??H?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QBE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T148743[ebp]
	and	eax, 1
	je	$LN5@operator@12
	and	DWORD PTR $T148743[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@12:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@PAUVector2D@@PBU_Container_base12@1@@Z ; std::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >::_Vector_iterator<std::_Vector_val<Vector2D,std::allocator<Vector2D> > >
	mov	edx, DWORD PTR $T148766[ebp]
	or	edx, 1
	mov	DWORD PTR $T148766[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
...
__unwindfunclet$?_Make_iter@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@QBE?AV?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@V?$_Vector_const_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T148766[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T148766[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Vector_iterator@V?$_Vector_val@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
;	COMDAT xdata$x
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\common\game\entityfunctiontemplates.h
xdata$x	SEGMENT
...
$T148810 = -77						; size = 1
$T148809 = -76						; size = 12
_range$143582 = -64					; size = 8
_to$143578 = -52					; size = 16
_it$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_entity$ = 8						; size = 4
_others$ = 12						; size = 4
...
; 56   :     Vector2D to = (*it)->Pos() - entity->Pos();
	...
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	push	eax
	lea	eax, DWORD PTR _to$143578[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
...
; 60   :     double range = radius + (*it)->BRadius();
	...
	fstp	QWORD PTR _range$143582[ebp]
...
; 63   :     if ( ((*it) != entity) && (to.LengthSq() < range*range))
	...
	lea	ecx, DWORD PTR _to$143578[ebp]
	call	?LengthSq@Vector2D@@QBENXZ		; Vector2D::LengthSq
	fld	QWORD PTR _range$143582[ebp]
	fmul	QWORD PTR _range$143582[ebp]
	fcompp
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$143836[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$143836[ebp]
	push	edx
	lea	eax, DWORD PTR $T143837[ebp]
	push	eax
	...
	lea	eax, DWORD PTR $T148838[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T143837[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T148928[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T148928[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T148990[ebp]
	or	ecx, 1
	mov	DWORD PTR $T148990[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T148990[ebp]
	and	eax, 1
	je	$LN5@operator@14
	and	DWORD PTR $T148990[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@14:
	ret	0
...
; 672  : 		_Val_type(_First), _Ptr_cat(_First, _First));
	...
	add	esp, 8
	mov	BYTE PTR $T149055[ebp], al
	movzx	edx, BYTE PTR $T149055[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
...
; 2535 : 		_Dest, _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T149062[ebp], al
	movzx	edx, BYTE PTR $T149062[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; 88   : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T149065[ebp], al
	movzx	edx, BYTE PTR $T149065[ebp]
	push	edx
...
; 1542 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$144607[ebp], edx
...
; 1544 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$144607[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve@2:
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T149106[ebp]
	or	ecx, 1
	mov	DWORD PTR $T149106[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T149111[ebp]
	or	eax, 1
	mov	DWORD PTR $T149111[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T149116[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T149116[ebp], 0
	...
	mov	ecx, DWORD PTR $T149116[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T149116[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T149182[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T149182[ebp], 0
	je	SHORT $LN3@construct@2
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
	call	??$forward@UVector2D@@@std@@YA$$QAUVector2D@@AAU1@@Z ; std::forward<Vector2D>
	add	esp, 4
	mov	edx, DWORD PTR $T149182[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR [edx], ecx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR [edx+4], ecx
...
; 471  : 		_Val_type(_First), _Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@UVector2D@@U1@@std@@YA?AU_Nonscalar_ptr_iterator_tag@0@PAUVector2D@@0@Z ; std::_Ptr_cat<Vector2D,Vector2D>
	add	esp, 8
	mov	BYTE PTR $T149194[ebp], al
	movzx	edx, BYTE PTR $T149194[ebp]
	push	edx
	mov	eax, DWORD PTR __First$[ebp]
	push	eax
	call	??$_Val_type@PAUVector2D@@@std@@YAPAUVector2D@@PAU1@@Z ; std::_Val_type<Vector2D *>
