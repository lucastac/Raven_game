...
; 25   :      const double Tweaker = 1.0;
	...
	fld1
	fstp	QWORD PTR _Tweaker$134040[ebp]
...
; 29   :                     Raven_Feature::TotalWeaponStrength(pBot);
	...
	add	esp, 4
	fmul	QWORD PTR _Tweaker$134040[ebp]
...
; 49   :   gdi->TextAtPos(Position, "AT: " + ttos(CalculateDesirability(pBot), 2));
	...
	push	ecx
	push	OFFSET $SG134084
	lea	edx, DWORD PTR $T134083[ebp]
	push	edx
	...
	lea	ecx, DWORD PTR $T134083[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T134056[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; 52   :   std::string s = ttos(Raven_Feature::Health(pBot)) + ", " + ttos(Raven_Feature::TotalWeaponStrength(pBot));
	...
	call	?TotalWeaponStrength@Raven_Feature@@SANPAVRaven_Bot@@@Z ; Raven_Feature::TotalWeaponStrength
	add	esp, 4
	fstp	QWORD PTR $T143115[ebp]
	mov	eax, DWORD PTR _pBot$[ebp]
	push	eax
	call	?Health@Raven_Feature@@SANPAVRaven_Bot@@@Z ; Raven_Feature::Health
	add	esp, 4
	fstp	QWORD PTR $T143116[ebp]
	push	2
	lea	ecx, DWORD PTR $T143115[ebp]
	push	ecx
	lea	edx, DWORD PTR $T134116[ebp]
	push	edx
	call	??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z ; ttos<double>
	add	esp, 12					; 0000000cH
	...
	push	2
	lea	edx, DWORD PTR $T143116[ebp]
	push	edx
	lea	eax, DWORD PTR $T134087[ebp]
	push	eax
	call	??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z ; ttos<double>
	add	esp, 12					; 0000000cH
	...
	lea	ecx, DWORD PTR $T134087[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	BYTE PTR __$EHRec$[ebp+8], 8
	lea	ecx, DWORD PTR $T134116[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$135720[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$135720[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$135720[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 27   :   return buffer.str();
	...
	mov	eax, DWORD PTR $T143208[ebp]
	or	eax, 1
	mov	DWORD PTR $T143208[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR _buffer$[ebp]
...
__unwindfunclet$??$ttos@N@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABNH@Z$1:
	...
	and	eax, 1
	je	$LN5@ttos
	and	DWORD PTR $T143208[ebp], -2		; fffffffeH
...
; 127  : 	return (_STD move(_Right.insert(0, _Left)));
	...
	mov	ecx, DWORD PTR $T143226[ebp]
	or	ecx, 1
	mov	DWORD PTR $T143226[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$135699[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$135699[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 147  : 	return (_STD move(_Left.append(_Right)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T143317[ebp]
	or	ecx, 1
	mov	DWORD PTR $T143317[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 115  : 		return (_STD move(_Left.append(_Right)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T143322[ebp]
	or	ecx, 1
	mov	DWORD PTR $T143322[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 117  : 		return (_STD move(_Right.insert(0, _Left)));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T143322[ebp]
	or	eax, 1
	mov	DWORD PTR $T143322[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
$LN4@operator@2:
...
; 434  : 			const _Nput& _Nput_fac = _USE(ios_base::getloc(), _Nput);
	...
	add	esp, 4
	mov	DWORD PTR __Nput_fac$139137[ebp], eax
...
$LN7@operator@4:
	...
	mov	edx, DWORD PTR [eax]
	push	edx
	lea	eax, DWORD PTR $T143386[ebp]
	push	eax
	mov	ecx, DWORD PTR __Nput_fac$139137[ebp]
...
; 444  : 		return (*this);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T143387[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR __Ok$[ebp]
	call	??1sentry@?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@XZ ; std::basic_ostream<char,std::char_traits<char> >::sentry::~sentry
	mov	eax, DWORD PTR $T143387[ebp]
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T143410[ebp], eax
	lea	ecx, DWORD PTR __Lock$118397[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T143410[ebp]
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T143418[ebp]
	or	edx, 1
	mov	DWORD PTR $T143418[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	lea	ecx, DWORD PTR $T143444[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	edx, DWORD PTR $T143444[ebp]
	push	edx
	call	__CxxThrowException@8
$LN10@clear@2:
...
__unwindfunclet$??0?$basic_ostringstream@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@H@Z$0:
	mov	eax, DWORD PTR $T143565[ebp]
	and	eax, 1
	je	$LN5@basic_ostr
	and	DWORD PTR $T143565[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 80					; 00000050H
...
tv195 = -32						; size = 4
$T143695 = -28						; size = 4
__Oldptr$139500 = -24					; size = 4
__Newptr$139499 = -20					; size = 4
__Inc$139494 = -16					; size = 4
__Newsize$139493 = -12					; size = 4
__Oldsize$139492 = -8					; size = 4
_this$ = -4						; size = 4
__Meta$ = 8						; size = 4
...
; 125  : 		if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T143695[ebp], eax
	lea	edx, DWORD PTR __Meta$[ebp]
	push	edx
	lea	eax, DWORD PTR $T143695[ebp]
	push	eax
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	ecx, al
...
$LN22@overflow:
	...
	mov	DWORD PTR __Oldsize$139492[ebp], eax

; 139  : 			size_t _Newsize = _Oldsize;

	mov	ecx, DWORD PTR __Oldsize$139492[ebp]
	mov	DWORD PTR __Newsize$139493[ebp], ecx

; 140  : 			size_t _Inc = _Newsize / 2 < _MINSIZE
; 141  : 				? _MINSIZE : _Newsize / 2;	// grow by 50 per cent

	mov	edx, DWORD PTR __Newsize$139493[ebp]
	shr	edx, 1
...
$LN23@overflow:
	mov	eax, DWORD PTR __Newsize$139493[ebp]
	shr	eax, 1
	mov	DWORD PTR tv199[ebp], eax
$LN24@overflow:
	mov	ecx, DWORD PTR tv199[ebp]
	mov	DWORD PTR __Inc$139494[ebp], ecx
$LN11@overflow:

; 142  : 
; 143  : 			while (0 < _Inc && INT_MAX - _Inc < _Newsize)

	cmp	DWORD PTR __Inc$139494[ebp], 0
	jbe	SHORT $LN10@overflow
	mov	edx, 2147483647				; 7fffffffH
	sub	edx, DWORD PTR __Inc$139494[ebp]
	cmp	edx, DWORD PTR __Newsize$139493[ebp]
	jae	SHORT $LN10@overflow

; 144  : 				_Inc /= 2;	// increment causes overflow, halve it

	mov	eax, DWORD PTR __Inc$139494[ebp]
	shr	eax, 1
	mov	DWORD PTR __Inc$139494[ebp], eax
...
; 148  : 			_Newsize += _Inc;
	...
	mov	ecx, DWORD PTR __Newsize$139493[ebp]
	add	ecx, DWORD PTR __Inc$139494[ebp]
	mov	DWORD PTR __Newsize$139493[ebp], ecx
...
; 150  : 			_Elem *_Newptr = _Al.allocate(_Newsize);
	...
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Newptr$139499[ebp], eax

; 151  : 			_Elem *_Oldptr = _Mysb::eback();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	mov	DWORD PTR __Oldptr$139500[ebp], eax

; 152  : 
; 153  : 			if (0 < _Oldsize)

	cmp	DWORD PTR __Oldsize$139492[ebp], 0
	jbe	SHORT $LN8@overflow

; 154  : 				_Traits::copy(_Newptr, _Oldptr, _Oldsize);

	mov	eax, DWORD PTR __Oldsize$139492[ebp]
	push	eax
	mov	ecx, DWORD PTR __Oldptr$139500[ebp]
	push	ecx
	mov	edx, DWORD PTR __Newptr$139499[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
$LN8@overflow:
...
; 158  : 				_Seekhigh = _Newptr;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newptr$139499[ebp]
	mov	DWORD PTR [eax+60], ecx

; 159  : 				_Mysb::setp(_Newptr, _Newptr + _Newsize);

	mov	edx, DWORD PTR __Newptr$139499[ebp]
	add	edx, DWORD PTR __Newsize$139493[ebp]
	push	edx
	mov	eax, DWORD PTR __Newptr$139499[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 167  : 				_Seekhigh = _Newptr + (_Seekhigh - _Oldptr);
	...
	sub	eax, DWORD PTR __Oldptr$139500[ebp]
	add	eax, DWORD PTR __Newptr$139499[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 180  : 				_Al.deallocate(_Oldptr, _Oldsize);
	...
	mov	ecx, DWORD PTR __Oldsize$139492[ebp]
	push	ecx
	mov	edx, DWORD PTR __Oldptr$139500[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 68					; 00000044H
	call	?deallocate@?$allocator@D@std@@QAEXPADI@Z ; std::allocator<char>::deallocate
...
; 46   : 	explicit __CLR_OR_THIS_CALL basic_ostream(
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T143757[ebp]
	or	ecx, 1
	mov	DWORD PTR $T143757[ebp], ecx
$LN1@basic_ostr@2:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR [eax+4]
...
__unwindfunclet$??0?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@_N@Z$0:
	mov	eax, DWORD PTR $T143757[ebp]
	and	eax, 1
	je	$LN5@basic_ostr@2
	and	DWORD PTR $T143757[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN5@basic_ostr@2:
...
tv91 = -148						; size = 4
$T143795 = -144						; size = 4
__Nul$139720 = -136					; size = 32
__Str$139718 = -96					; size = 32
__Str$139715 = -56					; size = 32
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
$LN8@str:
	...
	call	?pbase@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::pbase
	push	eax
	lea	ecx, DWORD PTR __Str$139715[ebp]
...
; 98   : 			return (_Str);
	...
	lea	eax, DWORD PTR __Str$139715[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T143795[ebp]
	or	ecx, 1
	mov	DWORD PTR $T143795[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Str$139715[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 102  : 			_Mystr _Str(_Mysb::eback(), _Mysb::egptr() - _Mysb::eback());
	...
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	push	eax
	lea	ecx, DWORD PTR __Str$139718[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBDI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 2
...
; 107  : 			_Mystr _Nul;
	...
	lea	ecx, DWORD PTR __Nul$139720[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 3

; 108  : 			return (_Nul);

	lea	eax, DWORD PTR __Nul$139720[ebp]
	push	eax
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@$$QAV01@@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	ecx, DWORD PTR $T143795[ebp]
...
__unwindfunclet$?str@?$basic_stringbuf@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ$1:
	mov	eax, DWORD PTR $T143795[ebp]
	and	eax, 1
	je	$LN11@str
	and	DWORD PTR $T143795[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN11@str:
	ret	0
...
; 564  : 		_Ploc = _NEW_CRT locale;
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T143846[ebp], eax
	cmp	DWORD PTR $T143846[ebp], 0
	je	SHORT $LN3@Init
...
; 320  : 			_Elem *_Pnew = _Al.allocate(_Count);
	...
	add	ecx, 68					; 00000044H
	call	?allocate@?$allocator@D@std@@QAEPADI@Z	; std::allocator<char>::allocate
	mov	DWORD PTR __Pnew$139953[ebp], eax
...
; 321  : 			_Traits::copy(_Pnew, _Ptr, _Count);
	...
	mov	ecx, DWORD PTR __Ptr$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$139953[ebp]
	push	edx
	call	?copy@?$char_traits@D@std@@SAPADPADPBDI@Z ; std::char_traits<char>::copy
	add	esp, 12					; 0000000cH
...
; 322  : 			_Seekhigh = _Pnew + _Count;
	...
	mov	eax, DWORD PTR __Pnew$139953[ebp]
	add	eax, DWORD PTR __Count$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+60], eax
...
; 326  : 					_Pnew + _Count);	// setup read buffer
	...
	mov	ecx, DWORD PTR __Pnew$139953[ebp]
	add	ecx, DWORD PTR __Count$[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pnew$139953[ebp]
	push	edx
...
$T143888 = -64						; size = 4
$T143887 = -60						; size = 12
__Pfmod$137543 = -48					; size = 4
__Pf$137527 = -44					; size = 4
__Id$137526 = -40					; size = 4
__Psave$137514 = -32					; size = 4
__Lock$137513 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$137513[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$137514[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$137514[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$137514[ebp]
	mov	DWORD PTR __Pf$137527[ebp], edx
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	push	eax
	lea	ecx, DWORD PTR __Psave$137514[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T143887[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T143887[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$137514[ebp]
	mov	DWORD PTR __Pf$137527[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$137514[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$137514[ebp]
	mov	DWORD PTR __Pfmod$137543[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$137543[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$137527[ebp]
	mov	DWORD PTR $T143888[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$137513[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T143888[ebp]
$LN8@use_facet:
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T143917[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T143917[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T143924[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T143924[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T143920[ebp]
...
; 78   :             _THROW_NCEE(runtime_error, "bad locale name");
	...
	lea	ecx, DWORD PTR $T143936[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T143936[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
...
; 118  : 		return (::_Getctype());
	...
	lea	eax, DWORD PTR $T143998[ebp]
	push	eax
	call	__Getctype
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T143997[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T143997[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T143997[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T143997[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T143997[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T143997[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T143997[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T143997[ebp+12]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
	mov	DWORD PTR $T144028[ebp], edx
	mov	eax, DWORD PTR $T144028[ebp]
	push	eax
...
$T144066 = -64						; size = 4
$T144065 = -60						; size = 12
__Pfmod$140476 = -48					; size = 4
__Pf$140465 = -44					; size = 4
__Id$140464 = -40					; size = 4
__Psave$140452 = -32					; size = 4
__Lock$140451 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$140451[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$140452[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$140464[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$140464[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$140465[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$140465[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$140452[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$140452[ebp]
	mov	DWORD PTR __Pf$140465[ebp], edx
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$140452[ebp]
	push	ecx
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$140452[ebp]
	mov	DWORD PTR __Pf$140465[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$140452[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$140452[ebp]
	mov	DWORD PTR __Pfmod$140476[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$140476[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$140465[ebp]
	mov	DWORD PTR $T144066[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$140451[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T144066[ebp]
$LN8@use_facet@2:
...
; 1054 : 				_Locinfo(_Ploc->c_str()));
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T144085[ebp], eax
	push	1053					; 0000041dH
	push	OFFSET ??_C@_0EH@GHEBKCIB@c?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T144085[ebp]
	push	ecx
	push	16					; 00000010H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T144084[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T144084[ebp], 0
	je	SHORT $LN4@Getcat@2
	push	0
	mov	ecx, DWORD PTR __Ploc$[ebp]
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T144086[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv138[ebp], eax
	mov	edx, DWORD PTR tv138[ebp]
	mov	DWORD PTR tv133[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T144090[ebp]
	or	eax, 1
	mov	DWORD PTR $T144090[ebp], eax
	mov	ecx, DWORD PTR tv133[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T144084[ebp]
...
$LN5@Getcat@2:
	mov	edx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T144083[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR __Ppf$[ebp]
	mov	ecx, DWORD PTR $T144083[ebp]
	mov	DWORD PTR [eax], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T144090[ebp]
	and	edx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T144090[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T144086[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
$T144115 = -144						; size = 8
$T144112 = -136						; size = 4
__Fillcount$139811 = -132				; size = 4
$T139810 = -128						; size = 32
$T139808 = -96						; size = 32
__Str$139751 = -60					; size = 32
__Punct_fac$139744 = -24				; size = 4
_this$ = -20						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
___$ReturnUdt$ = 8					; size = 4
...
; 1149 : 			const _Mypunct& _Punct_fac = _USE(_Iosbase.getloc(), _Mypunct);
	...
	add	esp, 4
	mov	DWORD PTR __Punct_fac$139744[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T144112[ebp]
	call	??1locale@std@@QAE@XZ			; std::locale::~locale
...
; 1150 : 			_Mystr _Str;
	...
	lea	ecx, DWORD PTR __Str$139751[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 1
...
; 1152 : 				_Str.assign(_Punct_fac.truename());
	...
	push	edx
	mov	ecx, DWORD PTR __Punct_fac$139744[ebp]
...
$LN9@do_put:
	...
	mov	DWORD PTR __Fillcount$139811[ebp], edx
...
; 1162 : 				_Dest = _Rep(_Dest, _Fill, _Fillcount);
	...
	mov	eax, DWORD PTR __Fillcount$139811[ebp]
	push	eax
...
; 1163 : 				_Fillcount = 0;
	...
	mov	DWORD PTR __Fillcount$139811[ebp], 0
$LN1@do_put:
...
$LN18@do_put@6:
	...
	mov	BYTE PTR __Signed$139857[ebp], cl

; 1230 : 			if (_Signed)

	movzx	edx, BYTE PTR __Signed$139857[ebp]
	test	edx, edx
...
; 1244 : 			if (_Signed)
	...
	movzx	ecx, BYTE PTR __Signed$139857[ebp]
	test	ecx, ecx
...
$LN18@do_put@7:
	...
	mov	BYTE PTR __Signed$139880[ebp], cl

; 1271 : 			if (_Signed)

	movzx	edx, BYTE PTR __Signed$139880[ebp]
	test	edx, edx
...
; 1285 : 			if (_Signed)
	...
	movzx	ecx, BYTE PTR __Signed$139880[ebp]
	test	ecx, ecx
...
$T144230 = -168						; size = 8
$T144225 = -160						; size = 4
__Expoffset$140031 = -156				; size = 4
__Fracoffset$140024 = -152				; size = 4
__Adjustfield$ = -148					; size = 4
__Fillcount$ = -144					; size = 4
__Off$140004 = -140					; size = 4
__Pg$140003 = -136					; size = 4
...
; 1380 : 			const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$140003[ebp], eax
...
; 1381 : 			size_t _Off = _CSTD strcspn(&_Groupstring[0], &_Enders[0]);
	...
	call	_strcspn
	add	esp, 8
	mov	DWORD PTR __Off$140004[ebp], eax
$LN9@Fput:

; 1382 : 			while (*_Pg != CHAR_MAX && '\0' < *_Pg
; 1383 : 				&& (size_t)*_Pg < _Off - _Prefix)

	mov	edx, DWORD PTR __Pg$140003[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	eax, 127				; 0000007fH
	je	SHORT $LN8@Fput
	mov	ecx, DWORD PTR __Pg$140003[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	jle	SHORT $LN8@Fput
	mov	eax, DWORD PTR __Pg$140003[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Off$140004[ebp]
...
; 1385 : 				_Groupstring.insert(_Off -= *_Pg, (size_t)1, '\0');
	...
	mov	edx, DWORD PTR __Off$140004[ebp]
	sub	edx, ecx
	mov	DWORD PTR __Off$140004[ebp], edx
	push	0
	push	1
	mov	eax, DWORD PTR __Off$140004[ebp]
	push	eax
	lea	ecx, DWORD PTR __Groupstring$[ebp]
	call	?insert@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@IID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::insert
...
; 1427 : 			_Buf += _Fracoffset, _Count -= _Fracoffset;
	...
	mov	eax, DWORD PTR __Buf$[ebp]
	add	eax, DWORD PTR __Fracoffset$140024[ebp]
	mov	DWORD PTR __Buf$[ebp], eax
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, DWORD PTR __Fracoffset$140024[ebp]
	mov	DWORD PTR __Count$[ebp], ecx
$LN2@Fput:
...
; 1439 : 			_Buf += _Expoffset, _Count -= _Expoffset;
	...
	mov	ecx, DWORD PTR __Buf$[ebp]
	add	ecx, DWORD PTR __Expoffset$140031[ebp]
	mov	DWORD PTR __Buf$[ebp], ecx
	mov	edx, DWORD PTR __Count$[ebp]
	sub	edx, DWORD PTR __Expoffset$140031[ebp]
	mov	DWORD PTR __Count$[ebp], edx
$LN1@Fput:
...
__Off$140059 = -72					; size = 4
__Pg$140058 = -68					; size = 4
__Prefix$ = -64						; size = 4
__Grouping$ = -56					; size = 32
__Punct_fac$ = -20					; size = 4
__$ArrayPad$ = -16					; size = 4
...
; 1489 : 			const char *_Pg = _Grouping.c_str();
	...
	lea	ecx, DWORD PTR __Grouping$[ebp]
	call	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
	mov	DWORD PTR __Pg$140058[ebp], eax

; 1490 : 			size_t _Off = _Count;

	mov	ecx, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Off$140059[ebp], ecx
$LN9@Iput:

; 1491 : 			while (*_Pg != CHAR_MAX && '\0' < *_Pg
; 1492 : 				&& (size_t)*_Pg < _Off - _Prefix)

	mov	edx, DWORD PTR __Pg$140058[ebp]
	movsx	eax, BYTE PTR [edx]
	cmp	eax, 127				; 0000007fH
	je	$LN10@Iput
	mov	ecx, DWORD PTR __Pg$140058[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	jle	SHORT $LN10@Iput
	mov	eax, DWORD PTR __Pg$140058[ebp]
	movsx	ecx, BYTE PTR [eax]
	mov	edx, DWORD PTR __Off$140059[ebp]
	sub	edx, DWORD PTR __Prefix$[ebp]
	cmp	ecx, edx
	jae	SHORT $LN10@Iput
...
; 1494 : 				_Off -= *_Pg;
	...
	mov	edx, DWORD PTR __Off$140059[ebp]
	sub	edx, ecx
	mov	DWORD PTR __Off$140059[ebp], edx
$LN6@Iput:
...
; 1497 : 				_CRT_SECURE_MEMMOVE(&_Buf[_Off + 1], _Count + 1 - _Off,
	...
	mov	ecx, DWORD PTR __Count$[ebp]
	add	ecx, 1
	sub	ecx, DWORD PTR __Off$140059[ebp]
	push	ecx
	mov	edx, DWORD PTR __Buf$[ebp]
	add	edx, DWORD PTR __Off$140059[ebp]
	push	edx
	mov	eax, DWORD PTR __Count$[ebp]
	add	eax, 1
	sub	eax, DWORD PTR __Off$140059[ebp]
	push	eax
	mov	ecx, DWORD PTR __Off$140059[ebp]
	mov	edx, DWORD PTR __Buf$[ebp]
...
; 1500 : 				_Buf[_Off] = '\0', ++_Count;
	...
	mov	ecx, DWORD PTR __Buf$[ebp]
	add	ecx, DWORD PTR __Off$140059[ebp]
	mov	BYTE PTR [ecx], 0
	mov	edx, DWORD PTR __Count$[ebp]
	add	edx, 1
	mov	DWORD PTR __Count$[ebp], edx
...
; 1502 : 					++_Pg;	// not last group, advance
	...
	mov	edx, DWORD PTR __Pg$140058[ebp]
	add	edx, 1
	mov	DWORD PTR __Pg$140058[ebp], edx
$LN4@Iput:
...
$T144323 = -24						; size = 8
$T144322 = -16						; size = 8
__Groupsize$140151 = -8					; size = 4
__Pend$140149 = -4					; size = 4
_this$ = 8						; size = 4
___$ReturnUdt$ = 12					; size = 4
__Dest$ = 16						; size = 8
__Ptr$ = 24						; size = 4
...
; 1553 : 				(const char *)_CSTD memchr(_Ptr, '\0', _Count);
	...
	call	_memchr
	add	esp, 12					; 0000000cH
	mov	DWORD PTR __Pend$140149[ebp], eax

; 1554 : 			size_t _Groupsize = _Pend != 0 ? _Pend - _Ptr : _Count;

	cmp	DWORD PTR __Pend$140149[ebp], 0
	je	SHORT $LN8@Putgrouped
	mov	ecx, DWORD PTR __Pend$140149[ebp]
...
$LN9@Putgrouped:
	...
	mov	DWORD PTR __Groupsize$140151[ebp], eax

; 1555 : 
; 1556 : 			_Dest = _Putc(_Dest, _Ptr, _Groupsize);

	mov	ecx, DWORD PTR __Groupsize$140151[ebp]
	push	ecx
	mov	edx, DWORD PTR __Ptr$[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp+4]
...
; 1557 : 			_Ptr += _Groupsize, _Count -= _Groupsize;
	...
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, DWORD PTR __Groupsize$140151[ebp]
	mov	DWORD PTR __Ptr$[ebp], eax
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, DWORD PTR __Groupsize$140151[ebp]
	mov	DWORD PTR __Count$[ebp], ecx
...
; 625  : 				_Strbuf->sputc(_Right)))
	...
	mov	DWORD PTR $T144326[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T144327[ebp], eax
	lea	eax, DWORD PTR $T144326[ebp]
	push	eax
...
; 79   : 		return (do_grouping());
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR $T144345[ebp]
	or	ecx, 1
	mov	DWORD PTR $T144345[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T144352 = -64						; size = 4
$T144351 = -60						; size = 12
__Pfmod$140509 = -48					; size = 4
__Pf$140498 = -44					; size = 4
__Id$140497 = -40					; size = 4
__Psave$140485 = -32					; size = 4
__Lock$140484 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$140484[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$140485[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$140497[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	ecx, DWORD PTR __Id$140497[ebp]
	push	ecx
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$140498[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$140498[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$140485[ebp], 0
	je	SHORT $LN4@use_facet@3

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	edx, DWORD PTR __Psave$140485[ebp]
	mov	DWORD PTR __Pf$140498[ebp], edx
	jmp	SHORT $LN5@use_facet@3
$LN4@use_facet@3:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$140485[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T144351[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	edx, DWORD PTR $T144351[ebp]
	push	edx
	call	__CxxThrowException@8
...
; 528  : 			_Pf = _Psave;
	...
	mov	eax, DWORD PTR __Psave$140485[ebp]
	mov	DWORD PTR __Pf$140498[ebp], eax

; 529  : 			_Facetptr<_Facet>::_Psave = _Psave;

	mov	ecx, DWORD PTR __Psave$140485[ebp]
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	edx, DWORD PTR __Psave$140485[ebp]
	mov	DWORD PTR __Pfmod$140509[ebp], edx

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$140509[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$140498[ebp]
	mov	DWORD PTR $T144352[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$140484[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T144352[ebp]
$LN8@use_facet@3:
...
; 114  : 				_Locinfo(_Ploc->c_str()), 0, true);
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T144371[ebp], eax
	push	113					; 00000071H
	push	OFFSET ??_C@_0EH@GHEBKCIB@c?3?2Program?5Files?5?$CIx86?$CJ?2Microsoft@
	mov	ecx, DWORD PTR $T144371[ebp]
	push	ecx
	push	24					; 00000018H
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T144370[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T144370[ebp], 0
	...
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T144372[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv139[ebp], eax
	mov	edx, DWORD PTR tv139[ebp]
	mov	DWORD PTR tv134[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	eax, DWORD PTR $T144376[ebp]
	or	eax, 1
	mov	DWORD PTR $T144376[ebp], eax
	mov	ecx, DWORD PTR tv134[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T144370[ebp]
...
$LN5@Getcat@3:
	...
	and	DWORD PTR $T144376[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T144372[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@3:
...
; 174  : 		return (string(_Grouping));
	...
	mov	edx, DWORD PTR $T144402[ebp]
	or	edx, 1
	mov	DWORD PTR $T144402[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 179  : 		return (string_type(_Falsename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T144419[ebp]
	or	edx, 1
	mov	DWORD PTR $T144419[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 184  : 		return (string_type(_Truename));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	edx, DWORD PTR $T144424[ebp]
	or	edx, 1
	mov	DWORD PTR $T144424[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 123  : 		return (::_Getcvt());
	...
	call	__Getcvt
	mov	DWORD PTR $T144446[ebp], eax
	mov	DWORD PTR $T144446[ebp+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T144446[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T144446[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 660  : 	_Elem *_Ptrdest = _NEW_CRT _Elem[_Count];
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T144479[ebp], eax
	mov	edx, DWORD PTR $T144479[ebp]
...
; 664  : 	for (_Elem *_Ptrnext = _Ptrdest; 0 < _Count; --_Count, ++_Ptrnext, ++_Ptr)
	...
	mov	DWORD PTR __Ptrnext$140724[ebp], eax
	jmp	SHORT $LN3@Maklocstr
$LN2@Maklocstr:
	mov	ecx, DWORD PTR __Count$[ebp]
	sub	ecx, 1
	mov	DWORD PTR __Count$[ebp], ecx
	mov	edx, DWORD PTR __Ptrnext$140724[ebp]
	add	edx, 1
	mov	DWORD PTR __Ptrnext$140724[ebp], edx
	mov	eax, DWORD PTR __Ptr$[ebp]
	add	eax, 1
	mov	DWORD PTR __Ptr$[ebp], eax
$LN3@Maklocstr:
...
; 665  : 		*_Ptrnext = (_Elem)(unsigned char)*_Ptr;
	...
	mov	ecx, DWORD PTR __Ptrnext$140724[ebp]
	mov	edx, DWORD PTR __Ptr$[ebp]
	mov	al, BYTE PTR [edx]
	mov	BYTE PTR [ecx], al
