; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Lucas\Desktop\jogos - game ai by example\Bluckland_SourceCode - new version\VS2010\Raven_Game\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG127688 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG127689 DB	'.', 00H, '.', 00H, '\', 00H, 'C', 00H, 'o', 00H, 'm', 00H
	...
	DB	'p', 00H, 00H, 00H
	ORG $+4
$SG127690 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
CONST	ENDS
PUBLIC	?SetID@BaseGameEntity@@IAEXH@Z			; BaseGameEntity::SetID
...
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\raven_game\common\game\basegameentity.cpp
rdata$r	SEGMENT
...
; 13   :   SetID(ID);
	...
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetID@BaseGameEntity@@IAEXH@Z		; BaseGameEntity::SetID
...
; Function compile flags: /Odtp /RTCsu
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\raven_game\common\game\basegameentity.h
_TEXT	ENDS
...
_this$ = -4						; size = 4
_val$ = 8						; size = 4
?SetID@BaseGameEntity@@IAEXH@Z PROC			; BaseGameEntity::SetID
; _this$ = ecx
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG127688
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG127689
	push	OFFSET $SG127690
	call	__wassert
...
; 31   : }
	...
	pop	ebp
	ret	4
?SetID@BaseGameEntity@@IAEXH@Z ENDP			; BaseGameEntity::SetID
_TEXT	ENDS
