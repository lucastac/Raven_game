...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG138919 DB	'Pellet_Mass', 00H
_SmallestDelay DQ 03fd0000000000000r		; 0.25
_SEND_MSG_IMMEDIATELY DQ 00000000000000000r	; 0
$SG138918 DB	'Pellet_MaxForce', 00H
$SG138920 DB	'Pellet_MaxSpeed', 00H
$SG138921 DB	'Pellet_Scale', 00H
	ORG $+3
$SG138922 DB	'Pellet_Damage', 00H
	ORG $+2
$SG138923 DB	'Pellet_Persistance', 00H
CONST	ENDS
...
; 33   : {
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG138922
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetInt@Scriptor@@QAEHPAD@Z		; Scriptor::GetInt
	push	eax
	lea	eax, DWORD PTR $T149601[ebp]
	push	eax
...
$T149700 = -108						; size = 16
$T149699 = -92						; size = 16
_accel$138942 = -72					; size = 16
_sf$138939 = -48					; size = 16
_DesiredVelocity$138934 = -24				; size = 16
_this$ = -4						; size = 4
...
; 45   :     Vector2D DesiredVelocity = Vec2DNormalize(m_vTarget - Pos()) * MaxSpeed();
	...
	push	edx
	lea	eax, DWORD PTR $T149700[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
	push	eax
	lea	ecx, DWORD PTR $T149701[ebp]
	push	ecx
	call	?Vec2DNormalize@@YA?AUVector2D@@ABU1@@Z	; Vec2DNormalize
	add	esp, 8
	push	eax
	lea	edx, DWORD PTR _DesiredVelocity$138934[ebp]
	push	edx
...
; 47   :     Vector2D sf = DesiredVelocity - Velocity();
	...
	lea	eax, DWORD PTR $T149702[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Velocity@MovingEntity@@QBE?AUVector2D@@XZ ; MovingEntity::Velocity
	push	eax
	lea	ecx, DWORD PTR _DesiredVelocity$138934[ebp]
	push	ecx
	lea	edx, DWORD PTR _sf$138939[ebp]
	push	edx
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
...
; 50   :     Vector2D accel = sf / m_dMass;
	...
	fstp	QWORD PTR [esp]
	lea	ecx, DWORD PTR _sf$138939[ebp]
	push	ecx
	lea	edx, DWORD PTR _accel$138942[ebp]
	push	edx
...
; 52   :     m_vVelocity += accel;
	...
	lea	eax, DWORD PTR _accel$138942[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 64					; 00000040H
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$144384[ebp]
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$144384[ebp]
	push	edx
	lea	eax, DWORD PTR $T144386[ebp]
	push	eax
	...
	lea	eax, DWORD PTR $T149825[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T144386[ebp]
...
; 165  : 		{	// construct from message string
	...
	mov	DWORD PTR $T149840[ebp], eax
	lea	eax, DWORD PTR $T149840[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$140882[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$140882[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$140882[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T149928[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T149928[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$140861[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$140861[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T149994[ebp]
	or	ecx, 1
	mov	DWORD PTR $T149994[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T149994[ebp]
	and	eax, 1
	je	$LN5@operator@5
	and	DWORD PTR $T149994[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@5:
	ret	0
...
; 64   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	push	OFFSET ??_C@_0CB@NOKEJIID@?$DMPopLuaNumber?$DO?5Cannot?5retrieve?3?5@
	lea	ecx, DWORD PTR _err$144401[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 66   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$144401[ebp]
	push	edx
	lea	eax, DWORD PTR $T144402[ebp]
	push	eax
	call	??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z ; std::operator+<char,std::char_traits<char>,std::allocator<char> >
	add	esp, 12					; 0000000cH
	mov	DWORD PTR tv74[ebp], eax
	...
	push	edx
	lea	ecx, DWORD PTR $T150044[ebp]
	call	??0runtime_error@std@@QAE@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@@Z ; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T150044[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T144402[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
$T150059 = -88						; size = 12
$T150058 = -73						; size = 1
_point$145079 = -68					; size = 16
_dist$145078 = -44					; size = 8
_curWall$ = -28						; size = 12
__$EHRec$ = -12						; size = 12
_A$ = 8							; size = 16
_B$ = 24						; size = 16
...
$LN6@FindCloses:
	...
	movzx	edx, BYTE PTR $T150058[ebp]
	test	edx, edx
	je	$LN4@FindCloses
...
; 100  :     double dist = 0.0;
	...
	fldz
	fstp	QWORD PTR _dist$145078[ebp]

; 101  :     Vector2D point;

	lea	ecx, DWORD PTR _point$145079[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 102  : 
; 103  :     if (LineIntersection2D(A, B, (*curWall)->From(), (*curWall)->To(), dist, point))

	lea	eax, DWORD PTR _point$145079[ebp]
	push	eax
	lea	ecx, DWORD PTR _dist$145078[ebp]
	push	ecx
	lea	edx, DWORD PTR $T150060[ebp]
	push	edx
	lea	ecx, DWORD PTR _curWall$[ebp]
...
; 105  :       if (dist < distance)
	...
	fld	QWORD PTR [edx]
	fcomp	QWORD PTR _dist$145078[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
...
; 107  :         distance = dist;
	...
	mov	eax, DWORD PTR _distance$[ebp]
	fld	QWORD PTR _dist$145078[ebp]
	fstp	QWORD PTR [eax]

; 108  :         ip = point;

	mov	ecx, DWORD PTR _ip$[ebp]
	mov	edx, DWORD PTR _point$145079[ebp]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR _point$145079[ebp+4]
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR _point$145079[ebp+8]
	mov	DWORD PTR [ecx+8], edx
	mov	eax, DWORD PTR _point$145079[ebp+12]
	mov	DWORD PTR [ecx+12], eax
$LN2@FindCloses:
...
; 113  :   if (distance < MaxDouble) return true;
	...
	mov	BYTE PTR $T150062[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T150062[ebp]
...
; 115  :   return false;
	...
	mov	BYTE PTR $T150063[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _curWall$[ebp]
	call	??1?$_Vector_const_iterator@V?$_Vector_val@PAVWall2D@@V?$allocator@PAVWall2D@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T150063[ebp]
$LN7@FindCloses:
...
; 1542 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$145807[ebp], edx
...
; 1544 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$145807[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T150163[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T150163[ebp], 0
	...
	mov	ecx, DWORD PTR $T150163[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T150163[ebp]
