; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Lucas\Desktop\jogos - game ai by example\Raven_Game\Buckland_Chapter7 to 10_Raven\goals\Goal_Protect_Flag.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?Distance@Vector2D@@QBENABU1@@Z			; Vector2D::Distance
...
PUBLIC	?Activate@Goal_Protect_Flag@@UAEXXZ		; Goal_Protect_Flag::Activate
...
; File c:\users\lucas\desktop\jogos - game ai by example\raven_game\buckland_chapter7 to 10_raven\goals\goal_protect_flag.cpp
CONST	SEGMENT
__real@4024000000000000 DQ 04024000000000000r	; 10
CONST	ENDS
xdata$x	SEGMENT
__unwindtable$?Activate@Goal_Protect_Flag@@UAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?Activate@Goal_Protect_Flag@@UAEXXZ$0
	DD	0ffffffffH
	DD	FLAT:__unwindfunclet$?Activate@Goal_Protect_Flag@@UAEXXZ$1
__ehfuncinfo$?Activate@Goal_Protect_Flag@@UAEXXZ DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$?Activate@Goal_Protect_Flag@@UAEXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
$T144841 = -60						; size = 4
$T144840 = -56						; size = 16
_dummy$134611 = -36					; size = 16
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?Activate@Goal_Protect_Flag@@UAEXXZ PROC		; Goal_Protect_Flag::Activate
; _this$ = ecx
...
; 20   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?Activate@Goal_Protect_Flag@@UAEXXZ
...
; 22   : 
; 23   :   //if this goal is reactivated then there may be some existing subgoals that
; 24   :   //must be removed
; 25   :   RemoveAllSubgoals();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?RemoveAllSubgoals@?$Goal_Composite@VRaven_Bot@@@@QAEXXZ ; Goal_Composite<Raven_Bot>::RemoveAllSubgoals

; 26   : 
; 27   :   if (m_pOwner->Pos().Distance(StandPos)<=10 &&  m_pOwner->GetTargetSys()->isTargetShootable())

	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 32					; 00000020H
	push	ecx
	lea	edx, DWORD PTR $T144840[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?Pos@BaseGameEntity@@QBE?AUVector2D@@XZ	; BaseGameEntity::Pos
	mov	ecx, eax
	call	?Distance@Vector2D@@QBENABU1@@Z		; Vector2D::Distance
...
; 28   :   {
; 29   :     //if the bot has space to strafe then do so
; 30   :     Vector2D dummy;

	lea	ecx, DWORD PTR _dummy$134611[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 31   :     if (m_pOwner->canStepLeft(dummy) || m_pOwner->canStepRight(dummy))

	lea	eax, DWORD PTR _dummy$134611[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [ecx+8]
...
; 32   :     {
; 33   :       AddSubgoal(new Goal_DodgeSideToSide(m_pOwner));

	push	40					; 00000028H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T144842[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T144842[ebp], 0
	je	SHORT $LN7@Activate
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	push	ecx
	mov	ecx, DWORD PTR $T144842[ebp]
...
$LN8@Activate:
	...
	mov	DWORD PTR $T144841[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	esi, esp
	mov	eax, DWORD PTR $T144841[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 34   :     }
; 35   : 
; 36   :     //if not able to strafe, head directly at the target's position 
; 37   :     /*else
; 38   :     {
; 39   :       AddSubgoal(new Goal_SeekToPosition(m_pOwner, m_pOwner->GetTargetBot()->Pos()));
; 40   :     }*/
; 41   :   }
; 42   : 
; 43   :   //if the target is not visible, go hunt it.
; 44   :   else
...
; 45   :   {
; 46   : 	  AddSubgoal(new Goal_MoveToPosition(m_pOwner,StandPos));
...
$LN10@Activate:
	...
	mov	DWORD PTR $T144845[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	esi, esp
	mov	edx, DWORD PTR $T144845[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
...
; 48   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN16@Activate
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?Activate@Goal_Protect_Flag@@UAEXXZ$0:
	mov	eax, DWORD PTR $T144842[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__unwindfunclet$?Activate@Goal_Protect_Flag@@UAEXXZ$1:
	mov	eax, DWORD PTR $T144846[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?Activate@Goal_Protect_Flag@@UAEXXZ:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-80]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?Activate@Goal_Protect_Flag@@UAEXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?Activate@Goal_Protect_Flag@@UAEXXZ ENDP		; Goal_Protect_Flag::Activate
...
EXTRN	_sqrt:PROC
; Function compile flags: /Odtp /RTCsu
;	COMDAT ?Distance@Vector2D@@QBENABU1@@Z
_TEXT	SEGMENT
_xSeparation$ = -20					; size = 8
_ySeparation$ = -12					; size = 8
_this$ = -4						; size = 4
_v2$ = 8						; size = 4
?Distance@Vector2D@@QBENABU1@@Z PROC			; Vector2D::Distance, COMDAT
; _this$ = ecx
...
; 188  : 
; 189  :   return sqrt(ySeparation*ySeparation + xSeparation*xSeparation);
...
; 190  : }
	...
	pop	ebp
	ret	4
?Distance@Vector2D@@QBENABU1@@Z ENDP			; Vector2D::Distance
; Function compile flags: /Odtp /RTCsu
...
; 91   :   Vector2D     Pos()const{return m_vPosition;}
...
; File c:\users\lucas\desktop\jogos - game ai by example\raven_game\buckland_chapter7 to 10_raven\goals\goal_dodgesidetoside.h
rdata$r	SEGMENT
...
; File c:\users\lucas\desktop\jogos - game ai by example\raven_game\buckland_chapter7 to 10_raven\goals\goal_movetoposition.h
rdata$r	SEGMENT
...
PUBLIC	?Process@Goal_Protect_Flag@@UAEHXZ		; Goal_Protect_Flag::Process
; Function compile flags: /Odtp /RTCsu
; File c:\users\lucas\desktop\jogos - game ai by example\raven_game\buckland_chapter7 to 10_raven\goals\goal_protect_flag.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Process@Goal_Protect_Flag@@UAEHXZ PROC			; Goal_Protect_Flag::Process
; _this$ = ecx
...
; 56   :     
; 57   :   //process the subgoals
; 58   :   m_iStatus = ProcessSubgoals();
...
; 63   : }
	...
	pop	ebp
	ret	0
?Process@Goal_Protect_Flag@@UAEHXZ ENDP			; Goal_Protect_Flag::Process
_TEXT	ENDS
...
PUBLIC	?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z ; Goal_Protect_Flag::HandleMessage
...
xdata$x	SEGMENT
__ehfuncinfo$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z DD 019930522H
	DD	05H
	DD	FLAT:__unwindtable$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
__unwindtable$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z$1
	DD	01H
	DD	FLAT:__unwindfunclet$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z$2
	DD	00H
	DD	FLAT:__unwindfunclet$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z$2
	DD	03H
	DD	FLAT:__unwindfunclet$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z$3
; Function compile flags: /Odtp /RTCsu
xdata$x	ENDS
_TEXT	SEGMENT
tv192 = -112						; size = 4
...
$T144919 = -73						; size = 1
$T144918 = -72						; size = 12
_curBot$134758 = -56					; size = 12
_bots$134639 = -36					; size = 16
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
_msg$ = 8						; size = 4
?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z PROC ; Goal_Protect_Flag::HandleMessage
; _this$ = ecx
...
; 66   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 68   : 	{
; 69   : 		case Msg_YouGotMeYouSOB:
; 70   : 		{
; 71   : 		  std::list<Raven_Bot*> bots = m_pOwner->GetWorld()->GetAllBots();
	...
	push	eax
	lea	ecx, DWORD PTR _bots$134639[ebp]
...
; 72   : 		  std::list<Raven_Bot*>::const_iterator curBot = bots.begin();

	lea	eax, DWORD PTR $T144918[ebp]
	push	eax
	lea	ecx, DWORD PTR _bots$134639[ebp]
	...
	push	edx
	lea	ecx, DWORD PTR _curBot$134758[ebp]
...
; 73   : 		  for (curBot; curBot != bots.end(); ++curBot)

	jmp	SHORT $LN5@HandleMess
$LN4@HandleMess:
	lea	ecx, DWORD PTR _curBot$134758[ebp]
...
$LN5@HandleMess:
	...
	mov	BYTE PTR $T144919[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	lea	ecx, DWORD PTR $T144920[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	eax, BYTE PTR $T144919[ebp]
	test	eax, eax
	je	SHORT $LN3@HandleMess

; 74   : 		  {
; 75   : 			  if((*curBot)->my_type == m_pOwner->my_type)
...
; 76   : 			  {
; 77   : 
; 78   : 				  Dispatcher->DispatchMsg(SEND_MSG_IMMEDIATELY,
; 79   : 								  m_pOwner->ID(),
; 80   : 								  (* curBot)->ID(),
; 81   : 								  Msg_ProtectCompleted,
; 82   : 								  NO_ADDITIONAL_INFO);
...
; 88   : 		  return false;
	...
	mov	al, BYTE PTR $T144921[ebp]
	jmp	SHORT $LN9@HandleMess
$LN1@HandleMess:

; 89   : 		}
; 90   : 
; 91   : 		case Msg_ProtectCompleted:
; 92   : 		{
; 93   : 			m_iStatus = completed;
...
; 99   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN19@HandleMess
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z$0:
	lea	ecx, DWORD PTR _bots$134639[ebp]
...
__unwindfunclet$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z$1:
	lea	ecx, DWORD PTR $T144918[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z$2:
	lea	ecx, DWORD PTR _curBot$134758[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z$3:
	lea	ecx, DWORD PTR $T144920[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__ehhandler$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-108]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?HandleMessage@Goal_Protect_Flag@@UAE_NABUTelegram@@@Z ENDP ; Goal_Protect_Flag::HandleMessage
; Function compile flags: /Odtp /RTCsu
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\common\game\basegameentity.h
...
; 77   :   {throw std::runtime_error("Cannot add goals to atomic goals");}
	...
	lea	ecx, DWORD PTR $T145020[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T145020[ebp]
	push	eax
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T145077[ebp]
	or	eax, 1
	mov	DWORD PTR $T145077[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	eax, DWORD PTR $T145118[ebp]
	or	eax, 1
	mov	DWORD PTR $T145118[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$136791[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$136791[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$136791[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T145370[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T145370[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
$T145382 = -16						; size = 4
$T145381 = -12						; size = 4
_StatusOfSubGoals$140235 = -8				; size = 4
_this$ = -4						; size = 4
...
; 106  :     delete m_SubGoals.front(); 
	...
	call	?front@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::list<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> >::front
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T145382[ebp], ecx
	mov	edx, DWORD PTR $T145382[ebp]
	mov	DWORD PTR $T145381[ebp], edx
	cmp	DWORD PTR $T145381[ebp], 0
	je	SHORT $LN9@ProcessSub
	mov	esi, esp
	push	1
	mov	eax, DWORD PTR $T145381[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T145381[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 114  :     int StatusOfSubGoals = m_SubGoals.front()->Process();
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _StatusOfSubGoals$140235[ebp], eax
...
; 120  :     if (StatusOfSubGoals == completed && m_SubGoals.size() > 1)
	...
	cmp	DWORD PTR _StatusOfSubGoals$140235[ebp], 2
...
; 125  :     return StatusOfSubGoals;
	...
	mov	eax, DWORD PTR _StatusOfSubGoals$140235[ebp]
	jmp	SHORT $LN7@ProcessSub
...
; 80   :   for (SubgoalList::iterator it = m_SubGoals.begin();
	...
	lea	eax, DWORD PTR _it$140296[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 16					; 00000010H
...
; 82   :        ++it)
	...
	lea	ecx, DWORD PTR _it$140296[ebp]
...
; 86   :     delete *it;
	...
	call	??D?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator*
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T145394[ebp], ecx
	mov	edx, DWORD PTR $T145394[ebp]
	mov	DWORD PTR $T145393[ebp], edx
	cmp	DWORD PTR $T145393[ebp], 0
	je	SHORT $LN6@RemoveAllS
	mov	esi, esp
	push	1
	mov	eax, DWORD PTR $T145393[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T145393[ebp]
	mov	eax, DWORD PTR [edx]
	call	eax
	cmp	esi, esp
	call	__RTC_CheckEsp
...
$LN3@RenderAtPo@2:
	...
	add	esp, 8
	mov	BYTE PTR $T145411[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T145412[ebp]
	call	??1?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@XZ
	movzx	edx, BYTE PTR $T145411[ebp]
	test	edx, edx
...
; 1004 : 		_Insert(_Where, _First, _Last, _Iter_cat(_First));
	...
	add	esp, 8
	mov	dl, BYTE PTR [eax]
	mov	BYTE PTR $T145429[ebp], dl
	movzx	eax, BYTE PTR $T145429[ebp]
	push	eax
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@PBV?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >
	mov	eax, DWORD PTR $T145528[ebp]
	or	eax, 1
	mov	DWORD PTR $T145528[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 811  : 		{	// return iterator for beginning of reversed nonmutable sequence
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T145537[ebp], 0

; 812  : 		return (const_reverse_iterator(end()));

	sub	esp, 12					; 0000000cH
	mov	eax, esp
	mov	DWORD PTR $T145533[ebp], esp
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	...
	mov	eax, DWORD PTR $T145537[ebp]
	or	eax, 1
	mov	DWORD PTR $T145537[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T145532[ebp]
	call	??1?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?rbegin@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QBE?AV?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@2@XZ$2:
	...
	and	eax, 1
	je	$LN6@rbegin
	and	DWORD PTR $T145537[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@XZ
$LN6@rbegin:
	ret	0
...
; 822  : 		return (const_reverse_iterator(begin()));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	eax, DWORD PTR $T145552[ebp]
	or	eax, 1
	mov	DWORD PTR $T145552[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T145547[ebp]
	call	??1?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?rend@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QBE?AV?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@2@XZ$2:
	...
	and	eax, 1
	je	$LN6@rend
	and	DWORD PTR $T145552[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$reverse_iterator@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@@std@@QAE@XZ
$LN6@rend:
	ret	0
...
; 897  : 		return (*begin());
	...
	call	??D?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBEAAPAV?$Goal@VRaven_Bot@@@@XZ ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator*
	mov	DWORD PTR $T145566[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T145567[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T145566[ebp]
...
; 922  : 		erase(begin());
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T145589[ebp], esp
	mov	edx, DWORD PTR tv92[ebp]
	push	edx
	call	??0?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv94[ebp], eax
	lea	eax, DWORD PTR $T145591[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?erase@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z ; std::list<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> >::erase
	mov	DWORD PTR tv95[ebp], eax
	lea	ecx, DWORD PTR $T145591[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T145608[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T145608[ebp], 0
	...
	mov	edx, DWORD PTR [eax]
	mov	eax, DWORD PTR [eax+4]
	mov	ecx, DWORD PTR $T145608[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T145608[ebp]
...
; 1045 : 		return (*--_Tmp);
	...
	mov	ecx, eax
	call	??D?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBEABQAV?$Goal@VRaven_Bot@@@@XZ ; std::_List_const_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator*
	mov	DWORD PTR $T145637[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR $T145637[ebp]
...
; 1046 : 		}
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN7@operator@5
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
; 787  : 		return (const_iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T145666[ebp]
	or	ecx, 1
	mov	DWORD PTR $T145666[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 797  : 		return (const_iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@PBV?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@@Z ; std::_List_const_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::_List_const_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >
	mov	eax, DWORD PTR $T145671[ebp]
	or	eax, 1
	mov	DWORD PTR $T145671[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1077 : 		return (_Make_iter(_Where));
	...
	mov	ecx, DWORD PTR $T145690[ebp]
	or	ecx, 1
	mov	DWORD PTR $T145690[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?erase@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z$3:
	mov	eax, DWORD PTR $T145690[ebp]
	and	eax, 1
	je	$LN10@erase
	and	DWORD PTR $T145690[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
$LN10@erase:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@PBV?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::_List_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >
	mov	edx, DWORD PTR $T145738[ebp]
	or	edx, 1
	mov	DWORD PTR $T145738[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?_Make_iter@?$list@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@QBE?AV?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T145738[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T145738[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
; 1046 : 			const_iterator _Before = _Where;
	...
	lea	edx, DWORD PTR __Where$[ebp]
	push	edx
	lea	ecx, DWORD PTR __Before$141937[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
...
; 1077 : 		return (_Make_iter(_Where));
	...
	mov	DWORD PTR tv200[ebp], eax
	mov	ecx, DWORD PTR $T145891[ebp]
	or	ecx, 1
	mov	DWORD PTR $T145891[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?erase@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@@Z$3:
	mov	eax, DWORD PTR $T145891[ebp]
	and	eax, 1
	je	$LN10@erase@2
	and	DWORD PTR $T145891[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN10@erase@2:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@PBV?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >::_List_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > >
	mov	edx, DWORD PTR $T145907[ebp]
	or	edx, 1
	mov	DWORD PTR $T145907[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?_Make_iter@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@QBE?AV?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T145907[ebp]
	and	eax, 1
	je	$LN5@Make_iter@2
	and	DWORD PTR $T145907[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter@2:
	ret	0
...
; 245  : 		return (_Tmp);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T145936[ebp]
	or	edx, 1
	mov	DWORD PTR $T145936[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??E?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T145936[ebp]
	and	eax, 1
	je	$LN5@operator@12
	and	DWORD PTR $T145936[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@12:
	ret	0
...
; 728  : 	_Debug_range2(_First, _Last, _File, _Line, _Iter_cat(_First));
	...
	lea	eax, DWORD PTR __First$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T145959[ebp]
	push	ecx
	call	??$_Iter_cat@V?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@std@@@std@@YA?AUbidirectional_iterator_tag@0@ABV?$_List_const_iterator@V?$_List_val@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@@0@@Z ; std::_Iter_cat<std::_List_const_iterator<std::_List_val<Raven_Bot *,std::allocator<Raven_Bot *> > > >
	add	esp, 8
	movzx	edx, BYTE PTR $T145960[ebp]
	push	edx
...
; 1083 : 		return (current == _Right.base());
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	??8?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QBE_NABV01@@Z ; std::_List_const_iterator<std::_List_val<Goal<Raven_Bot> *,std::allocator<Goal<Raven_Bot> *> > >::operator==
	mov	BYTE PTR $T145996[ebp], al
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T145997[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@XZ
	mov	al, BYTE PTR $T145996[ebp]
...
; 48   : 	::new (_Vptr) _Ty1(_STD forward<_Ty2>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T146020[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T146020[ebp], 0
...
; 1039 : 		return (current);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAV?$Goal@VRaven_Bot@@@@V?$allocator@PAV?$Goal@VRaven_Bot@@@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	ecx, DWORD PTR $T146033[ebp]
	or	ecx, 1
	mov	DWORD PTR $T146033[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
