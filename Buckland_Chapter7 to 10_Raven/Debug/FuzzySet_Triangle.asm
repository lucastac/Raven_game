; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Lucas\Desktop\jogos - game ai by example\Bluckland_SourceCode - new version\VS2010\Raven_Game\Common\fuzzy\FuzzySet_Triangle.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\lucas\desktop\jogos - game ai by example\bluckland_sourcecode - new version\vs2010\raven_game\common\fuzzy\fuzzyset_triangle.cpp
CONST	SEGMENT
...
rtc$IMZ	ENDS
_TEXT	SEGMENT
_grad$42260 = -20					; size = 8
_grad$42257 = -12					; size = 8
_this$ = -4						; size = 4
_val$ = 8						; size = 8
...
; 17   :     double grad = 1.0 / m_dLeftOffset;
	...
	fstp	QWORD PTR _grad$42257[ebp]
...
; 19   :     return grad * (val - (m_dPeakPoint - m_dLeftOffset));
	...
	fmul	QWORD PTR _grad$42257[ebp]
...
; 24   :     double grad = 1.0 / -m_dRightOffset;
	...
	fld1
	fdivrp	ST(1), ST(0)
	fstp	QWORD PTR _grad$42260[ebp]
...
; 26   :     return grad * (val - m_dPeakPoint) + 1.0;
	...
	fmul	QWORD PTR _grad$42260[ebp]
